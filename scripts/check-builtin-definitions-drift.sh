...
mirrors=(
	"apps/web-ui/src/lib/builtin-definitions.ts"
	"apps/web-ui/src/lib/builtin-definitions-pr-review.ts"
	"apps/web-ui/src/lib/builtin-definitions-internal-events.ts"
)
