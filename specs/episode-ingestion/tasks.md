...
- [x] T006 Implement `lore_write_episode` MCP tool with content hash dedup
- [x] T007 Implement `list_episodes` MCP tool with fact count subquery
- [x] T008 Wire async fact extraction on `lore_write_episode`
- [x] T009 Wire async graph extraction on `lore_write_episode`
...
- [x] T012 Audit log for `lore_write_episode` operations
