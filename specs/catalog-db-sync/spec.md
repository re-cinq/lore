...
- FR7.2: `GET /api/agent-definitions/usage` publishes the walk as a stable, name-sorted wire shape built from the builtin blueprints baked into the image. ([validated by maps the walk's refs to snake_case wire entries sorted by name](../../apps/lore-api/src/api/routes/agent-definitions/usage.test.ts#L9), [validated by the builtin catalog's response names implementation but never runbook](../../apps/lore-api/src/api/routes/agent-definitions/usage.test.ts#L47), [validated by keys the usage entries by definition name on 200](apps/web-ui/src/lib/agents-api.test.ts#L124), [validated by returns null when env is missing — unknown, never known-empty](apps/web-ui/src/lib/agents-api.test.ts#L146), [validated by returns null on a non-ok response (a stale lore-api 404s exactly here)](apps/web-ui/src/lib/agents-api.test.ts#L151), [validated by returns null when fetch throws](apps/web-ui/src/lib/agents-api.test.ts#L156), [validated by an ok response with no usage key is a known-empty map, not unknown](apps/web-ui/src/lib/agents-api.test.ts#L163))
