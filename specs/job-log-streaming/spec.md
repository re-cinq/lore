...
A finished task with zero stored turns shows the no-stored-turns explainer — naming locally-run tasks (no ingest yet), tasks that ran before the transcript store, and the 30-day retention — instead of the placeholder. ([validated by `TaskLogs.test.tsx:629`](apps/web-ui/src/app/tasks/[id]/TaskLogs.test.tsx#L629))
...
Clicking Raw shows the stored stream — each turn's envelope re-serialized as one NDJSON line — and clicking Formatted restores the transcript; the toggle is hidden until turns arrive. ([validated by `TaskLogs.test.tsx:705`](apps/web-ui/src/app/tasks/[id]/TaskLogs.test.tsx#L705), [validated by `TaskLogs.test.tsx:724`](apps/web-ui/src/app/tasks/[id]/TaskLogs.test.tsx#L724), [validated by `task-logs-presenter.test.ts:157`](apps/web-ui/src/app/tasks/[id]/task-logs-presenter.test.ts#L157), [validated by `task-logs-presenter.test.ts:169`](apps/web-ui/src/app/tasks/[id]/task-logs-presenter.test.ts#L169))
