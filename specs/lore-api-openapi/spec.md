...
([`zodValidate`](../../apps/lore-api/src/http/zod-validate.ts)): each
...
- The rate-limit bucket (`webhook` / `task` / `default`) is a `x-rate-limit-bucket`
  ...
  [rate-limit plugin](../../apps/lore-api/src/http/rate-limit.ts) uses.
...
- Every route whose method can carry a body (`POST`/`PUT`/`DELETE`/`*`) either
  ...
  the doc cannot silently rot. (Design fork 5.) ([validated by `coverage.test.ts:28`](apps/lore-api/src/openapi/coverage.test.ts#L22), [validated by `build-document.test.ts:41`](apps/lore-api/src/openapi/build-document.test.ts#L41))
...
- The output is a structurally valid OpenAPI 3.1 document (`openapi: "3.1.0"`,
  ...
  every `requestBody` is an `application/json` schema. ([validated by `coverage.test.ts:123`](apps/lore-api/src/openapi/coverage.test.ts#L111), [validated by `coverage.test.ts:136`](apps/lore-api/src/openapi/coverage.test.ts#L124), [validated by `coverage.test.ts:147`](apps/lore-api/src/openapi/coverage.test.ts#L135))
...
- **FR1** `zodValidate(schema)` stamps the raw zod schema onto the validation
  ...
  (parse → typed data → `{ error }` 400) is unchanged. ([validated by `zod-validate.test.ts:29`](apps/lore-api/src/http/zod-validate.test.ts#L29), [`zod-validate.test.ts:17`](apps/lore-api/src/http/zod-validate.test.ts#L17))
...
- **FR7** Non-API operational paths (`/healthz`, `/dist/*`) are excluded from the
  document and the exclusion is logged, not silent. ([validated by `build-document.test.ts:45`](apps/lore-api/src/openapi/build-document.test.ts#L45), [`coverage.test.ts:90`](apps/lore-api/src/openapi/coverage.test.ts#L90))
...
- **SC-4** A body-bearing route with neither a `zodValidate` schema nor a sidecar
  ...
  test). ([validated by `coverage.test.ts:32`](apps/lore-api/src/openapi/coverage.test.ts#L26))
