...
- **FR8** Operations are grouped into Redoc sidebar categories: the tags are
  ...
  assigned exactly one declared category. ([validated by `build-document.test.ts:160`](apps/lore-api/src/openapi/build-document.test.ts#L160), [validated by `build-document.test.ts:180`](apps/lore-api/src/openapi/build-document.test.ts#L179), [validated by `coverage.test.ts:49`](apps/lore-api/src/openapi/coverage.test.ts#L49))
