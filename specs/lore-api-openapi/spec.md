...
- The output is a structurally valid OpenAPI 3.1 document (`openapi: "3.1.0"`,
  ...
  every `requestBody` is an `application/json` schema. ([validated by `coverage.test.ts:65`](apps/lore-api/src/openapi/coverage.test.ts#L97), [validated by `coverage.test.ts:78`](apps/lore-api/src/openapi/coverage.test.ts#L110), [validated by `coverage.test.ts:91`](apps/lore-api/src/openapi/coverage.test.ts#L123))
...
- **FR7** Non-API operational paths (`/healthz`, `/dist/*`) are excluded from the
  document and the exclusion is logged, not silent. ([validated by `build-document.test.ts:45`](apps/lore-api/src/openapi/build-document.test.ts#L45), [`coverage.test.ts:42`](apps/lore-api/src/openapi/coverage.test.ts#L74))
