...
permissive `object`. ([validated by `build-document.test.ts:52`](apps/lore-api/src/transport/openapi/build-document.test.ts#L52), [validated by `build-document.test.ts:61`](apps/lore-api/src/transport/openapi/build-document.test.ts#L58), [validated by `build-document.test.ts:88`](apps/lore-api/src/transport/openapi/build-document.test.ts#L85), [validated by `build-document.test.ts:96`](apps/lore-api/src/transport/openapi/build-document.test.ts#L93))
...
- **FR4b** A `parse:false` route that declares `options.app.rawBody` is a real raw-body
  ...
  (`type: string`) instead of the generic HMAC boilerplate. ([validated by `build-document.test.ts:230`](apps/lore-api/src/transport/openapi/build-document.test.ts#L221))
...
- **SC-3** Every covered write route's `requestBody` schema round-trips its zod
  ...
  discriminated union is a `oneOf`/discriminator. Proven by generator unit tests. ([validated by `build-document.test.ts:81`](apps/lore-api/src/transport/openapi/build-document.test.ts#L78), [`build-document.test.ts:72`](apps/lore-api/src/transport/openapi/build-document.test.ts#L69))
...
- **SC-5** Per-route scope and rate-limit bucket appear as `x-required-scope` /
  ...
  operations are `security: []`. ([validated by `build-document.test.ts:136`](apps/lore-api/src/transport/openapi/build-document.test.ts#L127))
