...
([`zodValidate`](../../apps/lore-api/src/transport/http/zod-validate.ts)): each
...
- The routes are registered in **one place** —
  [`build-server.ts`](../../apps/lore-api/src/app/build-server.ts) `server.route([...])` —
...
- **agents** (`agents.ts`) — the domain validator IS an exported zod schema
  ([`AgentInputSchema`](apps/lore-api/src/work/agents/agents-schema.ts)).
- **dark-factory** (`dark-factory.ts`) — likewise
  ([`DarkFactorySettingsSchema`](apps/lore-api/src/work/dark-factory/dark-factory-settings.ts)).
...
permissive `object`. ([validated by `build-document.test.ts:52`](apps/lore-api/src/transport/openapi/build-document.test.ts#L52), [validated by `build-document.test.ts:61`](apps/lore-api/src/transport/openapi/build-document.test.ts#L61), [validated by `build-document.test.ts:88`](apps/lore-api/src/transport/openapi/build-document.test.ts#L88), [validated by `build-document.test.ts:96`](apps/lore-api/src/transport/openapi/build-document.test.ts#L96))
...
- The rate-limit bucket (`webhook` / `task` / `default`) is a `x-rate-limit-bucket`
  ...
  [rate-limit plugin](../../apps/lore-api/src/transport/http/rate-limit.ts) uses.
...
- Every route whose method can carry a body (`POST`/`PUT`/`DELETE`/`*`) either
  ...
  the doc cannot silently rot. (Design fork 5.) ([validated by `coverage.test.ts:28`](apps/lore-api/src/transport/openapi/coverage.test.ts#L22), [validated by `build-document.test.ts:41`](apps/lore-api/src/transport/openapi/build-document.test.ts#L41))
...
- The output is a structurally valid OpenAPI 3.1 document (`openapi: "3.1.0"`,
  ...
  every `requestBody` is an `application/json` schema. ([validated by `coverage.test.ts:123`](apps/lore-api/src/transport/openapi/coverage.test.ts#L111), [validated by `coverage.test.ts:136`](apps/lore-api/src/transport/openapi/coverage.test.ts#L124), [validated by `coverage.test.ts:147`](apps/lore-api/src/transport/openapi/coverage.test.ts#L135))
...
- **FR1** `zodValidate(schema)` stamps the raw zod schema onto the validation
  ...
  (parse → typed data → `{ error }` 400) is unchanged. ([validated by `zod-validate.test.ts:29`](apps/lore-api/src/transport/http/zod-validate.test.ts#L29), [`zod-validate.test.ts:17`](apps/lore-api/src/transport/http/zod-validate.test.ts#L17))
...
- **FR3** `buildOpenApiDocument(routes)` produces an OpenAPI **3.1.0** document
  ...
  defaults `servers` to the relative root when no `serverUrl` is given. ([validated by `build-document.test.ts:29`](apps/lore-api/src/transport/openapi/build-document.test.ts#L29), [validated by `build-document.test.ts:33`](apps/lore-api/src/transport/openapi/build-document.test.ts#L33), [validated by `build-document.test.ts:211`](apps/lore-api/src/transport/openapi/build-document.test.ts#L211))
- **FR4** Auth is modelled as a `bearerAuth` security scheme; authed operations set
  `security: [{ bearerAuth: [] }]`, HMAC webhook operations set `security: []`. ([validated by `build-document.test.ts:13`](apps/lore-api/src/transport/openapi/build-document.test.ts#L13), [`build-document.test.ts:148`](apps/lore-api/src/transport/openapi/build-document.test.ts#L148))
- **FR4b** A `parse:false` route that declares `options.app.rawBody` is a real raw-body
  ...
  (`type: string`) instead of the generic HMAC boilerplate. ([validated by `build-document.test.ts:230`](apps/lore-api/src/transport/openapi/build-document.test.ts#L230))
- **FR5** `GET /api/openapi.json` (read scope) serves the document. `GET /api/docs`
  ...
  before the handler runs. ([validated by `openapi.test.ts:28`](apps/lore-api/src/transport/routes/openapi/openapi.test.ts#L28), [`openapi.test.ts:63`](apps/lore-api/src/transport/routes/openapi/openapi.test.ts#L63), [validated by `openapi.test.ts:41`](apps/lore-api/src/transport/routes/openapi/openapi.test.ts#L41), [validated by `openapi.test.ts:48`](apps/lore-api/src/transport/routes/openapi/openapi.test.ts#L48))
...
- **FR7** Non-API operational paths (`/healthz`, `/dist/*`) are excluded from the
  document and the exclusion is logged, not silent. ([validated by `build-document.test.ts:45`](apps/lore-api/src/transport/openapi/build-document.test.ts#L45), [`coverage.test.ts:90`](apps/lore-api/src/transport/openapi/coverage.test.ts#L90))
...
- **FR8** Operations are grouped into Redoc sidebar categories: the tags are
  ...
  assigned exactly one declared category. ([validated by `build-document.test.ts:160`](apps/lore-api/src/transport/openapi/build-document.test.ts#L160), [validated by `build-document.test.ts:181`](apps/lore-api/src/transport/openapi/build-document.test.ts#L181), [validated by `coverage.test.ts:109`](apps/lore-api/src/transport/openapi/coverage.test.ts#L97))
- **FR9** *(added 2026-08-13)* A route MAY declare its success body, and the Features surface does. `zodResponse(base, schema, opts)` stamps the schema onto `options.plugins.openapi` and the generator registers it as a NAMED component so codegen emits one type per shape rather than an anonymous inline one. It merges onto a base options object rather than returning a standalone one: `bearerScope()` already owns `options.plugins`, so spreading two producers would silently clobber the bearer-scope key and drop the auth scope from every route it touched. A declared contract REPLACES the generic 200 — two success statuses would generate `RealBody | unknown`, which is the same as no type — and one component name registered with two different shapes is a hard error, because the document would serve the second and generate a client type that lies about the first. The coverage guard is scoped to the Features tag: the rest of the surface is request-focused by design, so a document-wide assertion would red-light routes for a contract they never claimed. ([validated by preserves the auth scope it is merged onto](apps/lore-api/src/transport/http/zod-response.test.ts#L9), [`zod-response.test.ts:19`](apps/lore-api/src/transport/http/zod-response.test.ts#L19), [`zod-response.test.ts:25`](apps/lore-api/src/transport/http/zod-response.test.ts#L25), [`zod-response.test.ts:38`](apps/lore-api/src/transport/http/zod-response.test.ts#L38), [`zod-response.test.ts:50`](apps/lore-api/src/transport/http/zod-response.test.ts#L50), [`coverage.test.ts:155`](apps/lore-api/src/transport/openapi/coverage.test.ts#L155), [`coverage.test.ts:159`](apps/lore-api/src/transport/openapi/coverage.test.ts#L159), [`coverage.test.ts:176`](apps/lore-api/src/transport/openapi/coverage.test.ts#L176); implemented by [`zod-response.ts:1`](apps/lore-api/src/transport/http/zod-response.ts#L1))
- **FR10** *(added 2026-08-13)* The document is COMMITTED as `apps/lore-api/openapi.json`, and `apps/web-ui/src/lib/api/schema.d.ts` is generated from it by `openapi-typescript`. Generating inside web-ui is not possible — its Docker context is `apps/web-ui`, so lore-api is unreachable at image-build time — so both artifacts are checked in and `scripts/check-openapi-drift.sh` (the `openapi-drift` PR check) regenerates and diffs them. The write is a CLI entry point, not a module side effect, and carries no environment-derived server URL, no timestamp and no pool: a guard that compares a regenerated file against the committed one turns any environmental input into a red run on an unrelated PR. The guard also fails when an artifact is UNTRACKED, since `git diff` says nothing about a file git does not know. This retires `scripts/type-drift/feature-types.drift.ts` — web-ui's `feature-types.ts` is now aliases over the generated schema rather than 162 hand-written lines. `sectionsOf` stays hand-duplicated in `gap-sections.ts`: it is runtime code a `.d.ts` cannot carry, and the planning pages read `gap_result` straight from Postgres, so no server hop could normalize legacy rows away. ([validated by is written next to lore-api's package.json](apps/lore-api/src/transport/openapi/gen-openapi.test.ts#L8), [`gen-openapi.test.ts:14`](apps/lore-api/src/transport/openapi/gen-openapi.test.ts#L14), [`gen-openapi.test.ts:20`](apps/lore-api/src/transport/openapi/gen-openapi.test.ts#L20), [`gen-openapi.test.ts:28`](apps/lore-api/src/transport/openapi/gen-openapi.test.ts#L28), [`gen-openapi.test.ts:35`](apps/lore-api/src/transport/openapi/gen-openapi.test.ts#L35); implemented by [`gen-openapi.ts:1`](apps/lore-api/src/transport/openapi/gen-openapi.ts#L1))
- **FR11** *(added 2026-08-14)* The web UI consumes this contract rather than the database, and `re-lint/no-sql-in-web-ui` enforces it: any string or template literal in the files `eslint.config.mjs` scopes it to (`apps/web-ui/src/**`) that reads as SQL — `SELECT`…`FROM` or `UPDATE`…`SET` across newlines and through `${interpolation}`, `INSERT INTO`, `DELETE FROM`, or DDL — is reported, pointing the author at a lore-api route plus the generated client. Detection requires the keywords UPPERCASE, the casing every query in this repo already uses, because a case-insensitive match flags ordinary UI copy ("Select a repo from the list") and a rule that cries wolf gets disabled rather than obeyed. It runs at `error`. It shipped at `warn` because 143 queries across 51 files predated the contract and a warning marked each as debt without red-lighting a repo that could not be fixed in one change; every one of those queries has since moved behind an lore-api route, `apps/web-ui/src/lib/db.ts` is deleted, and `pg` is no longer a web-ui dependency — so a new query would have to reintroduce the driver to run at all. The rule is what says so at review time rather than at deploy time. ([validated by any file the rule is scoped to is checked, with no built-in path gate](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L42), [validated by prose whose keywords are not SQL-cased](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L12), [`no-sql-in-web-ui.test.mjs:17`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L17), [`no-sql-in-web-ui.test.mjs:22`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L22), [`no-sql-in-web-ui.test.mjs:36`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L36), [`no-sql-in-web-ui.test.mjs:48`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L48), [`no-sql-in-web-ui.test.mjs:54`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L54), [`no-sql-in-web-ui.test.mjs:59`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L59), [`no-sql-in-web-ui.test.mjs:64`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L64), [`no-sql-in-web-ui.test.mjs:69`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L69), [`no-sql-in-web-ui.test.mjs:75`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L75), [`no-sql-in-web-ui.test.mjs:81`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.test.mjs#L81); implemented by [`no-sql-in-web-ui.mjs:1`](https://github.com/re-cinq/re-lint/blob/v0.1.1/src/rules/no-sql-in-web-ui.mjs#L1))
...
- **SC-2** Every `/api/*` route registered in `routeList` appears exactly once in
  ...
  hapi optional path param to `required: true` with an "optional" note. ([validated by `coverage.test.ts:44`](apps/lore-api/src/transport/openapi/coverage.test.ts#L38), [`build-document.test.ts:111`](apps/lore-api/src/transport/openapi/build-document.test.ts#L111), [validated by `build-document.test.ts:123`](apps/lore-api/src/transport/openapi/build-document.test.ts#L123))
- **SC-3** Every covered write route's `requestBody` schema round-trips its zod
  ...
  discriminated union is a `oneOf`/discriminator. Proven by generator unit tests. ([validated by `build-document.test.ts:81`](apps/lore-api/src/transport/openapi/build-document.test.ts#L81), [`build-document.test.ts:72`](apps/lore-api/src/transport/openapi/build-document.test.ts#L72))
- **SC-4** A body-bearing route with neither a `zodValidate` schema nor a sidecar
  ...
  test). ([validated by `coverage.test.ts:32`](apps/lore-api/src/transport/openapi/coverage.test.ts#L26))
- **SC-5** Per-route scope and rate-limit bucket appear as `x-required-scope` /
  ...
  operations are `security: []`. ([validated by `build-document.test.ts:136`](apps/lore-api/src/transport/openapi/build-document.test.ts#L136))
...
- **FR14** *(added 2026-08-20)* A DECLARED response contract is HELD TO the answer, not just written down. `zodResponse` is documentation-only by design — validating a response at runtime lets a doc comment 500 a working endpoint — so nothing in the serving path can notice a declaration that has gone wrong. An open document could not BE wrong; a named union can be wrong silently, and a generated client narrows over it. So the multiplexed memory surface carries a contract test that drives all five actions for real and parses every answer through the published schema. It runs against BOTH backends — the file fallback under a throwaway `$HOME`, and a migrated Postgres in the integration job — because one endpoint served by two backends is a lie half the time if only one of them satisfies the contract. Writing it is what surfaced the three places the two disagreed: the pool path's one-version read omitted the `key` it was asked for, and the fallback's search named no `source` while its listing answered whole entries where the pool answered a projection. The fallback was moved onto the pool path's answer rather than the union widened to cover both. ([validated by `memory-contract.test.ts:34`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L34), [`memory-contract.test.ts:45`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L45), [`memory-contract.test.ts:56`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L56), [`memory-contract.test.ts:67`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L67), [`memory-contract.test.ts:74`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L74), [`memory-contract.test.ts:85`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L85), [`memory-contract.test.ts:94`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L94), [`memory-contract.test.ts:112`](apps/lore-api/src/transport/routes/memory/memory-contract.test.ts#L112), [`memory-contract.test.ts:63`](apps/lore-api/src/integration-tests/memory-contract.test.ts#L63), [`memory-contract.test.ts:80`](apps/lore-api/src/integration-tests/memory-contract.test.ts#L80), [`memory-contract.test.ts:87`](apps/lore-api/src/integration-tests/memory-contract.test.ts#L87), [`memory-contract.test.ts:94`](apps/lore-api/src/integration-tests/memory-contract.test.ts#L94), [`memory-contract.test.ts:101`](apps/lore-api/src/integration-tests/memory-contract.test.ts#L101), [`memory-contract.test.ts:107`](apps/lore-api/src/integration-tests/memory-contract.test.ts#L107), [`memory-contract.test.ts:114`](apps/lore-api/src/integration-tests/memory-contract.test.ts#L114))
- **FR15** *(added 2026-08-20)* Every `method: "*"` route DECLARES whether it serves verbs or refuses them. `WILDCARD_METHODS` names the verbs a wildcard means to serve and `METHOD_NOT_ALLOWED_FALLBACKS` names the paths whose wildcard exists only to answer 405; a wildcard in neither table fails the coverage guard. The path-count assertion cannot see this case: a wildcard that means to serve a real verb on a path concrete verbs ALREADY document adds no new path key, so the operation goes missing from the document in silence. On a new path the same omission surfaces as a missing path — this closes the half that does not. ([validated by `coverage.test.ts:74`](apps/lore-api/src/transport/openapi/coverage.test.ts#L68); implemented by [`build-document.ts:145`](apps/lore-api/src/transport/openapi/build-document.ts#L145))
