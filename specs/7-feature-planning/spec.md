...
The submitted title and prompt are trimmed and required, capped at 256 and 8000 characters respectively, and rejected with a `ValidationError` otherwise. ([validated by `feature-input.test.ts:9`](libs/shared/src/feature-planning/feature-input.test.ts#L9), [`feature-input.test.ts:18`](libs/shared/src/feature-planning/feature-input.test.ts#L18), [`feature-input.test.ts:24`](libs/shared/src/feature-planning/feature-input.test.ts#L24), [`feature-input.test.ts:30`](libs/shared/src/feature-planning/feature-input.test.ts#L30), [`feature-input.test.ts:36`](libs/shared/src/feature-planning/feature-input.test.ts#L36))
