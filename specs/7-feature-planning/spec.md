...
- FR-15.10: A round that RESUMES the previous round's conversation sends only the author's reaction — no restatement of the draft, because the agent already holds its own last answer and re-sending it re-briefs the model on what it just said. Each comment nests under the section it lands on and each question's ASKED TEXT is quoted beside its answer: an id alone would not survive the CLI compacting the turn that asked it. Sections the author left alone are omitted — silence is not feedback, and listing every untouched section grows the turn back into the draft it exists to avoid. ([validated by nests each answered question under the section that asked it](libs/shared/src/feature-planning/planning-prompt.test.ts#L195), [`planning-prompt.test.ts:185`](libs/shared/src/feature-planning/planning-prompt.test.ts#L206), [`planning-prompt.test.ts:193`](libs/shared/src/feature-planning/planning-prompt.test.ts#L214), [`planning-prompt.test.ts:202`](libs/shared/src/feature-planning/planning-prompt.test.ts#L223), [`planning-prompt.test.ts:208`](libs/shared/src/feature-planning/planning-prompt.test.ts#L229), [`planning-prompt.test.ts:215`](libs/shared/src/feature-planning/planning-prompt.test.ts#L236), [`planning-prompt.test.ts:225`](libs/shared/src/feature-planning/planning-prompt.test.ts#L246))
