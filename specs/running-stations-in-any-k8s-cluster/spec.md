...
(`libs/shared/src/outbound/project/events/event-reporter-http.ts`) exists precisely so
...
- `pipeline.station_runs` gains `status text NOT NULL DEFAULT 'running'` with
  ...
  (`visits.some(v => v.outcome === null)`) is untouched. ([validated by `advance-line.test.ts:1005`](apps/floor/src/work/assembly-run/advance-line.test.ts#L1052))
- `started_at` keeps its NOT NULL row-creation meaning (now: enqueue time).
  ...
  execution. ([validated by `assembly-run-reaper.test.ts:156`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L157), [`assembly-run-reaper.test.ts:859`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L861), [`assembly-run-reaper.test.ts:139`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L140))
- A run that sits `queued` longer than a configurable queue-wait bound
  ...
  tag must say so, not report a generic infra timeout. ([validated by `assembly-run-reaper.test.ts:185`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L186), [`assembly-run-reaper.test.ts:709`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L711), [`assembly-run-reaper.test.ts:435`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L437), [`assembly-run-reaper.test.ts:253`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L254), [`assembly-run-reaper.test.ts:258`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L259), [`assembly-run-reaper.test.ts:179`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L180), [`assembly-run-reaper.test.ts:801`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L803))
...
- The sweep takes its clock and its queue-wait bound as inputs rather than
  ...
  past the bound without sleeping through it or mutating `process.env`. ([validated by [bounds the wait by the injected queueWaitMs rather than the ambient env](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L779), [reads the clock through the injected now, so a sweep can be aged without waiting](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L790))
- Requeueing (FR4) resets the **same row** back to `queued`, clearing
  ...
  not. ([validated by `assembly-run-reaper.test.ts:828`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L830), [`assembly-run-reaper.test.ts:128`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L129), [`assembly-run-reaper.test.ts:116`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L117), [`assembly-runs.contract.test.ts:1071`](libs/shared/src/outbound/project/assembly-runs/assembly-runs.contract.test.ts#L1071))
...
- Assembly-line YAML nodes accept an optional `required_tags` list in the
  ...
  `definitionHash`. ([validated by `required-tags.test.ts:49`](libs/shared/src/outbound/project/cluster-agents/required-tags.test.ts#L49), [`required-tags.test.ts:63`](libs/shared/src/outbound/project/cluster-agents/required-tags.test.ts#L63), [validated by `loader.test.ts:1001`](libs/assembly-lines/src/loader.test.ts#L1024), [`loader.test.ts:1019`](libs/assembly-lines/src/loader.test.ts#L1042), [`loader.test.ts:1027`](libs/assembly-lines/src/loader.test.ts#L1050), [`snapshot-graph.test.ts:88`](libs/assembly-lines/src/snapshot-graph.test.ts#L88), [`advance-line.test.ts:1063`](apps/floor/src/work/assembly-run/advance-line.test.ts#L1110), [`required-tags.test.ts:33`](libs/shared/src/outbound/project/cluster-agents/required-tags.test.ts#L33), [`required-tags.test.ts:41`](libs/shared/src/outbound/project/cluster-agents/required-tags.test.ts#L41), [`required-tags.test.ts:49`](libs/shared/src/outbound/project/cluster-agents/required-tags.test.ts#L49))
...
- A pod that downloads an input file (a planning pod's `plan.md`) fetches it
  ...
  endpoint never claims a pass that would start with no file. ([validated by requires agent-files of the cluster that claims a pod downloading plan.md, so a cluster that cannot serve it never takes the pass](apps/floor/src/work/assembly-run/advance-line.test.ts#L1137), [offers agent-files beside node:agent when LORE_AGENT_FILES_URL is set, so it claims the passes whose pods download a file](apps/cluster-agent/src/events/claim/registration.test.ts#L81))
...
- The Floor's launch seam writes the station run as `queued`, carrying the
  ...
  other than the pod being built from it. ([validated by arming a claimed row is a no-op, so a re-dispatch cannot rewrite what a pod is being built from](libs/shared/src/outbound/project/assembly-runs/assembly-runs.contract.test.ts#L1143), [`advance-line.test.ts:1005`](apps/floor/src/work/assembly-run/advance-line.test.ts#L1052), [`advance-line.test.ts:1090`](apps/floor/src/work/assembly-run/advance-line.test.ts#L1157), [`advance-line.test.ts:1103`](apps/floor/src/work/assembly-run/advance-line.test.ts#L1170), [`advance-line.test.ts:1130`](apps/floor/src/work/assembly-run/advance-line.test.ts#L1271))
...
- A claim the agent then fails to LAUNCH is handed back:
  ...
  catalog does not hold, a mint refused, a Secret write that lost its race —
  leaves a claimed row with nothing behind it. Unsaid, that row waits:
  centrally for the reaper to notice a missing CR, and on a satellite, whose
  CRs the centre cannot see, for the whole node budget. A hand-back is counted
  on the row *(amended 2026-09-14, #2006)*. A retryable cause requeues the
  same row, because it is usually about the cluster that claimed and another
  may launch it; the attempt that reaches `LORE_STATION_LAUNCH_ATTEMPTS`
  (default 3) fails the visit instead, and a cause no retry can clear — the
  shared classifier's permanent classes, including an installation token
  refused for a repository the App cannot reach — fails it on the first
  hand-back. The failed visit carries the launch error as its detail. The
  claim takes the fewest-attempts row first, so a visit that has bounced waits
  behind fresh work. The rule used to leave a returning row "for the
  queue-wait bound to end", which never happened: every requeue restarts that
  clock, so on 2026-09-12 and three times on 2026-09-14 one visit for the
  renamed `re-cinq/HAL-engine` was handed the next poll every fifteen seconds
...
- **The Floor settles a terminal run from the REPORT, never by reading the
  ...
  ([validated by settles the run from the event's own report, with no cluster read](apps/floor/src/events/handlers/kubernetes.test.ts#L21), [`kubernetes.test.ts:33`](apps/floor/src/events/handlers/kubernetes.test.ts#L33), [`kubernetes.test.ts:49`](apps/floor/src/events/handlers/kubernetes.test.ts#L49), [`kubernetes.test.ts:55`](apps/floor/src/events/handlers/kubernetes.test.ts#L55), [`agent-watcher-logic.test.ts:219`](apps/floor/src/domain/agent-watcher-logic.test.ts#L190), [`agent-watcher-logic.test.ts:240`](apps/floor/src/domain/agent-watcher-logic.test.ts#L211), [`agent-watcher-logic.test.ts:244`](apps/floor/src/domain/agent-watcher-logic.test.ts#L215), [`agent-watcher-logic.test.ts:248`](apps/floor/src/domain/agent-watcher-logic.test.ts#L219), [`agent-watcher-logic.test.ts:258`](apps/floor/src/domain/agent-watcher-logic.test.ts#L229))
- What the run was dispatched WITH is recovered from what the Floor wrote down —
  ...
  ([validated by reads what the run row recorded at dispatch, not what a cluster still holds](apps/floor/src/domain/agent-watcher-logic.test.ts#L257), [`agent-watcher-logic.test.ts:309`](apps/floor/src/domain/agent-watcher-logic.test.ts#L280), [`agent-watcher-logic.test.ts:326`](apps/floor/src/domain/agent-watcher-logic.test.ts#L297), [`agent-watcher-logic.test.ts:338`](apps/floor/src/domain/agent-watcher-logic.test.ts#L309), [`agent-watcher-logic.test.ts:350`](apps/floor/src/domain/agent-watcher-logic.test.ts#L321), [`agent-watcher-logic.test.ts:295`](apps/floor/src/domain/agent-watcher-logic.test.ts#L266))
...
- The acceptance tier therefore spans registry → claim → walk → reaper on the
  ...
  rather than failing over to the other. ([validated by `assembly-run-reaper.test.ts:1255`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L1259), [`single-cr-dispatch-acceptance.test.ts:188`](apps/floor/src/work/station/single-cr-dispatch-acceptance.test.ts#L188), [`single-cr-dispatch-acceptance.test.ts:175`](apps/floor/src/work/station/single-cr-dispatch-acceptance.test.ts#L175))
...
- The reaper's CR-status recovery arm (`readAgentStatus` → relaunch on null)
  ...
  duplicate central launch. ([validated by `assembly-run-reaper.test.ts:191`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L192), [`assembly-run-reaper.test.ts:204`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L205), [`assembly-run-reaper.test.ts:812`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L814), [`cr-visibility.test.ts:5`](apps/floor/src/work/assembly-run/cr-visibility.test.ts#L5), [`cr-visibility.test.ts:11`](apps/floor/src/work/assembly-run/cr-visibility.test.ts#L11), [`cr-visibility.test.ts:20`](apps/floor/src/work/assembly-run/cr-visibility.test.ts#L20), [`cr-visibility.test.ts:29`](apps/floor/src/work/assembly-run/cr-visibility.test.ts#L29), [`cr-visibility.test.ts:35`](apps/floor/src/work/assembly-run/cr-visibility.test.ts#L35))
...
- A duplicate terminal delivery that carries no status for a node whose first
  ...
  2026-09-09). ([validated by `node-event-handler.test.ts:441`](apps/floor/src/work/assembly-run/node-event-handler.test.ts#L443))
...
- A run claimed by an **offline** agent is reset to `queued` (same row, per
  ...
  dead attempt pushed. ([validated by an offline claimant flips nothing on a queued row](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L1024), [`assembly-run-reaper.test.ts:1006`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L1010), [`assembly-run-reaper.test.ts:1020`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L1024), [`assembly-run-reaper.test.ts:1097`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L1101))
...
- **A cluster forgets what it finished with** *(added 2026-08-30)*. Every run
  ...
  ([validated by [deletes a terminal CR older than the retention window](apps/cluster-agent/src/work/reap/decide-prune.test.ts#L45), [keeps a terminal CR inside the window, which is the forensic record](apps/cluster-agent/src/work/reap/decide-prune.test.ts#L51), [never deletes a CR that has not gone terminal, however old](apps/cluster-agent/src/work/reap/decide-prune.test.ts#L57), [bounds one tick, so a first sweep over a backlog does not storm the apiserver](apps/cluster-agent/src/work/reap/decide-prune.test.ts#L66), [keeps three days of evidence by default](apps/cluster-agent/src/work/reap/prune-loop.test.ts#L139), [ignores a zero or unparseable retention rather than deleting everything](apps/cluster-agent/src/work/reap/prune-loop.test.ts#L146), [sweeps hourly unless the environment says otherwise](apps/cluster-agent/src/work/reap/prune-loop.test.ts#L132); implemented by [`decide-prune.ts`](apps/cluster-agent/src/work/reap/decide-prune.ts))
...
- A web-ui page renders that list, marking offline agents and linking the
  ...
  `clusterAgentId` open-claim filter). ([validated by `assembly-runs.contract.test.ts:1110`](libs/shared/src/outbound/project/assembly-runs/assembly-runs.contract.test.ts#L1110), [validated by `ClusterAgentsView.test.tsx:65`](apps/web-ui/src/app/cluster-agents/ClusterAgentsView.test.tsx#L61), [`ClusterAgentsView.test.tsx:89`](apps/web-ui/src/app/cluster-agents/ClusterAgentsView.test.tsx#L89), [`ClusterAgentsView.test.tsx:107`](apps/web-ui/src/app/cluster-agents/ClusterAgentsView.test.tsx#L107), [`cluster-agents.test.ts:29`](apps/web-ui/src/lib/api/cluster-agents.test.ts#L29))
...
4. **The push path is deleted** once no pre-flip run is open: the launch
   ...
   **Done 2026-08-29.** What remained was the half the flip did not cover —
   ...
   which previously bounded nothing. ([validated by `assembly-run-reaper.test.ts:506`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L508), [`assembly-run-reaper.test.ts:530`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L532))
