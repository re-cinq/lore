...
2. Tasks survive rollout restarts via the lease backend.
   ([validated by `lease-backends.test.ts:14`](libs/shared/src/project/leases/lease-backends.test.ts#L14),
   [`lease-backends.test.ts:142`](libs/shared/src/project/leases/lease-backends.test.ts#L142))
