...
9. The cron `spec_coverage_backfill` runs weekly (Mon 11:00 UTC) and on demand, segments + classifies + judges each spec's testable un-linked statements, and **opens a PR per spec** adding the suggested `([validated by ...](path#Lline))` parentheticals; no DB writes. `proposeLinkInsertions` inserts the trailing parenthetical at the matched statement — composing a unified-diff preview, collapsing multiple suggestions for one statement into a single comma-separated paren, omitting the `#Lline` anchor when the line is null, returning content unchanged for no suggestions, and skipping an already-linked or drifted (statement_text not-found) suggestion — while `pickStatementsForBackfill` returns only the testable statements with no existing trailing link, excluding already-linked, untestable, or unclassified ones. ([validated by `spec-coverage-backfill.test.ts:28`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L28), [`spec-judge.test.ts:160`](libs/shared/src/work/spec-judge.test.ts#L160), [`spec-judge.test.ts:237`](libs/shared/src/work/spec-judge.test.ts#L237), [`diff-preview`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L44), [`skip-linked`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L56), [`skip-drift`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L72), [`collapse-paren`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L84), [`null-anchor`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L109), [`no-suggestions`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L119), [`pick-unlinked`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L141), [`pick-excl-linked`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L158), [`pick-excl-untestable`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L172), [`pick-all-linked`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L186), [`pick-none-testable`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L199), [`pick-no-classification`](libs/shared/src/work/detect/spec-coverage-backfill.test.ts#L209))
...
13. The backfill judge pipeline is deterministic where it can be: `featureDir` extraction (feature folder under `specs/`, parent dir otherwise, null for a bare filename), slug-token directory affinity, cosine similarity (1 for identical, 0 for orthogonal / empty / length-mismatched / zero-magnitude vectors), pgvector-string parsing, assertion-name referencing (case-insensitive, skips names under three characters), symbol-name normalization, and `hashSpecContent` (stable 64-char sha-256, distinct per content) are pure; `selectCandidates` ranks assertion-overlap then directory affinity then embedding proximity, skips non-test files and chunks with no test name, dedups by test keeping the strongest signal, and caps at `maxCandidates` flagging truncation; `judgeLink` keeps the highest-scoring judgment per test and drops non-matches and sub-threshold scores; the re-run diff returns links and ordinals no longer confirmed this run. The LLM judge returns the model tool call's assertions (propagating the caller's `jobName` for cost accounting) or `[]` when the model yields no assertions field. ([validated by `spec-judge:21`](libs/shared/src/work/spec-judge.test.ts#L21), [validated by `spec-judge:27`](libs/shared/src/work/spec-judge.test.ts#L27), [validated by `spec-judge:31`](libs/shared/src/work/spec-judge.test.ts#L31), [validated by `spec-judge:37`](libs/shared/src/work/spec-judge.test.ts#L37), [validated by `spec-judge:46`](libs/shared/src/work/spec-judge.test.ts#L46), [validated by `spec-judge:55`](libs/shared/src/work/spec-judge.test.ts#L55), [validated by `spec-judge:63`](libs/shared/src/work/spec-judge.test.ts#L63), [validated by `spec-judge:67`](libs/shared/src/work/spec-judge.test.ts#L67), [validated by `spec-judge:71`](libs/shared/src/work/spec-judge.test.ts#L71), [validated by `spec-judge:76`](libs/shared/src/work/spec-judge.test.ts#L76), [validated by `spec-judge:87`](libs/shared/src/work/spec-judge.test.ts#L87), [validated by `spec-judge:93`](libs/shared/src/work/spec-judge.test.ts#L93), [validated by `spec-judge:97`](libs/shared/src/work/spec-judge.test.ts#L97), [validated by `spec-judge:103`](libs/shared/src/work/spec-judge.test.ts#L103), [validated by `spec-judge:112`](libs/shared/src/work/spec-judge.test.ts#L112), [validated by `spec-judge:118`](libs/shared/src/work/spec-judge.test.ts#L118), [validated by `spec-judge:125`](libs/shared/src/work/spec-judge.test.ts#L125), [validated by `spec-judge:129`](libs/shared/src/work/spec-judge.test.ts#L129), [validated by `spec-judge:133`](libs/shared/src/work/spec-judge.test.ts#L133), [validated by `spec-judge:171`](libs/shared/src/work/spec-judge.test.ts#L171), [validated by `spec-judge:187`](libs/shared/src/work/spec-judge.test.ts#L187), [validated by `spec-judge:196`](libs/shared/src/work/spec-judge.test.ts#L196), [validated by `spec-judge:208`](libs/shared/src/work/spec-judge.test.ts#L208), [validated by `spec-judge:247`](libs/shared/src/work/spec-judge.test.ts#L247), [validated by `spec-judge:254`](libs/shared/src/work/spec-judge.test.ts#L254), [validated by `spec-judge:267`](libs/shared/src/work/spec-judge.test.ts#L267), [validated by `spec-judge:273`](libs/shared/src/work/spec-judge.test.ts#L273), [validated by `spec-judge:280`](libs/shared/src/work/spec-judge.test.ts#L280), [validated by `spec-judge-llm:9`](libs/shared/src/work/spec-judge-llm.test.ts#L9), [validated by `spec-judge-llm:32`](libs/shared/src/work/spec-judge-llm.test.ts#L32), [validated by `spec-judge-llm:42`](libs/shared/src/work/spec-judge-llm.test.ts#L42))
