...
26. `SpecDetails` sanitizes the spec markdown after raw-HTML parsing and before statement highlighting: an injected `<script>` is stripped while statement `<mark>` wrapping still applies, an `onerror` attribute is removed from raw `<img>` HTML, a `javascript:` href is stripped from a raw anchor, and an injected `<svg onload>` is dropped. ([validated by `SpecDetails.test.tsx:379`](apps/web-ui/src/app/repos/[owner]/[repo]/specs/SpecDetails.test.tsx#L379), [`SpecDetails.test.tsx:397`](apps/web-ui/src/app/repos/[owner]/[repo]/specs/SpecDetails.test.tsx#L397), [`SpecDetails.test.tsx:407`](apps/web-ui/src/app/repos/[owner]/[repo]/specs/SpecDetails.test.tsx#L407), [`SpecDetails.test.tsx:416`](apps/web-ui/src/app/repos/[owner]/[repo]/specs/SpecDetails.test.tsx#L416))
