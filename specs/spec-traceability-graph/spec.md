...
24. `dispatchSpecTrace` routes by kind family: `specs`/`adrs` project from the repo (returning a graph-ingest audit/log), `test-report` → `ingestTestReport`, `coverage` → `ingestCoverageReport`; an unrecognized kind routes to `ingestSpecTrace`, which rejects with an error naming the kind without reading the repo. ([validated by `spec-trace-dispatch:25`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L25), [validated by `spec-trace-dispatch:47`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L47), [validated by `ingest-spec-trace:114`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L114), [validated by `ingest-spec-trace:149`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L149), [validated by `ingest-spec-trace-unknown-kind:17`](libs/shared/src/spec-trace/ingest-spec-trace-unknown-kind.test.ts#L17))
