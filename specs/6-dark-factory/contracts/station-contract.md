...
(`apps/floor/src/work/assembly-run/floor-assembly-run.ts`); parsed by
`libs/shared/src/domain/station-input.ts` (the reference zod schema, shared by both images since #1248):
