...
- **FR6.7** The `assembly_line.start` handler MUST be the sole executor entry: it validates the definition (an unknown definition closes the row as failed and resolves — configuration errors never retry), marks the row running, routes by definition shape (detect-shaped definitions to the repo-less detect runner; every other definition to the Floor AssemblyLine, one Agent CR per node), and fire-and-backgrounds the run so the event loop is never blocked by a minutes-long walk; the background continuation closes the row (terminal task status on the station path is the agent-watcher's, not the handler's). ([validated by `start-event-handler.test.ts:115`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L115), [`start-event-handler.test.ts:189`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L189), [`start-event-handler.test.ts:205`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L205), [`start-event-handler.test.ts:244`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L244); implemented by [`start-event-handler.ts:39`](apps/floor/src/jobs/assembly-line/start-event-handler.ts#L39))
