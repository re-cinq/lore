...
- **FR2.1** Assembly line definitions MUST live as YAML files outside of TypeScript code, in a directory parallel to `scripts/task-types.yaml`. No alternate formats (DOT, JSON, custom DSL) are introduced; web-ui renders the graph from YAML directly. ([validated by `loader.test.ts:38`](libs/assembly-lines/src/loader.test.ts#L38), [`loader.test.ts:47`](libs/assembly-lines/src/loader.test.ts#L47), [`loader.test.ts:53`](libs/assembly-lines/src/loader.test.ts#L53), [`loader.test.ts:69`](libs/assembly-lines/src/loader.test.ts#L69), [`loader.test.ts:85`](libs/assembly-lines/src/loader.test.ts#L85), [`loader.test.ts:104`](libs/assembly-lines/src/loader.test.ts#L104), [`loader.test.ts:127`](libs/assembly-lines/src/loader.test.ts#L127), [`loader.test.ts:296`](libs/assembly-lines/src/loader.test.ts#L322); implemented by [`loader.ts:63`](libs/assembly-lines/src/loader.ts#L63))
...
- **FR2.4** Existing flows (implementation, gap-fill, runbook, review, feature-request, onboard, general) MUST be migratable to graph definitions without losing current behavior. ([validated by `loader.test.ts:389`](libs/assembly-lines/src/loader.test.ts#L417), [`loader.test.ts:340`](libs/assembly-lines/src/loader.test.ts#L369), [`loader.test.ts:359`](libs/assembly-lines/src/loader.test.ts#L386), [`loader.test.ts:380`](libs/assembly-lines/src/loader.test.ts#L396), [`loader.test.ts:400`](libs/assembly-lines/src/loader.test.ts#L426), [`loader.test.ts:413`](libs/assembly-lines/src/loader.test.ts#L437); implemented by [`loader.ts:138`](libs/assembly-lines/src/loader.ts#L138))
...
- **FR2.7** *(added 2026-07-23, #946)* The loader MUST reject, at load time, a definition in which any non-exit node lacks an edge (exact-outcome or `always`) for an outcome its node type can produce — every type produces `success` and `failed` (infrastructure failure: CR phase Failed, station timeout), and agent nodes additionally `changes_requested` (LORE_NODE_RESULT / REVIEW_RESULT verdict lines). The error names the node, the missing outcome(s), and the definition; an uncovered outcome must never surface as `nextTransition`'s runtime no-edge walk crash. ([validated by `loader.test.ts:458`](libs/assembly-lines/src/loader.test.ts#L458), [`loader.test.ts:482`](libs/assembly-lines/src/loader.test.ts#L482), [`loader.test.ts:508`](libs/assembly-lines/src/loader.test.ts#L508), [`loader.test.ts:531`](libs/assembly-lines/src/loader.test.ts#L531), [`loader.test.ts:561`](libs/assembly-lines/src/loader.test.ts#L561), [`loader.test.ts:582`](libs/assembly-lines/src/loader.test.ts#L582), [`loader.test.ts:623`](libs/assembly-lines/src/loader.test.ts#L623), [`loader.test.ts:630`](libs/assembly-lines/src/loader.test.ts#L630), [`loader.test.ts:637`](libs/assembly-lines/src/loader.test.ts#L637); implemented by [`loader.ts:91`](libs/assembly-lines/src/loader.ts#L91))
...
- **FR3.3** Sub-setting `auto_merge` MUST express path allowlist, minimum repo trust level, CI requirement, and bot-approval requirement. Default paths: `specs/`, `adrs/`, `*.md`, `CLAUDE.md`, `.claude/`. Default min trust: `docs`. ([validated by `pr-policy.test.ts:102`](apps/floor/src/jobs/platform/pr-policy.test.ts#L102), [`pr-policy.test.ts:92`](apps/floor/src/jobs/platform/pr-policy.test.ts#L92), [`pr-policy.test.ts:129`](apps/floor/src/jobs/platform/pr-policy.test.ts#L129), [`pr-policy.test.ts:141`](apps/floor/src/jobs/platform/pr-policy.test.ts#L141), [`pr-policy.test.ts:151`](apps/floor/src/jobs/platform/pr-policy.test.ts#L151), [`pr-policy.test.ts:166`](apps/floor/src/jobs/platform/pr-policy.test.ts#L166), [`pr-policy.test.ts:178`](apps/floor/src/jobs/platform/pr-policy.test.ts#L178), [`pr-policy.test.ts:190`](apps/floor/src/jobs/platform/pr-policy.test.ts#L190), [`pr-policy.test.ts:202`](apps/floor/src/jobs/platform/pr-policy.test.ts#L202); implemented by [`auto-merge.ts:60`](apps/floor/src/jobs/merge/auto-merge.ts#L64), [`path-match.ts:18`](libs/shared/src/path-match.ts#L18))
...
- **FR6.6** *(restated 2026-07)* Every node execution — including back-edge re-iterations — MUST be recorded in `pipeline.assembly_line_nodes`: `ensureNodeStart` before the CR launches (with the CR name), `finishNodeOnce` at its terminal outcome. The rows ARE the walk state (FR6.9), not an observability side-channel. ([validated by `assembly-lines.test.ts:546`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L546), [`advance.test.ts:115`](apps/floor/src/jobs/assembly-line/advance.test.ts#L115), [`assembly-lines.test.ts:340`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L340), [`assembly-lines.test.ts:523`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L523), [`assembly-lines.test.ts:567`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L567), [`assembly-lines.test.ts:589`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L589), [`assembly-lines.test.ts:608`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L608), [`assembly-lines.test.ts:625`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L625), [`assembly-lines.test.ts:652`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L652), [`assembly-lines.test.ts:712`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L712), [`assembly-lines.test.ts:667`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L667), [`assembly-lines.test.ts:688`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L688), [`assembly-lines.test.ts:700`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L700), [`assembly-lines.test.ts:725`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L725); implemented by [`assembly-lines-pg.ts:77`](libs/shared/src/project/assembly-lines/assembly-lines-pg.ts#L77), [`advance.ts:215`](apps/floor/src/jobs/assembly-line/advance.ts#L215))

- **FR6.7** *(rewritten 2026-07: event-driven walk)* The `assembly_line.start` handler MUST be the sole executor entry: it validates the definition (a task-less row with an unknown definition closes as failed and resolves — configuration errors never retry), marks the row running, and routes by definition shape (detect-shaped definitions to the repo-less detect runner; single-CR rows — task-backed, no builtin definition — mark running and return, per FR6.8; every other definition launches the ENTRY node's Agent CR and returns). It neither clones, nor supervises, nor backgrounds a walk — the walk advances per FR6.9, so a Floor restart loses nothing. A launch failure propagates so the event loop retries (the advance path is idempotent end to end). ([validated by `start-event-handler.test.ts:87`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L87), [`start-event-handler.test.ts:111`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L111), [`start-event-handler.test.ts:127`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L127), [`start-event-handler.test.ts:141`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L141), [`start-event-handler.test.ts:99`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L99), [`start-event-handler.test.ts:198`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L198); implemented by [`start-event-handler.ts:36`](apps/floor/src/jobs/assembly-line/start-event-handler.ts#L36), [`advance.ts:110`](apps/floor/src/jobs/assembly-line/advance.ts#L110))
...
- **FR6.9** The walk MUST be event-driven and idempotent: node CRs carry `lore.re-cinq.com/assembly-line-id` (full uuid) + `node-id` + `iteration` labels; their terminal phases produce `kubernetes.agent_node.{succeeded,failed}` events deduped PER CR (`k8s:<crName>:<phase>` — all node CRs of one line share the synthetic task-id label, so a task-keyed dedupe would swallow every node after the first). CR names embed the iteration on revisits (`<assemblyLineId:12>-<nodeId>`, `-<iteration>` appended when iteration > 1) so a revisited node runs a fresh pod rather than 409-reusing the prior iteration's terminal CR. The transition handler parses the outcome (LORE_NODE_RESULT → REVIEW_RESULT → phase precedence), records it via compare-and-set, and re-derives the next step purely from the persisted node rows (`nextTransition` replays the executor's exact edge/iteration_max routing). Duplicate and concurrent transitions MUST converge structurally: UNIQUE `(assembly_line_id, node_id, iteration)`, CAS node outcome, first-writer-wins row finish, 409-idempotent CR creates. The single-agent watcher path MUST never process labeled node CRs. ([validated by `k8s-map.test.ts:23`](apps/floor/src/listeners/k8s-map.test.ts#L23), [`node-event-handler.test.ts:94`](apps/floor/src/jobs/assembly-line/node-event-handler.test.ts#L94), [`advance.test.ts:134`](apps/floor/src/jobs/assembly-line/advance.test.ts#L134), [`transition.test.ts:172`](libs/assembly-lines/src/transition.test.ts#L172), [`advance.test.ts:148`](apps/floor/src/jobs/assembly-line/advance.test.ts#L148), [`advance.test.ts:160`](apps/floor/src/jobs/assembly-line/advance.test.ts#L160), [`advance.test.ts:178`](apps/floor/src/jobs/assembly-line/advance.test.ts#L178), [`advance.test.ts:223`](apps/floor/src/jobs/assembly-line/advance.test.ts#L223), [`advance.test.ts:262`](apps/floor/src/jobs/assembly-line/advance.test.ts#L262), [`advance.test.ts:286`](apps/floor/src/jobs/assembly-line/advance.test.ts#L286), [`advance.test.ts:352`](apps/floor/src/jobs/assembly-line/advance.test.ts#L352), [`advance.test.ts:407`](apps/floor/src/jobs/assembly-line/advance.test.ts#L407), [`advance.test.ts:425`](apps/floor/src/jobs/assembly-line/advance.test.ts#L425), [`advance.test.ts:544`](apps/floor/src/jobs/assembly-line/advance.test.ts#L544), [`node-event-handler.test.ts:139`](apps/floor/src/jobs/assembly-line/node-event-handler.test.ts#L139), [`node-event-handler.test.ts:180`](apps/floor/src/jobs/assembly-line/node-event-handler.test.ts#L180), [`node-event-handler.test.ts:191`](apps/floor/src/jobs/assembly-line/node-event-handler.test.ts#L191), [`node-event-handler.test.ts:202`](apps/floor/src/jobs/assembly-line/node-event-handler.test.ts#L202), [`node-outcome.test.ts:34`](libs/assembly-lines/src/node-outcome.test.ts#L34), [`node-outcome.test.ts:41`](libs/assembly-lines/src/node-outcome.test.ts#L41), [`node-outcome.test.ts:48`](libs/assembly-lines/src/node-outcome.test.ts#L48), [`node-outcome.test.ts:61`](libs/assembly-lines/src/node-outcome.test.ts#L61), [`node-outcome.test.ts:76`](libs/assembly-lines/src/node-outcome.test.ts#L76), [`node-outcome.test.ts:93`](libs/assembly-lines/src/node-outcome.test.ts#L93), [`node-outcome.test.ts:130`](libs/assembly-lines/src/node-outcome.test.ts#L130), [`node-outcome.test.ts:137`](libs/assembly-lines/src/node-outcome.test.ts#L137); implemented by [`advance.ts:110`](apps/floor/src/jobs/assembly-line/advance.ts#L110), [`node-event-handler.ts:24`](apps/floor/src/jobs/assembly-line/node-event-handler.ts#L24), [`k8s-map.ts:37`](apps/floor/src/listeners/k8s-map.ts#L37))
...
- **FR6.11** An Agent's `status.output` is an NDJSON event stream whose terminal line carries the agent text inside a JSON string field (`{"type":"result","result":"…"}`), so newlines and any embedded JSON arrive escaped. The Floor MUST unwrap that envelope once, at the read boundary, before any text parser runs — a parser scanning for a single-line marker survives the escaping while one needing a real newline (the ```REVIEW_FINDINGS block) silently matches nothing, which yields a node that records `changes_requested` while the PR receives no review at all. Unwrapping MUST be idempotent so already-plain and legacy output pass through unchanged, and MUST (transitionally, until no pre-cutover CRs remain) also peel the ai-agent-subsystem's `{"source": {...}, "event": <line>}` attribution envelope that older runs stamped onto every stdout line — the result object rides at `.event` there. The duties a terminal node owes — post the review, record the outcome and advance, publish the PR check — MUST be shared by the event path and the reaper (FR6.10), and the review MUST be posted BEFORE the state transition, since both paths ignore a non-running row and a post attempted after it can never be repaired by a retry. A review that reaches a verdict but posts nothing, and a check that fails to publish, MUST be audited (`review_findings_unparsed` / `review_post_failed` / `pr_check_publish_failed`) rather than warned away — each is indistinguishable from a clean review at the PR. ([validated by `agent-output.test.ts:29`](libs/assembly-lines/src/agent-output.test.ts#L29), [`agent-output.test.ts:35`](libs/assembly-lines/src/agent-output.test.ts#L35), [`agent-output.test.ts:42`](libs/assembly-lines/src/agent-output.test.ts#L42), [`agent-output.test.ts:54`](libs/assembly-lines/src/agent-output.test.ts#L54), [`agent-output.test.ts:62`](libs/assembly-lines/src/agent-output.test.ts#L62), [`agent-output.test.ts:68`](libs/assembly-lines/src/agent-output.test.ts#L68), [`agent-output.test.ts:74`](libs/assembly-lines/src/agent-output.test.ts#L74), [`agent-output.test.ts:80`](libs/assembly-lines/src/agent-output.test.ts#L80), [`agent-output.test.ts:90`](libs/assembly-lines/src/agent-output.test.ts#L90), [`agent-output.test.ts:94`](libs/assembly-lines/src/agent-output.test.ts#L94), [`agent-output.test.ts:100`](libs/assembly-lines/src/agent-output.test.ts#L100), [`agent-output.test.ts:112`](libs/assembly-lines/src/agent-output.test.ts#L112), [`agent-output.test.ts:134`](libs/assembly-lines/src/agent-output.test.ts#L134), [`node-terminal.test.ts:111`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L111), [`node-terminal.test.ts:124`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L124), [`node-terminal.test.ts:130`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L130), [`node-event-handler.test.ts:157`](apps/floor/src/jobs/assembly-line/node-event-handler.test.ts#L157); implemented by [`agent-output.ts:119`](libs/assembly-lines/src/agent-output.ts#L119), [`node-terminal.ts:62`](apps/floor/src/jobs/assembly-line/node-terminal.ts#L62))
  - *(added 2026-07-30)* Because the post precedes the transition, a redelivered terminal event or an event-vs-reaper race re-executes it — #870: the same review posted twice on one PR. The post MUST be idempotent per node visit: every posted review, inline body and fallback comment alike, carries an invisible `<!-- lore-review-run: <line>/<node>/<iteration> -->` marker (iteration-keyed, so a legitimate revisit still posts), and the poster probes the PR's reviews and issue comments for that exact marker after the parse (a run that would post nothing spends no reads) and immediately before posting — found means skip, outcome `already_posted`, audited as `review_post_deduped`. The probe fails open: a poster without the read surface, an unknown iteration (guessing `1` would let a first post suppress a revisit's real review), or a probe error posts anyway, since a rare duplicate beats a dropped review; racers landing inside the probe-to-post window (seconds, not the redelivery gap that produced #870) remain the accepted residual. ([validated by `node-terminal.test.ts:448`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L448), [`node-terminal.test.ts:469`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L469), [`node-terminal.test.ts:483`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L483), [`node-terminal.test.ts:501`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L501), [`node-terminal.test.ts:517`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L517), [`node-terminal.test.ts:540`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L540), [`post-review.test.ts:276`](apps/floor/src/jobs/review/post-review.test.ts#L276), [`post-review.test.ts:280`](apps/floor/src/jobs/review/post-review.test.ts#L280), [`post-review.test.ts:288`](apps/floor/src/jobs/review/post-review.test.ts#L288), [`post-review.test.ts:296`](apps/floor/src/jobs/review/post-review.test.ts#L296), [`post-review.test.ts:325`](apps/floor/src/jobs/review/post-review.test.ts#L325), [`post-review.test.ts:331`](apps/floor/src/jobs/review/post-review.test.ts#L331), [`post-review.test.ts:337`](apps/floor/src/jobs/review/post-review.test.ts#L337), [`post-review.test.ts:344`](apps/floor/src/jobs/review/post-review.test.ts#L344), [`post-review.test.ts:348`](apps/floor/src/jobs/review/post-review.test.ts#L348), [`post-review.test.ts:368`](apps/floor/src/jobs/review/post-review.test.ts#L368), [`post-review.test.ts:391`](apps/floor/src/jobs/review/post-review.test.ts#L391), [`post-review.test.ts:415`](apps/floor/src/jobs/review/post-review.test.ts#L415), [`node-terminal.test.ts:550`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L550); implemented by [`post-review.ts:54`](apps/floor/src/jobs/review/post-review.ts#L54), [`post-review.ts:226`](apps/floor/src/jobs/review/post-review.ts#L226), [`node-terminal.ts:161`](apps/floor/src/jobs/assembly-line/node-terminal.ts#L161))
- **FR6.12** *(added 2026-07-17)* Every assembly-line closure with a failure outcome MUST notify the user through one generic seam — no definition-specific notification code. `finishLine` (the single closure path for the walk and the reaper) fires the notifier for any outcome outside the benign set (`completed`, `lease_held`, `pr_created`, `changes_requested`, `pr_closed`) and stays silent for benign closures, including the `lease_held` overlap defer. ([validated by `notify-failure.test.ts:32`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L32), [`notify-failure.test.ts:38`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L38), [`advance.test.ts:479`](apps/floor/src/jobs/assembly-line/advance.test.ts#L479), [`advance.test.ts:492`](apps/floor/src/jobs/assembly-line/advance.test.ts#L492); implemented by [`notify-failure.ts:26`](apps/floor/src/jobs/assembly-line/notify-failure.ts#L26), [`advance.ts:260`](apps/floor/src/jobs/assembly-line/advance.ts#L260))
  - Notification MUST fire exactly once per line — only the winner of the first-writer-wins `finish` CAS notifies (the port reports the win as its return value, in the Pg adapter and the in-memory double alike), and a notifier throw never fails the line transition or re-drives the event retry. ([validated by `advance.test.ts:458`](apps/floor/src/jobs/assembly-line/advance.test.ts#L510), [`advance.test.ts:472`](apps/floor/src/jobs/assembly-line/advance.test.ts#L524), [`assembly-lines.test.ts:97`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L97), [`assembly-lines.test.ts:295`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L295); implemented by [`assembly-lines-pg.ts:67`](libs/shared/src/project/assembly-lines/assembly-lines-pg.ts#L67))
  - Channels: an `escalation`-level message through the repo's `dark_factory.notify` routing carrying the definition, repo, outcome, reason, and run link; plus, when the line is PR-linked, a PR comment with the run link (and the `@lore review` re-run hint on `code-review` lines — omitted for other definitions; lines without a `pr_number` send no comment). Each send is best-effort: a failed send is audited as `failure_notify_failed` with its channel, and the other channel still fires. ([validated by `notify-failure.test.ts:48`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L48), [`notify-failure.test.ts:65`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L65), [`notify-failure.test.ts:80`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L80), [`notify-failure.test.ts:91`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L91), [`notify-failure.test.ts:138`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L138), [`notify-failure.test.ts:154`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L154), [`notify-failure.test.ts:168`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L168), [`notify-failure.test.ts:183`](apps/floor/src/jobs/assembly-line/notify-failure.test.ts#L183); implemented by [`notify-failure.ts:71`](apps/floor/src/jobs/assembly-line/notify-failure.ts#L71))
  - The one closure that bypasses `finishLine` — the start handler's task-less unknown-definition config error — notifies through the same contract, winner-gated so a redelivered start event never re-notifies. ([validated by `start-event-handler.test.ts:162`](apps/floor/src/jobs/assembly-line/start-event-handler.test.ts#L162); implemented by [`start-event-handler.ts:82`](apps/floor/src/jobs/assembly-line/start-event-handler.ts#L82))
- **FR6.13** *(added 2026-07-17)* A line's terminal state MUST be honest about node failures. A walk that reaches exit with a `failed` node visit closes the row with outcome `failed` and a `node "<id>" failed` reason instead of `completed` — every definition routes `failed` edges toward exit, so "completed" would render a green check over a failed review. ([validated by `advance.test.ts:464`](apps/floor/src/jobs/assembly-line/advance.test.ts#L464); implemented by [`advance.ts:55`](apps/floor/src/jobs/assembly-line/advance.ts#L55))
  - The PR check maps any non-benign line outcome (`failed`, `error`, `iteration_max`, ...) to a failure conclusion carrying the reason (plus the `@lore review` re-run hint on `code-review` lines) — keying on row status alone would miss it, since only `error` flips the status column. ([validated by `pr-check.test.ts:120`](apps/floor/src/jobs/assembly-line/pr-check.test.ts#L120), [`pr-check.test.ts:137`](apps/floor/src/jobs/assembly-line/pr-check.test.ts#L137), [`pr-check.test.ts:168`](apps/floor/src/jobs/assembly-line/pr-check.test.ts#L168); implemented by [`pr-check.ts:58`](apps/floor/src/jobs/assembly-line/pr-check.ts#L58))
  - The review post reports how it went (`posted` / `already_posted` / `no_findings` / `post_failed` / `not_review`), and the outage shape — no findings AND no verdict, e.g. an agent that could not read the diff yet exited 0 — records the node as `failed` rather than `success`, so the generic FR6.12 notification catches it. A verdict without a findings block stays untouched (a legitimate minimal approve), as do posted findings and non-review nodes. ([validated by `node-terminal.test.ts:255`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L255), [`node-terminal.test.ts:381`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L381), [`node-terminal.test.ts:393`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L393), [`node-terminal.test.ts:403`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L403), [`node-terminal.test.ts:413`](apps/floor/src/jobs/assembly-line/node-terminal.test.ts#L413); implemented by [`node-terminal.ts:82`](apps/floor/src/jobs/assembly-line/node-terminal.ts#L82))
...
- **FR1.6a** Definitions whose branch is a shared workspace rather than a per-run identity — `comment-triage` and `code-review-reply`, where every PR comment rides the PR's head branch carrying a distinct payload — are exempt from the branch-overlap guard, so a burst of comments is never silently dropped as `lease_held`. ([validated by `advance.test.ts:376`](apps/floor/src/jobs/assembly-line/advance.test.ts#L376))
- **FR1.6b** The assembly-lines runs list folds `lease_held` coordination skips away by default behind a toggle that reveals them in place, and renders a placeholder row when every run in view is a coordination skip. ([validated by `AssemblyLineRunsTable.test.tsx:97`](apps/web-ui/src/app/assembly-lines/AssemblyLineRunsTable.test.tsx#L97), [`AssemblyLineRunsTable.test.tsx:127`](apps/web-ui/src/app/assembly-lines/AssemblyLineRunsTable.test.tsx#L127), [`AssemblyLineRunsTable.test.tsx:154`](apps/web-ui/src/app/assembly-lines/AssemblyLineRunsTable.test.tsx#L154), [`AssemblyLineRunsTable.test.tsx:172`](apps/web-ui/src/app/assembly-lines/AssemblyLineRunsTable.test.tsx#L172))
