...
- **FR2.4** Existing flows (implementation, gap-fill, runbook, review, feature-request, onboard, general) MUST be migratable to graph definitions without losing current behavior. ([validated by `loader.test.ts:416`](libs/assembly-lines/src/loader.test.ts#L416), [`loader.test.ts:367`](libs/assembly-lines/src/loader.test.ts#L367), [`loader.test.ts:384`](libs/assembly-lines/src/loader.test.ts#L384), [`loader.test.ts:394`](libs/assembly-lines/src/loader.test.ts#L394), [`loader.test.ts:425`](libs/assembly-lines/src/loader.test.ts#L425), [`loader.test.ts:436`](libs/assembly-lines/src/loader.test.ts#L436); implemented by [`loader.ts:96`](libs/assembly-lines/src/loader.ts#L96))
