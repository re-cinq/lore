...
- **FR2.4** Existing flows (implementation, gap-fill, runbook, review, feature-request, onboard, general) MUST be migratable to graph definitions without losing current behavior. ([validated by `loader.test.ts:391`](libs/assembly-lines/src/loader.test.ts#L391), [`loader.test.ts:341`](libs/assembly-lines/src/loader.test.ts#L341), [`loader.test.ts:360`](libs/assembly-lines/src/loader.test.ts#L360), [`loader.test.ts:382`](libs/assembly-lines/src/loader.test.ts#L382), [`loader.test.ts:402`](libs/assembly-lines/src/loader.test.ts#L402), [`loader.test.ts:415`](libs/assembly-lines/src/loader.test.ts#L415); implemented by [`loader.ts:96`](libs/assembly-lines/src/loader.ts#L96))
