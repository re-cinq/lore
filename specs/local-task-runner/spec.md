...
3. Polling mode claims pending tasks before GKE (30s priority window) ([validated by `worker.test.ts:174`](apps/agent/src/worker.test.ts#L174), [`worker.test.ts:179`](apps/agent/src/worker.test.ts#L179))
