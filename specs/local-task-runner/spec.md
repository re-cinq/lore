...
3. Polling mode claims pending tasks before GKE (30s priority window) ([validated by `task-queue.test.ts:7`](libs/shared/src/project/tasks/task-queue.test.ts#L7), [`worker.test.ts:138`](apps/floor/src/work/task/worker.test.ts#L138))
