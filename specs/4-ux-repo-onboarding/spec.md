...
- FR-1.2: Repos are written to the registry on onboard (from the set the
  GitHub App has access to). ([validated by `repo-onboard.test.ts:118`](apps/lore-api/src/work/repo/repo-onboard.test.ts#L118))
...
- FR-2.11: *(added 2026-09-17)* Lore does not monitor a repo's setup; its
  owner UPDATES it by hand. The enrollment section carries a standing
  **Update Lore setup** trigger — standing because a setup that is complete
  but out of date fails no check, so no per-check action would offer it — and
  the API's and the MCP tool's `reonboard` reach the same run. That run is the
...
- FR-3.3: Overview tab shows recent tasks (PR + pipeline links,
  ...
  repo's Dark Factory mode. ([validated by `RepoOverviewView.test.tsx:94`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L90), [`RepoOverviewView.test.tsx:106`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L106), [`RepoOverviewView.test.tsx:147`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L147), [`RepoOverviewView.test.tsx:180`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L180), [`RepoOverviewView.test.tsx:192`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L192), [`RepoOverviewView.test.tsx:202`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L202), [`RepoOverviewView.test.tsx:231`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L231), [`EnrollmentSection.test.tsx:32`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L32), [`EnrollmentSection.test.tsx:70`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L70), [`EnrollmentSection.test.tsx:78`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L78), [`EnrollmentSection.test.tsx:105`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L105), [`ReonboardButton.test.tsx:7`](apps/web-ui/src/components/ReonboardButton.test.tsx#L7), [`ReonboardButton.test.tsx:21`](apps/web-ui/src/components/ReonboardButton.test.tsx#L21))
