...
- FR-1.4: MCP tool `lore_list_repos` returns all onboarded repos. ([validated by `repo-tools.test.ts:252`](apps/mcp-server/src/mcp/tools/repo-tools.test.ts#L252))
...
- FR-6.6: The Spend page (`/spend`) is Lore-computed-first (no admin key
  ...
  non-zero. ([validated by [`SpendView.test.tsx:175`](apps/web-ui/src/app/spend/SpendView.test.tsx#L175), [`SpendView.test.tsx:291`](apps/web-ui/src/app/spend/SpendView.test.tsx#L291), [`SpendView.test.tsx:302`](apps/web-ui/src/app/spend/SpendView.test.tsx#L302), [`SpendView.test.tsx:314`](apps/web-ui/src/app/spend/SpendView.test.tsx#L314), [`SpendView.test.tsx:323`](apps/web-ui/src/app/spend/SpendView.test.tsx#L323), [`SpendView.test.tsx:334`](apps/web-ui/src/app/spend/SpendView.test.tsx#L334), [`SpendView.test.tsx:353`](apps/web-ui/src/app/spend/SpendView.test.tsx#L353), [`SpendView.test.tsx:372`](apps/web-ui/src/app/spend/SpendView.test.tsx#L372), [`SpendView.test.tsx:380`](apps/web-ui/src/app/spend/SpendView.test.tsx#L380), [`SpendView.test.tsx:389`](apps/web-ui/src/app/spend/SpendView.test.tsx#L389), [`SpendView.test.tsx:401`](apps/web-ui/src/app/spend/SpendView.test.tsx#L401), [`SpendView.test.tsx:411`](apps/web-ui/src/app/spend/SpendView.test.tsx#L411), [`SpendView.test.tsx:419`](apps/web-ui/src/app/spend/SpendView.test.tsx#L419), [`SpendView.test.tsx:395`](apps/web-ui/src/app/spend/SpendView.test.tsx#L395))
...
- FR-6.11: The run-row mapper (`lib/assembly-runs`) resolves a
  ...
  still running). ([validated by `assembly-runs.test.ts:33`](apps/web-ui/src/lib/assembly-runs.test.ts#L33), [`assembly-runs.test.ts:47`](apps/web-ui/src/lib/assembly-runs.test.ts#L47), [`assembly-runs.test.ts:67`](apps/web-ui/src/lib/assembly-runs.test.ts#L67), [`assembly-runs.test.ts:84`](apps/web-ui/src/lib/assembly-runs.test.ts#L84), [`assembly-runs.test.ts:93`](apps/web-ui/src/lib/assembly-runs.test.ts#L93), [`assembly-runs.test.ts:118`](apps/web-ui/src/lib/assembly-runs.test.ts#L118))
