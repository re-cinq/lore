...
- FR-1.2: Repos are written to the registry on onboard (from the set the
  GitHub App has access to). ([validated by `repo-onboard.test.ts:120`](apps/lore-api/src/features/repo/repo-onboard.test.ts#L115))
...
- FR-1.4: MCP tool `lore_list_repos` returns all onboarded repos. ([validated by `repo-tools.test.ts:152`](apps/mcp-server/src/mcp/tools/repo-tools.test.ts#L152))
...
- FR-3.3: Overview tab shows recent tasks (PR + pipeline links,
  ...
  repo's Dark Factory mode. ([validated by `RepoOverviewView.test.tsx:94`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L90), [`RepoOverviewView.test.tsx:106`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L106), [`RepoOverviewView.test.tsx:147`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L147), [`RepoOverviewView.test.tsx:180`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L180), [`RepoOverviewView.test.tsx:192`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L192), [`RepoOverviewView.test.tsx:202`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L202), [`RepoOverviewView.test.tsx:231`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L231), [`EnrollmentSection.test.tsx:32`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L32), [`EnrollmentSection.test.tsx:48`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L48), [`ReonboardButton.test.tsx:7`](apps/web-ui/src/components/ReonboardButton.test.tsx#L7), [`ReonboardButton.test.tsx:21`](apps/web-ui/src/components/ReonboardButton.test.tsx#L21))
...
- FR-6.7: The knowledge-graph force layout (`lib/graph-layout`) seeds
  ...
  ring so trees don't overlap, and counts edge crossings. ([validated by `graph-layout.test.ts:20`](apps/web-ui/src/lib/graph-layout.test.ts#L20), [`graph-layout.test.ts:37`](apps/web-ui/src/lib/graph-layout.test.ts#L37), [`graph-layout.test.ts:60`](apps/web-ui/src/lib/graph-layout.test.ts#L60), [`graph-layout.test.ts:79`](apps/web-ui/src/lib/graph-layout.test.ts#L79), [`graph-layout.test.ts:89`](apps/web-ui/src/lib/graph-layout.test.ts#L89), [`graph-layout.test.ts:96`](apps/web-ui/src/lib/graph-layout.test.ts#L96), [`graph-layout.test.ts:103`](apps/web-ui/src/lib/graph-layout.test.ts#L103), [`graph-layout.test.ts:109`](apps/web-ui/src/lib/graph-layout.test.ts#L109), [`graph-layout.test.ts:115`](apps/web-ui/src/lib/graph-layout.test.ts#L115), [`graph-layout.test.ts:121`](apps/web-ui/src/lib/graph-layout.test.ts#L121), [`graph-layout.test.ts:132`](apps/web-ui/src/lib/graph-layout.test.ts#L132), [`graph-layout.test.ts:142`](apps/web-ui/src/lib/graph-layout.test.ts#L142), [`graph-layout.test.ts:152`](apps/web-ui/src/lib/graph-layout.test.ts#L152), [`graph-layout.test.ts:162`](apps/web-ui/src/lib/graph-layout.test.ts#L162), [`graph-layout.test.ts:172`](apps/web-ui/src/lib/graph-layout.test.ts#L172), [`graph-layout.test.ts:189`](apps/web-ui/src/lib/graph-layout.test.ts#L189), [`graph-layout.test.ts:193`](apps/web-ui/src/lib/graph-layout.test.ts#L193), [`graph-layout.test.ts:197`](apps/web-ui/src/lib/graph-layout.test.ts#L197), [`graph-layout.test.ts:205`](apps/web-ui/src/lib/graph-layout.test.ts#L205), [`graph-layout.test.ts:209`](apps/web-ui/src/lib/graph-layout.test.ts#L209), [`graph-layout.test.ts:218`](apps/web-ui/src/lib/graph-layout.test.ts#L218), [`graph-layout.test.ts:236`](apps/web-ui/src/lib/graph-layout.test.ts#L236), [`graph-layout.test.ts:252`](apps/web-ui/src/lib/graph-layout.test.ts#L252), [`graph-layout.test.ts:280`](apps/web-ui/src/lib/graph-layout.test.ts#L280), [`graph-layout.test.ts:286`](apps/web-ui/src/lib/graph-layout.test.ts#L286), [`graph-layout.test.ts:299`](apps/web-ui/src/lib/graph-layout.test.ts#L299), [`graph-layout.test.ts:311`](apps/web-ui/src/lib/graph-layout.test.ts#L311), [`graph-layout.test.ts:330`](apps/web-ui/src/lib/graph-layout.test.ts#L330), [`graph-layout.test.ts:342`](apps/web-ui/src/lib/graph-layout.test.ts#L342))
