...
- FR-2.11: *(added 2026-09-17)* Lore does not monitor a repo's setup; its
  owner triggers it by hand. The enrollment box carries ONE standing trigger
  ...
  line whose push delivered nothing still errors. ([validated by offers Open enrolment PR in the box for a repo with no onboarding PR, and runs the handler on click](apps/web-ui/src/components/EnrollmentSection.test.tsx#L48), [validated by offers Update Lore setup once the onboarding PR has merged, even with every check passing](apps/web-ui/src/components/EnrollmentSection.test.tsx#L62), [validated by offers neither trigger while the onboarding PR is open, nor without a handler](apps/web-ui/src/components/EnrollmentSection.test.tsx#L82), [validated by reads Open enrolment PR for a repo with no onboarding PR yet](apps/web-ui/src/lib/enrollment.test.ts#L447), [validated by reads Update Lore setup once the onboarding PR has merged](apps/web-ui/src/lib/enrollment.test.ts#L455), [validated by offers nothing while the onboarding PR is still open, where review & merge is the action](apps/web-ui/src/lib/enrollment.test.ts#L459), [validated by sends the update ticket, not the onboarding one, when o/r's onboarding PR has already merged](apps/lore-api/src/work/repo/repo-onboard.test.ts#L232), [validated by sends the onboarding ticket when reonboard is requested for o/r but its onboarding PR never merged](apps/lore-api/src/work/repo/repo-onboard.test.ts#L252), [validated by asks to update re-cinq/app's Lore setup rather than onboard it](libs/shared/src/work/onboard-content.test.ts#L167), [validated by owes every file a first onboarding owes, each only when missing](libs/shared/src/work/onboard-content.test.ts#L174), [validated by realigns only lore-tests.yml and pr-description-check.yml, the workflows written from a Lore instruction](libs/shared/src/work/onboard-content.test.ts#L185), [validated by calls an already-current setup a success, not a failure](libs/shared/src/work/onboard-content.test.ts#L193), [validated by commits nothing at all and still dispatches the line when every deterministic file is current](apps/floor/src/work/task/worker.onboard.test.ts#L182), [validated by completes an onboard line whose push delivered nothing, saying the setup is already current](apps/floor/src/work/assembly-run/spec-pr.test.ts#L305), [validated by errors a feature-planning line whose push delivered nothing, naming its branch](apps/floor/src/work/assembly-run/spec-pr.test.ts#L318))
...
- FR-3.3: Overview tab shows recent tasks (PR + pipeline links,
  ...
  repo's Dark Factory mode. ([validated by `RepoOverviewView.test.tsx:94`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L90), [`RepoOverviewView.test.tsx:106`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L106), [`RepoOverviewView.test.tsx:147`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L147), [`RepoOverviewView.test.tsx:180`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L180), [`RepoOverviewView.test.tsx:192`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L192), [`RepoOverviewView.test.tsx:202`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L202), [`RepoOverviewView.test.tsx:231`](apps/web-ui/src/app/repos/[owner]/[repo]/RepoOverviewView.test.tsx#L231), [`EnrollmentSection.test.tsx:32`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L32), [`EnrollmentSection.test.tsx:103`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L103), [`EnrollmentSection.test.tsx:111`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L111), [`EnrollmentSection.test.tsx:138`](apps/web-ui/src/components/EnrollmentSection.test.tsx#L138), [`ReonboardButton.test.tsx:7`](apps/web-ui/src/components/ReonboardButton.test.tsx#L7), [`ReonboardButton.test.tsx:21`](apps/web-ui/src/components/ReonboardButton.test.tsx#L21))
