...
- FR-6.11: The run-row mapper (`lib/assembly-line-runs`) resolves a
  ...
  still running). ([validated by `assembly-line-runs.test.ts:32`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L32), [`assembly-line-runs.test.ts:45`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L45), [`assembly-line-runs.test.ts:65`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L65), [`assembly-line-runs.test.ts:105`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L105), [`assembly-line-runs.test.ts:114`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L114), [`assembly-line-runs.test.ts:136`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L136))
