...
- FR-6.11: The run-row mapper (`lib/assembly-line-runs`) resolves a
  ...
  still running). ([validated by `assembly-line-runs.test.ts:40`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L40), [`assembly-line-runs.test.ts:53`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L53), [`assembly-line-runs.test.ts:73`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L73), [`assembly-line-runs.test.ts:90`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L90), [`assembly-line-runs.test.ts:99`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L99), [`assembly-line-runs.test.ts:121`](apps/web-ui/src/lib/assembly-line-runs.test.ts#L121))
