...
- FR-2.9: An onboard task ALWAYS walks the `onboard` assembly line, dark
  ...
  merged; a feature-planning line's PR records nothing there. ([validated by walks the onboard line for an onboard task with dark mode off](apps/floor/src/work/task/dispatch-agent-cr.test.ts#L8), [validated by dispatches an implementation task as a single agent with dark mode off](apps/floor/src/work/task/dispatch-agent-cr.test.ts#L18), [validated by walks the implementation line for an implementation task with dark mode on](apps/floor/src/work/task/dispatch-agent-cr.test.ts#L28), [validated by walks the feature-planning line for a feature-lifecycle task whatever dark mode says](apps/floor/src/work/task/dispatch-agent-cr.test.ts#L38), [validated by records an onboard line's PR as the repo's onboarding PR](apps/floor/src/work/assembly-run/spec-pr.test.ts#L264), [validated by records nothing on the repo row for a feature-planning line's PR](apps/floor/src/work/assembly-run/spec-pr.test.ts#L280), [validated by decides the record by the onboard blueprint name alone](apps/floor/src/work/assembly-run/spec-pr.test.ts#L296))
...
- FR-3.11: Features tab lists a feature's decomposed stories/tasks
  ...
  lifecycle status to its pill colour and in-flight state. ([validated by `DecompositionView.test.tsx:7`](apps/web-ui/src/app/repos/[owner]/[repo]/features/[id]/DecompositionView.test.tsx#L7), [`DecompositionView.test.tsx:15`](apps/web-ui/src/app/repos/[owner]/[repo]/features/[id]/DecompositionView.test.tsx#L15), [`feature-status.test.ts:17`](apps/web-ui/src/lib/feature-status.test.ts#L17), [`feature-status.test.ts:23`](apps/web-ui/src/lib/feature-status.test.ts#L23), [`feature-status.test.ts:27`](apps/web-ui/src/lib/feature-status.test.ts#L27), [`feature-status.test.ts:33`](apps/web-ui/src/lib/feature-status.test.ts#L33), [`feature-status.test.ts:40`](apps/web-ui/src/lib/feature-status.test.ts#L40))
...
- FR-7.10: A session keeps working past its GitHub token's lifetime. A GitHub
  ...
  refresh the session drops its token, so the person is asked to sign in again
  rather than told they have no access to a repo they can see.
  ([validated by `github-session-token.test.ts:24`](apps/web-ui/src/lib/github-session-token.test.ts#L24), [`github-session-token.test.ts:38`](apps/web-ui/src/lib/github-session-token.test.ts#L38), [`github-session-token.test.ts:46`](apps/web-ui/src/lib/github-session-token.test.ts#L46), [`github-session-token.test.ts:58`](apps/web-ui/src/lib/github-session-token.test.ts#L58), [`github-session-token.test.ts:69`](apps/web-ui/src/lib/github-session-token.test.ts#L69), [`github-session-token.test.ts:94`](apps/web-ui/src/lib/github-session-token.test.ts#L94), [`auth-options.test.ts:132`](apps/web-ui/src/lib/auth-options.test.ts#L132))
