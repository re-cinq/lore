...
- The implemented window opens at the repo's last digest post, or 24 hours back on the first run. ([validated by `fan-out.test.ts:69`](apps/floor/src/work/digest/fan-out.test.ts#L69), [`fan-out.test.ts:90`](apps/floor/src/work/digest/fan-out.test.ts#L90))
...
- The first digest of a week posts the parent; every digest replies in it with `reply_broadcast` so the day's post still shows in the channel. ([validated by `deliver-digest.test.ts:70`](apps/floor/src/work/digest/deliver-digest.test.ts#L70), [`deliver-digest.test.ts:119`](apps/floor/src/work/digest/deliver-digest.test.ts#L119), [`slack-poster-http.test.ts:25`](libs/shared/src/outbound/project/notify/slack-poster-http.test.ts#L25), [`slack-poster-http.test.ts:46`](libs/shared/src/outbound/project/notify/slack-poster-http.test.ts#L46))
- Every post is recorded per repo in `lore.digest_posts` with its thread and the intro and ending it carried; the repo's last finished post is its watermark and the channel's last 14 ride into the next drafts. ([validated by `deliver-digest.test.ts:167`](apps/floor/src/work/digest/deliver-digest.test.ts#L167), [`digest-posts.test.ts:13`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L13), [`digest-posts.test.ts:19`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L19), [`digest-posts.test.ts:31`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L31), [`digest-posts.test.ts:45`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L45), [`digest-posts.test.ts:135`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L135), [`digest-posts.test.ts:150`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L150))
- A run is claimed in that table before Slack is called, so the upload receiver and the run-closed fallback racing for one run post once; a claim whose Slack call failed is released so the next tick may try again. ([validated by `deliver-digest.test.ts:202`](apps/floor/src/work/digest/deliver-digest.test.ts#L202), [`deliver-digest.test.ts:219`](apps/floor/src/work/digest/deliver-digest.test.ts#L219), [`digest-posts.test.ts:72`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L72), [`digest-posts.test.ts:79`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L79), [`digest-posts.test.ts:106`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L106), [`digest-posts.test.ts:127`](libs/shared/src/outbound/project/digest-posts/digest-posts.test.ts#L127))
...
- Every 15 minutes the tick reads every onboarded repo's settings in one query, keeps the enabled repos with a channel whose digest is due, and starts one run per channel carrying every due repo, hosted by the first repo by name and keyed on the channel and the local day. ([validated by `settings.test.ts:63`](libs/shared/src/outbound/project/settings/settings.test.ts#L63), [`fan-out.test.ts:46`](apps/floor/src/work/digest/fan-out.test.ts#L46), [`fan-out.test.ts:57`](apps/floor/src/work/digest/fan-out.test.ts#L57), [`fan-out.test.ts:141`](apps/floor/src/work/digest/fan-out.test.ts#L141))
- The run's args carry each repo's window (from its last finished post, or 24 hours back), sections and grouping as `digest_repos`, which one codec wraps and unwraps, plus `ref` set to the host repo's default branch since the run's own branch is only a lease key. ([validated by `fan-out.test.ts:87`](apps/floor/src/work/digest/fan-out.test.ts#L87), [`fan-out.test.ts:120`](apps/floor/src/work/digest/fan-out.test.ts#L120), [`codec.test.ts:15`](libs/shared/src/work/digest/codec.test.ts#L15), [`codec.test.ts:19`](libs/shared/src/work/digest/codec.test.ts#L19))
- A channel whose run for the day is in flight is skipped, and a channel starts at most three runs a day; a tick that cannot start the run fails the job_run it minted; `params.repo` narrows the tick and `params.force` skips the due check. ([validated by `fan-out.test.ts:152`](apps/floor/src/work/digest/fan-out.test.ts#L152), [`fan-out.test.ts:170`](apps/floor/src/work/digest/fan-out.test.ts#L170), [`fan-out.test.ts:193`](apps/floor/src/work/digest/fan-out.test.ts#L193), [`fan-out.test.ts:204`](apps/floor/src/work/digest/fan-out.test.ts#L204))
...
- The uploaded `digest.md` is posted on a zero exit; a non-zero exit, an empty upload, or a run that closed without uploading posts the stored draft without its appendix; a run whose pod never downloaded a draft posts nothing. ([validated by `deliver-digest.test.ts:93`](apps/floor/src/work/digest/deliver-digest.test.ts#L93), [`deliver-digest.test.ts:107`](apps/floor/src/work/digest/deliver-digest.test.ts#L107), [`deliver-digest.test.ts:246`](apps/floor/src/work/digest/deliver-digest.test.ts#L246), [`deliver-digest.test.ts:232`](apps/floor/src/work/digest/deliver-digest.test.ts#L232), [`agent-files-digest.test.ts:135`](apps/floor/src/transport/http/routes/agent-files-digest.test.ts#L135), [`agent-files-digest.test.ts:165`](apps/floor/src/transport/http/routes/agent-files-digest.test.ts#L165))

## FR10 — Settings page

- The repo settings page carries a Daily digest section after the cross-repo field, prefilled from the stored block or, when none is stored, from the defaults. ([validated by `SettingsView.test.tsx:64`](apps/web-ui/src/app/repos/[owner]/[repo]/settings/SettingsView.test.tsx#L64), [`DigestFields.test.tsx:12`](apps/web-ui/src/app/repos/[owner]/[repo]/settings/DigestFields.test.tsx#L12), [`DigestFields.test.tsx:44`](apps/web-ui/src/app/repos/[owner]/[repo]/settings/DigestFields.test.tsx#L44))
- It offers the enable switch, the time of day, the weekdays, every timezone the browser knows (keeping a stored one it does not list), the sections and the grouping, and hints that the digest needs a Slack channel when none is set. ([validated by `DigestFields.test.tsx:62`](apps/web-ui/src/app/repos/[owner]/[repo]/settings/DigestFields.test.tsx#L62), [`DigestFields.test.tsx:68`](apps/web-ui/src/app/repos/[owner]/[repo]/settings/DigestFields.test.tsx#L68))
