...
| AssemblyRun | a `pipeline.assembly_runs` row, reached via `project.assemblyRuns`, walked event-driven by the Floor (`apps/floor/src/work/assembly-run/advance-line.ts`) |
