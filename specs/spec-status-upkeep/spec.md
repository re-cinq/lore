...
- Transition `lore.features.status` to `implemented` only when the spec ends up claiming `shipped` — freshly set or already current — so the features table and the spec file never diverge; every other outcome is left for a human to reconcile. ([validated by `spec-status-flip.test.ts:40`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L40), [`spec-status-flip.test.ts:50`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L50), [`spec-status-flip.test.ts:61`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L61), [`spec-status-flip.test.ts:71`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L71), [`spec-status-flip.test.ts:82`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L82), [`spec-status-flip.test.ts:93`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L93), [`merge-check.test.ts:9`](apps/stations/src/stations/merge-check/merge-check.test.ts#L9), [`merge-check.test.ts:15`](apps/stations/src/stations/merge-check/merge-check.test.ts#L15), [`merge-check.test.ts:19`](apps/stations/src/stations/merge-check/merge-check.test.ts#L19), [`merge-check.test.ts:25`](apps/stations/src/stations/merge-check/merge-check.test.ts#L25), [`merge-check.test.ts:36`](apps/stations/src/stations/merge-check/merge-check.test.ts#L36), [`merge-check.test.ts:46`](apps/stations/src/stations/merge-check/merge-check.test.ts#L46), [`merge-check.test.ts:63`](apps/stations/src/stations/merge-check/merge-check.test.ts#L63), [`merge-check.test.ts:70`](apps/stations/src/stations/merge-check/merge-check.test.ts#L70))
