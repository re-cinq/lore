...
- Derive a doc's entitled status from its test-link coverage: no linked testable statement yields draft, a partial set yields in-progress, and a complete set yields shipped. ([validated by `spec-status-coverage.test.ts:103`](libs/shared/src/spec-status-coverage.test.ts#L103), [`spec-status-coverage.test.ts:107`](libs/shared/src/spec-status-coverage.test.ts#L107), [`spec-status-coverage.test.ts:111`](libs/shared/src/spec-status-coverage.test.ts#L111), [`spec-status-coverage.test.ts:115`](libs/shared/src/spec-status-coverage.test.ts#L115), [`spec-status-coverage.test.ts:121`](libs/shared/src/spec-status-coverage.test.ts#L121))
- Tally a doc's testable statements against those carrying a test link in one walk, counting an unlinked, a partially linked and a fully linked doc alike. ([validated by `spec-status-coverage.test.ts:50`](libs/shared/src/spec-status-coverage.test.ts#L50), [`spec-status-coverage.test.ts:61`](libs/shared/src/spec-status-coverage.test.ts#L61), [`spec-status-coverage.test.ts:71`](libs/shared/src/spec-status-coverage.test.ts#L71))
- Expose the unlinked statements and the line each starts on from that same walk, so `require-statement-links` and the status ladder can never disagree about what is linked. ([validated by `spec-status-coverage.test.ts:89`](libs/shared/src/spec-status-coverage.test.ts#L89), [`spec-status-coverage.test.ts:95`](libs/shared/src/spec-status-coverage.test.ts#L95))
- Count a statement as testable only when the shared section heuristic says so, so intro, vision, background, rationale, open-question and limitation prose never drags a status down. ([validated by `spec-status-coverage.test.ts:79`](libs/shared/src/spec-status-coverage.test.ts#L79))
- Derive no status at all for a doc with no testable statement, leaving it alone rather than forcing it to draft. ([validated by `spec-status-coverage.test.ts:127`](libs/shared/src/spec-status-coverage.test.ts#L127), [`spec-status-coverage.test.ts:169`](libs/shared/src/spec-status-coverage.test.ts#L169))
- Exempt the terminal statuses — `rejected` (never accepted) and `retired` (shipped, then superseded) — from the ladder entirely, since no coverage reading should reopen a closed decision. Asking for a terminal status's label is a caller bug and fails loudly. ([validated by `spec-status-coverage.test.ts:145`](libs/shared/src/spec-status-coverage.test.ts#L145))
- Render the derived status in each corpus's own surface form: Title Case in a spec's table cell, lowercase in an ADR's frontmatter. ([validated by `spec-status-coverage.test.ts:133`](libs/shared/src/spec-status-coverage.test.ts#L133), [`spec-status-coverage.test.ts:139`](libs/shared/src/spec-status-coverage.test.ts#L139))
- Resolve a doc straight to the label its coverage entitles it to, so a caller reconciling a status never re-implements the ladder. ([validated by `spec-status-coverage.test.ts:153`](libs/shared/src/spec-status-coverage.test.ts#L153), [`spec-status-coverage.test.ts:157`](libs/shared/src/spec-status-coverage.test.ts#L157), [`spec-status-coverage.test.ts:163`](libs/shared/src/spec-status-coverage.test.ts#L163))
...
- Detect that this merge completes the group, then resolve the owning feature before acting. ([validated by `task-queue.test.ts:577`](libs/shared/src/project/tasks/task-queue.test.ts#L577), [`task-queue.test.ts:586`](libs/shared/src/project/tasks/task-queue.test.ts#L586), [`task-queue.test.ts:592`](libs/shared/src/project/tasks/task-queue.test.ts#L592), [`spec-status-flip.test.ts:17`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L17), [`spec-status-flip.test.ts:21`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L21), [`spec-status-flip.test.ts:25`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L25), [`spec-status-flip.test.ts:29`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L29), [`spec-status-flip.test.ts:33`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L33))
- Open a one-line follow-up PR setting the spec's `| Status |` row to the status its test-link coverage entitles it to claim, using the same PR-opening plumbing as `spec-coverage-backfill`. ([validated by `spec-status-flip.test.ts:70`](libs/shared/src/spec-status-flip.test.ts#L70), [`spec-status-flip.test.ts:102`](libs/shared/src/spec-status-flip.test.ts#L102))
- Mark the spec `Shipped` only when every testable statement is linked; a partially-linked spec whose group has merged lands `In Progress` instead, because a merged task group is not evidence that the spec's statements are validated. ([validated by `spec-status-flip.test.ts:70`](libs/shared/src/spec-status-flip.test.ts#L70), [`spec-status-flip.test.ts:102`](libs/shared/src/spec-status-flip.test.ts#L102))
- Demote a `Shipped` spec back to `In Progress` when a statement has lost its link, so the reconciliation runs in both directions. ([validated by `spec-status-flip.test.ts:121`](libs/shared/src/spec-status-flip.test.ts#L121))
- Skip without opening a PR when the spec is missing, has no status row, is terminal (rejected/retired), has no testable statement to derive a status from, or already claims the status its coverage supports. ([validated by `spec-status-flip.test.ts:138`](libs/shared/src/spec-status-flip.test.ts#L138), [`spec-status-flip.test.ts:155`](libs/shared/src/spec-status-flip.test.ts#L155), [`spec-status-flip.test.ts:171`](libs/shared/src/spec-status-flip.test.ts#L171), [`spec-status-flip.test.ts:187`](libs/shared/src/spec-status-flip.test.ts#L187), [`spec-status-flip.test.ts:198`](libs/shared/src/spec-status-flip.test.ts#L198), [`spec-status-flip.test.ts:207`](libs/shared/src/spec-status-flip.test.ts#L207), [`spec-status-flip.test.ts:222`](libs/shared/src/spec-status-flip.test.ts#L222))
- Compare status buckets rather than labels when deciding whether a flip is needed, so the corpus's synonyms (`Implemented` / `Shipped` / `Complete`) keep the PR idempotent. ([validated by `spec-status-flip.test.ts:138`](libs/shared/src/spec-status-flip.test.ts#L138))
...
- Transition `lore.features.status` to `implemented` only when the spec ends up claiming `shipped` — freshly set or already current — so the features table and the spec file never diverge; every other outcome is left for a human to reconcile. ([validated by `spec-status-flip.test.ts:40`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L40), [`spec-status-flip.test.ts:50`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L50), [`spec-status-flip.test.ts:61`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L61), [`spec-status-flip.test.ts:71`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L71), [`spec-status-flip.test.ts:82`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L82), [`spec-status-flip.test.ts:93`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L93))
