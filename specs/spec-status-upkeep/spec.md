...
- Only a task still in flight withholds the merged-tasks signal. A linked task
  ...
  let one cancelled or retried sibling suppress the signal forever. ([validated by `status-staleness.test.ts:393`](libs/shared/src/detect/status-staleness.test.ts#L393), [`status-staleness.test.ts:405`](libs/shared/src/detect/status-staleness.test.ts#L405))
- Named paths are scored against the same resolved-schema code read the inline
  ...
  live in a team schema rather than `org_shared`. ([validated by `status-staleness.test.ts:422`](libs/shared/src/detect/status-staleness.test.ts#L422))
