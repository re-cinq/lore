...
- Detect that this merge completes the group, then resolve the owning feature before acting. ([validated by `task-queue.test.ts:583`](libs/shared/src/project/tasks/task-queue.test.ts#L583), [`task-queue.test.ts:592`](libs/shared/src/project/tasks/task-queue.test.ts#L592), [`task-queue.test.ts:598`](libs/shared/src/project/tasks/task-queue.test.ts#L598), [`spec-status-flip.test.ts:17`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L17), [`spec-status-flip.test.ts:21`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L21), [`spec-status-flip.test.ts:25`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L25), [`spec-status-flip.test.ts:29`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L29), [`spec-status-flip.test.ts:33`](apps/stations/src/stations/merge-check/spec-status-flip.test.ts#L33))
