...
- FR4.1. The run page renders the assembly-line definition graph as a DAG whose node states update live. ([validated by `RunGraphView.test.tsx:31`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L31), [`RunGraphView.test.tsx:42`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L42), [`RunGraphView.test.tsx:53`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L53), [`RunGraphView.test.tsx:66`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L66), [`RunGraphView.test.tsx:81`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L81), [`RunGraphView.test.tsx:192`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L192), [`RunGraphView.test.tsx:204`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L204))

- FR4.1b. When the run's definition is not among the graphs the UI knows, the graph is synthesized from the walk's own distinct visit rows in visit order rather than omitted, and its edge conditions are suppressed because they were inferred rather than declared. ([validated by `run-graph-definition.test.ts:37`](apps/web-ui/src/lib/run-graph-definition.test.ts#L37), [`run-graph-definition.test.ts:44`](apps/web-ui/src/lib/run-graph-definition.test.ts#L44), [`run-graph-definition.test.ts:59`](apps/web-ui/src/lib/run-graph-definition.test.ts#L59), [`run-graph-definition.test.ts:72`](apps/web-ui/src/lib/run-graph-definition.test.ts#L72), [`RunGraphView.test.tsx:138`](apps/web-ui/src/app/assembly-lines/[id]/RunGraphView.test.tsx#L138))
