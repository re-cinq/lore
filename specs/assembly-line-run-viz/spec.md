...
- FR1.6. A `tool_result` payload is truncated at write time to at most 2KB. ([validated by `agent-run-events.test.ts:396`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L396), [`agent-run-events.test.ts:513`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L513), [`agent-run-events.test.ts:517`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L517), [`agent-run-events.test.ts:521`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L521))

- FR1.7. Each individual tool input is truncated at write time to at most 1KB, and all tool inputs on one row to at most 4KB in total. ([validated by `agent-run-events.test.ts:411`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L411), [`agent-run-events.test.ts:430`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L430))

- FR1.8. The file paths a tool call touches are extracted into `filePaths` at write time rather than derived by readers from the payload. ([validated by `agent-run-events.test.ts:118`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L118), [`agent-run-events.test.ts:138`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L138), [`agent-run-events.test.ts:487`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L487), [`agent-run-events.test.ts:497`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L497), [`agent-run-events.test.ts:503`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L503), [`agent-run-events.test.ts:507`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L507))

- FR1.8a. The `summary` field is one human-readable line describing the event, derived at write time and truncated to at most 200 characters. It is a rendering convenience, never a parsing target: no reader may branch on its content, and it is null whenever no meaningful line can be derived. Its exact per-event-type wording is an implementation choice of the projector, not a contract this spec fixes. ([validated by `agent-run-events.test.ts:450`](apps/floor/src/jobs/agent/agent-run-events.test.ts#L450))
...
- FR5.4. A subscriber that cannot keep up with the live tail is disconnected rather than allowed to apply back-pressure to the Floor. The bound is the subscriber's own buffer: each subscription holds at most 1000 undelivered events, and on overflow the server drops the subscriber and closes the connection. Dropping is safe precisely because it is recoverable — the client's `EventSource` reconnects with its `Last-Event-ID` and FR5.3 replays the gap from the database, so a slow reader loses latency, never data. The buffer is what makes this bounded; an implementation that lets an unread subscriber grow the Floor's heap satisfies neither this FR nor FR5.1. ([validated by `agent-event-bus.test.ts:28`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L28), [`agent-event-bus.test.ts:41`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L41), [`agent-event-bus.test.ts:52`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L52), [`agent-event-bus.test.ts:62`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L62), [`agent-event-bus.test.ts:68`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L68), [`agent-event-bus.test.ts:79`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L79), [`agent-event-bus.test.ts:91`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L91), [`agent-event-bus.test.ts:100`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L100), [`agent-event-bus.test.ts:114`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L114), [`agent-event-bus.test.ts:127`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L127), [`agent-event-bus.test.ts:155`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L155), [`agent-event-bus.test.ts:171`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L171), [`agent-event-bus.test.ts:191`](apps/floor/src/jobs/agent/agent-event-bus.test.ts#L191))
