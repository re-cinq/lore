...
- **Cross-cutting concerns are hand-wired and duplicated.** Bearer-scope auth,
  ...
  ([`auth.ts`](https://github.com/re-cinq/lore/blob/85d151c9b39efa0f8d701a659638284daa6c946a/apps/lore-api/src/http/auth.ts)) that must be kept in
...
- **Auth** → a custom `bearer-scope` scheme wrapping the existing
  ...
  token satisfies any required scope while a token lacking it is denied. ([validated by `auth.test.ts:43`](apps/lore-api/src/http/auth.test.ts#L43), [validated by `auth.test.ts:52`](apps/lore-api/src/http/auth.test.ts#L52), [validated by `auth.test.ts:70`](apps/lore-api/src/http/auth.test.ts#L70), [validated by `auth.test.ts:77`](apps/lore-api/src/http/auth.test.ts#L77), [validated by `auth.test.ts:94`](apps/lore-api/src/http/auth.test.ts#L94), [validated by `auth.test.ts:101`](apps/lore-api/src/http/auth.test.ts#L101), [validated by `auth.test.ts:115`](apps/lore-api/src/http/auth.test.ts#L115))
...
- **FR4** Native routes are guarded by the `bearer-scope` auth strategy with the
  ...
  verification and set `auth: false`. ([validated by `bearer-scope.test.ts:76`](apps/lore-api/src/http/bearer-scope.test.ts#L72))
...
- **SC-3** Auth matrix preserved: for every route, an under-scoped token still
  ...
  by tests migrated alongside each group. ([validated by `bearer-scope.test.ts:45`](apps/lore-api/src/http/bearer-scope.test.ts#L41))
- **SC-4** Rate limiting still returns `429` + `Retry-After: 60` at the same
  ...
  window slides past. ([validated by `rate-limit.test.ts:53`](apps/lore-api/src/http/rate-limit.test.ts#L50), [validated by `auth.test.ts:17`](apps/lore-api/src/http/auth.test.ts#L17), [validated by `auth.test.ts:24`](apps/lore-api/src/http/auth.test.ts#L24))
