...
- **FR4 — network policy + pod providers.** A label-scoped NetworkPolicy
  ...
  ([validated by `agent-catalog.test.ts:332`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L332), [`agent-catalog.test.ts:332`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L332), [`agent-catalog.test.ts:350`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L350), [`agent-catalog.test.ts:122`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L122), [`agent-catalog.test.ts:241`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L241), [`rate-limit.test.ts:26`](apps/lore-api/src/http/rate-limit.test.ts#L26), [`ingest.test.ts:274`](apps/stations/src/work/ingest/ingest.test.ts#L274), [`ingest.test.ts:296`](apps/stations/src/work/ingest/ingest.test.ts#L296), [`embed.test.ts:33`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L33), [`embed.test.ts:40`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L40), [`embed.test.ts:47`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L47), [`ingest.test.ts:247`](apps/stations/src/work/ingest/ingest.test.ts#L247), [`ingest.test.ts:266`](apps/stations/src/work/ingest/ingest.test.ts#L266), [`ingest.test.ts:364`](apps/stations/src/work/ingest/ingest.test.ts#L364); implemented by [`ingest-station-egress.yaml:1`](infra/terraform/modules/gke-mcp/lore-platform/charts/ai-agents-helm/templates/ingest-station-egress.yaml#L1), [`embed.ts:27`](apps/lore-api/src/api/routes/ingest/embed.ts#L27))
