...
- **FR1 — station type.** The `lore-station` image gains a builtin `ingest` type
  ...
  until FR3.
  ([validated by `ingest.test.ts:77`](apps/stations/src/stations/ingest/ingest.test.ts#L77), [`ingest.test.ts:90`](apps/stations/src/stations/ingest/ingest.test.ts#L90), [`ingest.test.ts:102`](apps/stations/src/stations/ingest/ingest.test.ts#L102), [`ingest.test.ts:120`](apps/stations/src/stations/ingest/ingest.test.ts#L120), [`ingest.test.ts:142`](apps/stations/src/stations/ingest/ingest.test.ts#L142), [`ingest.test.ts:295`](apps/stations/src/stations/ingest/ingest.test.ts#L295), [`ingest-graph-task.test.ts:138`](libs/shared/src/spec-trace/ingest-graph-task.test.ts#L138), [`ingest-spec-trace.test.ts:103`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L103), [`ingest-spec-trace.test.ts:138`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L138), [`ingest-spec-trace-unknown-kind.test.ts:10`](libs/shared/src/spec-trace/ingest-spec-trace-unknown-kind.test.ts#L10); implemented by [`ingest.ts:71`](apps/stations/src/stations/ingest/ingest.ts#L71))
...
- **FR4 — network policy + pod providers.** A label-scoped NetworkPolicy
  ...
  ([validated by `agent-catalog.test.ts:332`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L332), [`agent-catalog.test.ts:332`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L332), [`agent-catalog.test.ts:350`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L350), [`agent-catalog.test.ts:122`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L122), [`agent-catalog.test.ts:241`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L241), [`rate-limit.test.ts:29`](apps/lore-api/src/server/plugins/rate-limit.test.ts#L29), [`ingest.test.ts:258`](apps/stations/src/stations/ingest/ingest.test.ts#L258), [`ingest.test.ts:280`](apps/stations/src/stations/ingest/ingest.test.ts#L280), [`embed.test.ts:38`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L38), [`embed.test.ts:45`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L45), [`embed.test.ts:52`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L52), [`ingest.test.ts:231`](apps/stations/src/stations/ingest/ingest.test.ts#L231), [`ingest.test.ts:250`](apps/stations/src/stations/ingest/ingest.test.ts#L250); implemented by [`ingest-station-egress.yaml:1`](infra/terraform/modules/gke-mcp/lore-platform/charts/ai-agents-helm/templates/ingest-station-egress.yaml#L1), [`embed.ts:27`](apps/lore-api/src/api/routes/ingest/embed.ts#L27))
