...
- **FR1 — station type.** The `lore-station` image gains a builtin `ingest` type
  ...
  until FR3.
  ([validated by `ingest.test.ts:95`](apps/stations/src/stations/ingest/ingest.test.ts#L95), [`ingest.test.ts:108`](apps/stations/src/stations/ingest/ingest.test.ts#L108), [`ingest.test.ts:120`](apps/stations/src/stations/ingest/ingest.test.ts#L120), [`ingest.test.ts:138`](apps/stations/src/stations/ingest/ingest.test.ts#L138), [`ingest.test.ts:160`](apps/stations/src/stations/ingest/ingest.test.ts#L160), [`ingest.test.ts:311`](apps/stations/src/stations/ingest/ingest.test.ts#L311), [`ingest.test.ts:321`](apps/stations/src/stations/ingest/ingest.test.ts#L321), [`ingest.test.ts:331`](apps/stations/src/stations/ingest/ingest.test.ts#L331), [`ingest-graph-task.test.ts:160`](libs/shared/src/spec-trace/ingest-graph-task.test.ts#L160), [`ingest-spec-trace.test.ts:63`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L63), [`ingest-spec-trace.test.ts:98`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L98), [`ingest-spec-trace-unknown-kind.test.ts:10`](libs/shared/src/spec-trace/ingest-spec-trace-unknown-kind.test.ts#L10); implemented by [`ingest.ts:71`](apps/stations/src/stations/ingest/ingest.ts#L71))
...
- **FR2 — dispatch.** A single-node detect-shaped assembly line definition
  ...
  ([validated by `spec-trace-dispatch:35`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L29), [`spec-trace-dispatch:65`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L58), [`spec-trace-dispatch:170`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L163), [`spec-trace-dispatch:214`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L186), [`floor-assembly-run:197`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L189), [`floor-assembly-run:180`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L172), [`agent-backend:150`](libs/shared/src/cluster/agent-backend.test.ts#L148), [`per-task-token:64`](libs/shared/src/cluster/per-task-token.test.ts#L64), [`per-task-token:70`](libs/shared/src/cluster/per-task-token.test.ts#L70), [`loader:231`](libs/assembly-lines/src/loader.test.ts#L508); implemented by [`spec-trace-dispatch.ts:71`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.ts#L71), [`ingest.yaml:1`](libs/assembly-lines/src/assembly-lines/ingest.yaml#L1))
...
- **FR4 — network policy + pod providers.** A label-scoped NetworkPolicy
  ...
  ([validated by `agent-catalog.test.ts:332`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L332), [`agent-catalog.test.ts:332`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L332), [`agent-catalog.test.ts:350`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L350), [`agent-catalog.test.ts:122`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L122), [`agent-catalog.test.ts:241`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L241), [`rate-limit.test.ts:26`](apps/lore-api/src/http/rate-limit.test.ts#L26), [`ingest.test.ts:274`](apps/stations/src/stations/ingest/ingest.test.ts#L274), [`ingest.test.ts:296`](apps/stations/src/stations/ingest/ingest.test.ts#L296), [`embed.test.ts:33`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L33), [`embed.test.ts:40`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L40), [`embed.test.ts:47`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L47), [`ingest.test.ts:247`](apps/stations/src/stations/ingest/ingest.test.ts#L247), [`ingest.test.ts:266`](apps/stations/src/stations/ingest/ingest.test.ts#L266), [`ingest.test.ts:364`](apps/stations/src/stations/ingest/ingest.test.ts#L364); implemented by [`ingest-station-egress.yaml:1`](infra/terraform/modules/gke-mcp/lore-platform/charts/ai-agents-helm/templates/ingest-station-egress.yaml#L1), [`embed.ts:27`](apps/lore-api/src/api/routes/ingest/embed.ts#L27))
