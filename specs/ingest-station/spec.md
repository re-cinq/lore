...
- **FR2 — dispatch.** A single-node detect-shaped assembly line definition
  ...
  ([validated by `spec-trace-dispatch:35`](apps/floor/src/work/spec-trace/spec-trace-dispatch.test.ts#L29), [`spec-trace-dispatch:65`](apps/floor/src/work/spec-trace/spec-trace-dispatch.test.ts#L58), [`spec-trace-dispatch:170`](apps/floor/src/work/spec-trace/spec-trace-dispatch.test.ts#L163), [`spec-trace-dispatch:214`](apps/floor/src/work/spec-trace/spec-trace-dispatch.test.ts#L186), [`floor-assembly-run:197`](apps/floor/src/work/assembly-run/floor-assembly-run.test.ts#L189), [`floor-assembly-run:180`](apps/floor/src/work/assembly-run/floor-assembly-run.test.ts#L172), [`agent-backend:150`](libs/shared/src/outbound/cluster/agent-backend.test.ts#L158), [`per-task-token:64`](libs/shared/src/outbound/cluster/per-task-token.test.ts#L64), [`per-task-token:70`](libs/shared/src/outbound/cluster/per-task-token.test.ts#L70), [`loader:231`](libs/assembly-lines/src/loader.test.ts#L508); implemented by [`spec-trace-dispatch.ts:71`](apps/floor/src/work/spec-trace/spec-trace-dispatch.ts#L99), [`ingest.yaml:1`](libs/assembly-lines/src/assembly-lines/ingest.yaml#L1))
