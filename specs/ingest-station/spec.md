...
- **FR2 — dispatch.** A single-node detect-shaped assembly line definition
  ...
  ([validated by `spec-trace-dispatch:35`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L35), [`spec-trace-dispatch:65`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L66), [`spec-trace-dispatch:170`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L171), [`spec-trace-dispatch:214`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L194), [`floor-assembly-run:197`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L197), [`floor-assembly-run:180`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L180), [`agent-backend:148`](libs/shared/src/cluster/agent-backend.test.ts#L148), [`per-task-token:64`](libs/shared/src/cluster/per-task-token.test.ts#L64), [`per-task-token:70`](libs/shared/src/cluster/per-task-token.test.ts#L70), [`loader:231`](libs/assembly-lines/src/loader.test.ts#L498); implemented by [`spec-trace-dispatch.ts:71`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.ts#L71), [`ingest.yaml:1`](libs/assembly-lines/src/assembly-lines/ingest.yaml#L1))
