...
- **FR1 — station type.** The `lore-station` image gains a builtin `ingest` type
  ...
  until FR3.
  ([validated by `ingest.test.ts:85`](libs/stations/src/stations/ingest/ingest.test.ts#L85), [`ingest.test.ts:98`](libs/stations/src/stations/ingest/ingest.test.ts#L98), [`ingest.test.ts:110`](libs/stations/src/stations/ingest/ingest.test.ts#L110), [`ingest.test.ts:128`](libs/stations/src/stations/ingest/ingest.test.ts#L128), [`ingest.test.ts:150`](libs/stations/src/stations/ingest/ingest.test.ts#L150), [`ingest.test.ts:303`](libs/stations/src/stations/ingest/ingest.test.ts#L303), [`ingest-graph-task.test.ts:146`](libs/shared/src/spec-trace/ingest-graph-task.test.ts#L146), [`ingest-spec-trace.test.ts:114`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L114), [`ingest-spec-trace.test.ts:149`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L149), [`ingest-spec-trace-unknown-kind.test.ts:17`](libs/shared/src/spec-trace/ingest-spec-trace-unknown-kind.test.ts#L17); implemented by [`ingest.ts:71`](libs/stations/src/stations/ingest/ingest.ts#L71))
...
- **FR2 — dispatch.** A single-node detect-shaped assembly line definition
  ...
  ([validated by `spec-trace-dispatch:35`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L35), [`spec-trace-dispatch:65`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L66), [`spec-trace-dispatch:170`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L171), [`spec-trace-dispatch:214`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L194), [`floor-assembly-run:179`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L206), [`floor-assembly-run:163`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L189), [`agent-backend:208`](apps/floor/src/jobs/station/agent-backend.test.ts#L208), [`per-task-token:64`](libs/shared/src/cluster/per-task-token.test.ts#L64), [`per-task-token:70`](libs/shared/src/cluster/per-task-token.test.ts#L70), [`loader:231`](libs/assembly-lines/src/loader.test.ts#L497); implemented by [`spec-trace-dispatch.ts:71`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.ts#L71), [`ingest.yaml:1`](libs/assembly-lines/src/assembly-lines/ingest.yaml#L1))
...
- **FR4 — network policy + pod providers.** A label-scoped NetworkPolicy
  ...
  ([validated by `agent-catalog.test.ts:285`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L285), [validated by `agent-backend.test.ts:71`](apps/floor/src/jobs/station/agent-backend.test.ts#L71), [`floor-assembly-run.test.ts:107`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L125), [`agent-catalog.test.ts:285`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L285), [`agent-catalog.test.ts:303`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L303), [`agent-catalog.test.ts:80`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L80), [`agent-catalog.test.ts:190`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L190), [`rate-limit.test.ts:29`](apps/lore-api/src/server/plugins/rate-limit.test.ts#L29), [`ingest.test.ts:266`](libs/stations/src/stations/ingest/ingest.test.ts#L266), [`ingest.test.ts:288`](libs/stations/src/stations/ingest/ingest.test.ts#L288), [`embed.test.ts:38`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L38), [`embed.test.ts:45`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L45), [`embed.test.ts:52`](apps/lore-api/src/api/routes/ingest/embed.test.ts#L52), [`ingest.test.ts:239`](libs/stations/src/stations/ingest/ingest.test.ts#L239), [`ingest.test.ts:258`](libs/stations/src/stations/ingest/ingest.test.ts#L258); implemented by [`ingest-station-egress.yaml:1`](infra/terraform/modules/gke-mcp/lore-platform/charts/ai-agents-helm/templates/ingest-station-egress.yaml#L1), [`embed.ts:27`](apps/lore-api/src/api/routes/ingest/embed.ts#L27))
