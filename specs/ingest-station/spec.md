...
- **FR1 — station type.** The `lore-station` image gains a builtin `ingest` type
  ...
  until FR3.
  ([validated by `ingest.test.ts:95`](apps/stations/src/stations/ingest/ingest.test.ts#L95), [`ingest.test.ts:108`](apps/stations/src/stations/ingest/ingest.test.ts#L108), [`ingest.test.ts:120`](apps/stations/src/stations/ingest/ingest.test.ts#L120), [`ingest.test.ts:138`](apps/stations/src/stations/ingest/ingest.test.ts#L138), [`ingest.test.ts:160`](apps/stations/src/stations/ingest/ingest.test.ts#L160), [`ingest.test.ts:311`](apps/stations/src/stations/ingest/ingest.test.ts#L311), [`ingest.test.ts:321`](apps/stations/src/stations/ingest/ingest.test.ts#L321), [`ingest.test.ts:331`](apps/stations/src/stations/ingest/ingest.test.ts#L331), [`ingest-graph-task.test.ts:160`](libs/shared/src/spec-trace/ingest-graph-task.test.ts#L160), [`ingest-spec-trace.test.ts:103`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L72), [`ingest-spec-trace.test.ts:138`](libs/shared/src/spec-trace/ingest-spec-trace.test.ts#L107), [`ingest-spec-trace-unknown-kind.test.ts:10`](libs/shared/src/spec-trace/ingest-spec-trace-unknown-kind.test.ts#L10); implemented by [`ingest.ts:71`](apps/stations/src/stations/ingest/ingest.ts#L71))
