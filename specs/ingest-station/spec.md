...
- **FR2 — dispatch.** A single-node detect-shaped assembly line definition
  ...
  ([validated by `spec-trace-dispatch:35`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L35), [`spec-trace-dispatch:65`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L66), [`spec-trace-dispatch:170`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L171), [`spec-trace-dispatch:214`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L214), [`floor-assembly-run:179`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L202), [`floor-assembly-run:163`](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L185), [`agent-backend:208`](apps/floor/src/jobs/station/agent-backend.test.ts#L208), [`per-task-token:64`](apps/floor/src/jobs/station/per-task-token.test.ts#L64), [`per-task-token:70`](apps/floor/src/jobs/station/per-task-token.test.ts#L70), [`loader:231`](libs/assembly-lines/src/loader.test.ts#L497); implemented by [`spec-trace-dispatch.ts:71`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.ts#L71), [`ingest.yaml:1`](libs/assembly-lines/src/assembly-lines/ingest.yaml#L1))
...
- **FR6 — the Floor is pure orchestration.** With no in-process dgraph writer left,
  ...
  the feature gate).
  ([validated by `spec-trace-dispatch:86`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L87), [`spec-trace-dispatch:237`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L239), [`spec-trace-dispatch:251`](apps/floor/src/jobs/spec-trace/spec-trace-dispatch.test.ts#L253), [`loop.test.ts:152`](apps/floor/src/main-loop/loop.test.ts#L152); implemented by [`loop.ts:53`](apps/floor/src/main-loop/loop.ts#L53), [`internal.ts:18`](apps/floor/src/jobs/internal.ts#L18))
