...
- The Floor's `assembly_run.start` handler stamps the hash once, at the moment the definition resolves, and never overwrites an already-stamped value. ([validated by `start-event-handler.test.ts:240`](apps/floor/src/work/assembly-run/start-event-handler.test.ts#L240), [`start-event-handler.test.ts:271`](apps/floor/src/work/assembly-run/start-event-handler.test.ts#L271), [`start-event-handler.test.ts:293`](apps/floor/src/work/assembly-run/start-event-handler.test.ts#L293))
