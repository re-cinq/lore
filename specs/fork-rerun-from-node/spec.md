...
- `stampDefinitionHash` records the hash only when the row carries none, in the Postgres adapter and the in-memory double alike, so a redelivered start that loads a since-edited definition cannot re-point a line at a graph it never ran. ([validated by `assembly-lines.test.ts:846`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L846), [`assembly-lines.test.ts:856`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L856), [`assembly-lines.test.ts:865`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L865), [`assembly-lines.test.ts:875`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L875))
