...
- The plain (non-fork) start path is unchanged: same statement, same parameters, no copied-rows CTE. ([validated by `assembly-lines.test.ts:1240`](libs/shared/src/project/assembly-lines/assembly-lines.test.ts#L1240))
