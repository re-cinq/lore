...
- FR-20.14: The `Repo` files port reads a file at a given ref (null when
  ...
  ([validated by `repo-files.test.ts:53`](libs/shared/src/project/repo/repo-files.test.ts#L53), [`repo-files.test.ts:60`](libs/shared/src/project/repo/repo-files.test.ts#L60), [`repo-files.test.ts:66`](libs/shared/src/project/repo/repo-files.test.ts#L66))
...
- FR-20.16: The `Issues` port returns the GitHubPort issues for the
  ...
  closes, and labels by number bound to the repo. ([validated by `issues.test.ts:57`](libs/shared/src/project/issues/issues.test.ts#L57), [`issues.test.ts:102`](libs/shared/src/project/issues/issues.test.ts#L102), [`issues.test.ts:115`](libs/shared/src/project/issues/issues.test.ts#L115))
