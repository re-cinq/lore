...
- FR-20.15: The `PullRequests` port lists only the repo's PRs, merges by
  ...
  repo and number. ([validated by `pull-requests.test.ts:81`](libs/shared/src/project/pulls/pull-requests.test.ts#L81), [`pull-requests.test.ts:117`](libs/shared/src/project/pulls/pull-requests.test.ts#L117), [`pull-requests.test.ts:126`](libs/shared/src/project/pulls/pull-requests.test.ts#L126))
