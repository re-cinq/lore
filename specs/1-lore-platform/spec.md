...
- FR-20.10: The `AgentRunner` port launches a Station via the injected
  ...
  (`LORE_DB_HOST` set) yet allows cluster mode there. ([validated by `agent-runner.test.ts:33`](libs/shared/src/project/agents/agent-runner.test.ts#L33), [`agent-runner.test.ts:15`](libs/shared/src/project/agents/agent-runner.test.ts#L15), [`agent-runner.test.ts:70`](libs/shared/src/project/agents/agent-runner.test.ts#L98), [`agent-runner.test.ts:90`](libs/shared/src/project/agents/agent-runner.test.ts#L118), [`agent-runner.test.ts:114`](libs/shared/src/project/agents/agent-runner.test.ts#L142), [`agents.test.ts:22`](libs/shared/src/project/agents/agents.test.ts#L22), [`agents.test.ts:34`](libs/shared/src/project/agents/agents.test.ts#L34))
