...
- FR-7.6: Nightly re-index MUST hard-delete chunks whose source
  ...
  stale content is retained. ([validated by `verify.test.ts:69`](apps/floor/src/jobs/context-jobs/reindex/verify.test.ts#L69), [`chunks.test.ts:391`](libs/shared/src/project/chunks/chunks.test.ts#L391))
...
- FR-8.4: `lore_my_usage` tool exposes per-developer token consumption
  (today / 7-day / 30-day) without leaving Claude Code. ([validated by `usage-tools.test.ts:44`](apps/mcp-server/src/mcp/tools/usage-tools.test.ts#L44), [`usage-pg.test.ts:144`](libs/shared/src/project/usage/usage-pg.test.ts#L144))
...
The system MUST detect when specifications diverge from implementation. ([validated by `chunks.test.ts:190`](libs/shared/src/project/chunks/chunks.test.ts#L187), [`chunks.test.ts:209`](libs/shared/src/project/chunks/chunks.test.ts#L209))
...
- FR-14.3: Test files and generated files are excluded. ([validated by `chunks.test.ts:887`](libs/shared/src/project/chunks/chunks.test.ts#L884), [`chunks.test.ts:917`](libs/shared/src/project/chunks/chunks.test.ts#L917))
- FR-14.4: Spec-drift reads a repo's spec chunks and code symbols from
  ...
  ([validated by `chunks.test.ts:153`](libs/shared/src/project/chunks/chunks.test.ts#L150), [`chunks.test.ts:168`](libs/shared/src/project/chunks/chunks.test.ts#L168), [`chunks.test.ts:187`](libs/shared/src/project/chunks/chunks.test.ts#L187), [`chunks.test.ts:209`](libs/shared/src/project/chunks/chunks.test.ts#L209), [`chunks.test.ts:884`](libs/shared/src/project/chunks/chunks.test.ts#L884), [`chunks.test.ts:917`](libs/shared/src/project/chunks/chunks.test.ts#L917))
...
- FR-19.25: lore-api serves the org-wide `lore.settings` under the
  ...
  developers have run a local session against a repo. ([validated by [`org-settings.test.ts:44`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L44), [`org-settings.test.ts:50`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L50), [`org-settings.test.ts:69`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L69), [`org-settings.test.ts:69`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L69), [`org-settings.test.ts:85`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L85), [`org-settings.test.ts:109`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L109), [`org-settings.test.ts:109`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L109), [`org-settings.test.ts:69`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L69), [`org-settings.test.ts:85`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L85), [`org-settings.test.ts:99`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L99), [`org-settings.test.ts:109`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L109), [`org-settings.test.ts:120`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L120), [`repos.test.ts:107`](apps/web-ui/src/lib/api/repos.test.ts#L107), [`repos.test.ts:117`](apps/web-ui/src/lib/api/repos.test.ts#L117))
...
- FR-19.26: lore-api serves the context browser's chunk reads —
  ...
  ([validated by [`chunks-browse.test.ts:55`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L55), [`chunks-browse.test.ts:59`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L59), [`chunks-browse.test.ts:76`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L76), [`chunks-browse.test.ts:88`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L88), [`chunks-browse.test.ts:101`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L101), [`chunks-browse.test.ts:115`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L115), [`chunks-browse.test.ts:129`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L129), [`chunks-browse.test.ts:153`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L153), [`chunks-browse.test.ts:181`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L181), [`chunks-browse.test.ts:203`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L203), [`chunks-browse.test.ts:234`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L234), [`chunks-browse.test.ts:234`](apps/lore-api/src/api/routes/context/chunks-browse.test.ts#L234))
...
- FR-19.27: Anthropic's Admin API reports usage and cost and exposes NO
  ...
  ([`credit-ledger.test.ts:51`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L51), [`credit-ledger.test.ts:61`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L61), [`credit-ledger.test.ts:65`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L65), [`credit-ledger.test.ts:72`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L72), [`credit-ledger.test.ts:85`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L85), [`credit-ledger.test.ts:134`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L134), [`credit-ledger.test.ts:149`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L149), [`credit-ledger.test.ts:155`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L155), [`credit-ledger.test.ts:161`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L161), [`credit-ledger.test.ts:167`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L167), [`spend-window.test.ts:397`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L397), [`spend-window.test.ts:406`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L406), [`spend-window.test.ts:416`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L416), [`SpendView.test.tsx:474`](apps/web-ui/src/app/spend/SpendView.test.tsx#L474), [`spend-window.test.ts:427`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L427), [`spend-window.test.ts:427`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L427), [`credit-ledger.test.ts:167`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L167), [`credit-ledger.test.ts:190`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L190), [`credit-ledger.test.ts:100`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L100), [`credit-ledger.test.ts:122`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L122), [`credit-ledger.test.ts:128`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L128), [`credit-ledger.test.ts:175`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L175), [`spend-window.test.ts:461`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L461))
...
- FR-19.29: `/spend` attributes Lore-computed spend to the execution
  ...
  ([validated by [`spend-window.test.ts:148`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L148), [`spend-window.test.ts:478`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L478), [`spend-window.test.ts:492`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L492), [`spend-window.test.ts:427`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L427), [`SpendView.test.tsx:633`](apps/web-ui/src/app/spend/SpendView.test.tsx#L633), [`SpendView.test.tsx:703`](apps/web-ui/src/app/spend/SpendView.test.tsx#L703), [`SpendView.test.tsx:708`](apps/web-ui/src/app/spend/SpendView.test.tsx#L708)])
...
- **FR-19g — Whose invoice, and what a run costs** *(added 2026-09-03)*.
  ...
  ([validated by [`spend-window.test.ts:446`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L446), [`vendor-split.test.ts:5`](apps/lore-api/src/features/analytics/vendor-split.test.ts#L5), [`vendor-split.test.ts:19`](apps/lore-api/src/features/analytics/vendor-split.test.ts#L19), [`vendor-split.test.ts:25`](apps/lore-api/src/features/analytics/vendor-split.test.ts#L25), [`model-vendor.test.ts:5`](libs/shared/src/llm/model-vendor.test.ts#L5), [`model-vendor.test.ts:17`](libs/shared/src/llm/model-vendor.test.ts#L17), [`model-vendor.test.ts:21`](libs/shared/src/llm/model-vendor.test.ts#L21), [`model-vendor.test.ts:11`](libs/shared/src/llm/model-vendor.test.ts#L11), [`model-vendor.test.ts:25`](libs/shared/src/llm/model-vendor.test.ts#L25), [`model-vendor.test.ts:31`](libs/shared/src/llm/model-vendor.test.ts#L31), [`SpendView.test.tsx:721`](apps/web-ui/src/app/spend/SpendView.test.tsx#L721), [`SpendView.test.tsx:728`](apps/web-ui/src/app/spend/SpendView.test.tsx#L728), [`SpendView.test.tsx:741`](apps/web-ui/src/app/spend/SpendView.test.tsx#L741))
...
- FR-20.6: The `Chunks` knowledge-store port checks schema existence via
  ...
  ([validated by `chunks.test.ts:42`](libs/shared/src/project/chunks/chunks.test.ts#L39), [`chunks.test.ts:47`](libs/shared/src/project/chunks/chunks.test.ts#L47), [`chunks.test.ts:53`](libs/shared/src/project/chunks/chunks.test.ts#L53), [`chunks.test.ts:63`](libs/shared/src/project/chunks/chunks.test.ts#L63), [`chunks.test.ts:78`](libs/shared/src/project/chunks/chunks.test.ts#L78), [`chunks.test.ts:95`](libs/shared/src/project/chunks/chunks.test.ts#L95), [`chunks.test.ts:103`](libs/shared/src/project/chunks/chunks.test.ts#L103), [`chunks.test.ts:114`](libs/shared/src/project/chunks/chunks.test.ts#L114), [`chunks.test.ts:128`](libs/shared/src/project/chunks/chunks.test.ts#L128), [`chunks.test.ts:136`](libs/shared/src/project/chunks/chunks.test.ts#L136), [`chunks.test.ts:142`](libs/shared/src/project/chunks/chunks.test.ts#L142), [`chunks.test.ts:150`](libs/shared/src/project/chunks/chunks.test.ts#L150), [`chunks.test.ts:168`](libs/shared/src/project/chunks/chunks.test.ts#L168), [`chunks.test.ts:187`](libs/shared/src/project/chunks/chunks.test.ts#L187), [`chunks.test.ts:209`](libs/shared/src/project/chunks/chunks.test.ts#L209), [`chunks.test.ts:232`](libs/shared/src/project/chunks/chunks.test.ts#L232), [`chunks.test.ts:246`](libs/shared/src/project/chunks/chunks.test.ts#L246), [`chunks.test.ts:254`](libs/shared/src/project/chunks/chunks.test.ts#L254), [`chunks.test.ts:268`](libs/shared/src/project/chunks/chunks.test.ts#L268), [`chunks.test.ts:275`](libs/shared/src/project/chunks/chunks.test.ts#L275), [`chunks.test.ts:292`](libs/shared/src/project/chunks/chunks.test.ts#L292), [`chunks.test.ts:315`](libs/shared/src/project/chunks/chunks.test.ts#L315), [`chunks.test.ts:359`](libs/shared/src/project/chunks/chunks.test.ts#L359), [`chunks.test.ts:391`](libs/shared/src/project/chunks/chunks.test.ts#L391), [`chunks.test.ts:408`](libs/shared/src/project/chunks/chunks.test.ts#L408), [`chunks.test.ts:423`](libs/shared/src/project/chunks/chunks.test.ts#L423), [`chunks.test.ts:434`](libs/shared/src/project/chunks/chunks.test.ts#L434), [`chunks.test.ts:449`](libs/shared/src/project/chunks/chunks.test.ts#L449), [`chunks.test.ts:458`](libs/shared/src/project/chunks/chunks.test.ts#L458), [`chunks.test.ts:465`](libs/shared/src/project/chunks/chunks.test.ts#L465), [`chunks.test.ts:487`](libs/shared/src/project/chunks/chunks.test.ts#L487), [`chunks.test.ts:495`](libs/shared/src/project/chunks/chunks.test.ts#L495), [`chunks.test.ts:524`](libs/shared/src/project/chunks/chunks.test.ts#L524), [`chunks.test.ts:538`](libs/shared/src/project/chunks/chunks.test.ts#L538), [`chunks.test.ts:574`](libs/shared/src/project/chunks/chunks.test.ts#L574), [`chunks.test.ts:593`](libs/shared/src/project/chunks/chunks.test.ts#L593))
...
- FR-20.10: The `AgentRunner` port launches a Station via the injected
  ...
  (`LORE_DB_HOST` set) yet allows cluster mode there. ([validated by `agent-runner.test.ts:33`](libs/shared/src/project/agents/agent-runner.test.ts#L27), [`agent-runner.test.ts:15`](libs/shared/src/project/agents/agent-runner.test.ts#L15), [`agent-runner.test.ts:90`](libs/shared/src/project/agents/agent-runner.test.ts#L90), [`agent-runner.test.ts:110`](libs/shared/src/project/agents/agent-runner.test.ts#L110), [`agent-runner.test.ts:134`](libs/shared/src/project/agents/agent-runner.test.ts#L134), [`agents.test.ts:16`](libs/shared/src/project/agents/agents.test.ts#L16), [`agents.test.ts:28`](libs/shared/src/project/agents/agents.test.ts#L28))
...
- FR-20.21: Legacy chunk relocation is self-healing: the nightly reindex,
  ...
  `metadata.migrated_from` ([validated by `chunks.test.ts:672`](libs/shared/src/project/chunks/chunks.test.ts#L669), [`chunks.test.ts:686`](libs/shared/src/project/chunks/chunks.test.ts#L686), [`chunks.test.ts:719`](libs/shared/src/project/chunks/chunks.test.ts#L719))
  - Provenance-less rows with a classifyFile content type are adopted via
    `ingested_by = 'reindex-job'`; other content types relocate unowned ([validated by `chunks.test.ts:672`](libs/shared/src/project/chunks/chunks.test.ts#L669), [`chunks.test.ts:709`](libs/shared/src/project/chunks/chunks.test.ts#L709))
  - The Pg adapter issues copy and delete as one statement (shared
    ...
    rows against themselves and delete them ([validated by `chunks.test.ts:735`](libs/shared/src/project/chunks/chunks.test.ts#L732), [`chunks.test.ts:743`](libs/shared/src/project/chunks/chunks.test.ts#L743), [`chunks.test.ts:755`](libs/shared/src/project/chunks/chunks.test.ts#L755))
...
- Schema-per-team isolation in the vector store. ([validated by `chunks.test.ts:153`](libs/shared/src/project/chunks/chunks.test.ts#L150), [`chunks.test.ts:168`](libs/shared/src/project/chunks/chunks.test.ts#L168))
...
- Rate limiting: 30/min webhooks, 60/min task ops, 200/min other
  (in-memory sliding window). 1 MB body size limit. ([validated by `rate-limit.test.ts:42`](apps/lore-api/src/server/plugins/rate-limit.test.ts#L39), [`auth.test.ts:17`](apps/lore-api/src/api/routes/auth.test.ts#L17), [`webhook-incident.test.ts:144`](apps/lore-api/src/api/routes/webhooks/webhook-incident.test.ts#L144))
