...
- FR-20.1b: `setColumns` writes only the given allow-listed task columns
  ...
  for an unknown task id. ([validated by `task-queue.test.ts:633`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L633), [`task-queue.test.ts:640`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L640), [`task-queue.test.ts:647`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L647), [`task-queue.test.ts:652`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L652), [`task-queue.test.ts:659`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L659), [`task-queue.test.ts:665`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L665), [`task-queue.test.ts:672`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L672), [`task-queue.test.ts:684`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L684), [`task-queue.test.ts:696`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L696))
