...
- FR-19.6: _(Restated 2026-09-09.)_ The run detail page renders the task's status transitions inside the selected node's transcript rather than as a separate Event Timeline card: each transition that fell inside that node's visits reads as a `· task From → To` system line in the conversation, with its metadata folded behind the line and the from-status omitted on the first transition; a run with no backing task shows the note that no status history is available. ([validated by `transcript-entries.test.ts:116`](apps/web-ui/src/lib/transcript-entries.test.ts#L117), [`transcript-entries.test.ts:141`](apps/web-ui/src/lib/transcript-entries.test.ts#L142), [`TranscriptView.test.tsx:56`](apps/web-ui/src/app/assembly-runs/[id]/TranscriptView.test.tsx#L56), [`RunLiveShell.test.tsx:146`](apps/web-ui/src/app/assembly-runs/[id]/RunLiveShell.test.tsx#L138))
...
- FR-19.13: The task-refresh provider is the page's single scheduler:
  ...
  fresh run in its place. ([validated by `TaskRefreshProvider.test.tsx:149`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L160), [`TaskRefreshProvider.test.tsx:157`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L170), [`TaskRefreshProvider.test.tsx:177`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L190), [`TaskRefreshProvider.test.tsx:193`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L219), [`TaskRefreshProvider.test.tsx:206`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L219), [`TaskRefreshProvider.test.tsx:218`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L231), [`TaskRefreshProvider.test.tsx:232`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L245), [`TaskRefreshProvider.test.tsx:243`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L256), [`TaskRefreshProvider.test.tsx:254`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L267), [`TaskRefreshProvider.test.tsx:269`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L286), [`TaskRefreshProvider.test.tsx:288`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L303), [`TaskRefreshProvider.test.tsx:309`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L324), [`TaskRefreshProvider.test.tsx:336`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L348), [`TaskRefreshProvider.test.tsx:357`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L366), [`TaskRefreshProvider.test.tsx:387`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L396), [`TaskRefreshProvider.test.tsx:416`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L423), [`TaskRefreshProvider.test.tsx:442`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L453), [`TaskRefreshProvider.test.tsx:472`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L487), [`TaskRefreshProvider.test.tsx:491`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L506), [`TaskRefreshProvider.test.tsx:206`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L206))
