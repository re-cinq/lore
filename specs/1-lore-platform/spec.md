...
- FR-19.19: lore-api serves the run views' four reads under the `read`
  ...
  moment the card showing the number disappears. ([validated by `assembly-lines.test.ts:36`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L58), [`assembly-lines.test.ts:40`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L62), [`assembly-lines.test.ts:52`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L74), [`assembly-lines.test.ts:84`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L108), [`assembly-lines.test.ts:93`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L117), [`assembly-lines.test.ts:104`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L128), [`assembly-lines.test.ts:173`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L197), [`assembly-lines.test.ts:183`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L207), [`assembly-lines.test.ts:193`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L217), [`assembly-lines.test.ts:205`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L229), [`assembly-lines.test.ts:225`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L249), [`assembly-lines.test.ts:237`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L261), [`assembly-lines.test.ts:257`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L281), [`assembly-lines.test.ts:267`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L291))
