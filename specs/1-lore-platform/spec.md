...
- **FR-19h — Reading the spend page at a glance** _(added 2026-09-09)_.
  ...
  it. A daily-cost bar chart labels each day
  with its cost and date, with the calls and full precision kept in the Daily
  Cost table. The deeper LLM cuts — by model, kind, day, repo, task type and
  ...
  tables. The bar geometry is pure and scale-free: heights and widths are
  fractions of the largest value, an all-zero or empty interval renders flat
  rather than dividing by zero, and a comparison with no billed side is not
  drawn at all.
  ([validated by [groups the page into labelled estimate and billed sections](apps/web-ui/src/app/spend/SpendView.test.tsx#L508), [`SpendView.test.tsx:522`](apps/web-ui/src/app/spend/SpendView.test.tsx#L522), [`SpendView.test.tsx:530`](apps/web-ui/src/app/spend/SpendView.test.tsx#L530), [`SpendView.test.tsx:537`](apps/web-ui/src/app/spend/SpendView.test.tsx#L537), [charts the daily cost above the breakdown tables](apps/web-ui/src/app/spend/SpendView.test.tsx#L543), [folds the deeper LLM breakdowns behind a disclosure](apps/web-ui/src/app/spend/SpendView.test.tsx#L552), [labels an estimate section with an estimate pill](apps/web-ui/src/app/spend/SpendSection.test.tsx#L7), [`SpendSection.test.tsx:25`](apps/web-ui/src/app/spend/SpendSection.test.tsx#L25), [`SpendSection.test.tsx:36`](apps/web-ui/src/app/spend/SpendSection.test.tsx#L36), [shows the label and both figures for a comparable pair](apps/web-ui/src/app/spend/SpendCompareBars.test.tsx#L15), [`SpendCompareBars.test.tsx:23`](apps/web-ui/src/app/spend/SpendCompareBars.test.tsx#L23), [`SpendCompareBars.test.tsx:29`](apps/web-ui/src/app/spend/SpendCompareBars.test.tsx#L29), [`SpendCompareBars.test.tsx:39`](apps/web-ui/src/app/spend/SpendCompareBars.test.tsx#L39), [draws one bar per day](apps/web-ui/src/app/spend/SpendTrendChart.test.tsx#L16), [labels each day with its cost](apps/web-ui/src/app/spend/SpendTrendChart.test.tsx#L22), [`SpendTrendChart.test.tsx:29`](apps/web-ui/src/app/spend/SpendTrendChart.test.tsx#L29), [`SpendTrendChart.test.tsx:38`](apps/web-ui/src/app/spend/SpendTrendChart.test.tsx#L38), [`SpendTrendChart.test.tsx:46`](apps/web-ui/src/app/spend/SpendTrendChart.test.tsx#L46), [scales each value against the largest](apps/web-ui/src/app/spend/spend-chart-geometry.test.ts#L5), [`spend-chart-geometry.test.ts:9`](apps/web-ui/src/app/spend/spend-chart-geometry.test.ts#L9), [`spend-chart-geometry.test.ts:13`](apps/web-ui/src/app/spend/spend-chart-geometry.test.ts#L13), [`spend-chart-geometry.test.ts:17`](apps/web-ui/src/app/spend/spend-chart-geometry.test.ts#L17), [scales both values to the larger of the two](apps/web-ui/src/app/spend/spend-chart-geometry.test.ts#L23), [`spend-chart-geometry.test.ts:30`](apps/web-ui/src/app/spend/spend-chart-geometry.test.ts#L30), [takes the Anthropic vendor row when the split names one](apps/web-ui/src/app/spend/SpendView.test.tsx#L568), [is zero when the split names other vendors but no Anthropic](apps/web-ui/src/app/spend/SpendView.test.tsx#L582), [`SpendView.test.tsx:590`](apps/web-ui/src/app/spend/SpendView.test.tsx#L590), [counts the no-cluster bucket as the org API key](apps/web-ui/src/app/spend/SpendBillingSource.test.tsx#L16), [`SpendBillingSource.test.tsx:23`](apps/web-ui/src/app/spend/SpendBillingSource.test.tsx#L23), [`SpendBillingSource.test.tsx:30`](apps/web-ui/src/app/spend/SpendBillingSource.test.tsx#L30), [splits metered spend into org API key and satellite subscription](apps/web-ui/src/app/spend/SpendBillingSource.test.tsx#L39), [`SpendBillingSource.test.tsx:52`](apps/web-ui/src/app/spend/SpendBillingSource.test.tsx#L52), [`SpendBillingSource.test.tsx:60`](apps/web-ui/src/app/spend/SpendBillingSource.test.tsx#L60)])
