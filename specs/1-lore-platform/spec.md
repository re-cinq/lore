...
- FR-20.1b: `setColumns` writes only the given allow-listed task columns
  ...
  for an unknown task id. ([validated by `task-queue.test.ts:633`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L633), [`task-queue.test.ts:652`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L652), [`task-queue.test.ts:665`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L665), [`task-queue.test.ts:672`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L672), [`task-queue.test.ts:684`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L684), [`task-queue.test.ts:696`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L696))
- FR-20.1c: `activeTaskByIssue` returns null for a task whose status is terminal (`retried` or `completed`), so that a retried or completed task never guards its issue from being picked again by the backlog loop. Only genuinely active statuses count as a guard. ([validated by `task-queue.test.ts:608`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L608), [`task-queue.test.ts:616`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L616), [`task-queue.test.ts:624`](libs/shared/src/outbound/project/tasks/task-queue.test.ts#L624))
