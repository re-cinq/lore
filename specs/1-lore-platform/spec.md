...
- FR-19.19: lore-api serves the run views' four reads under the `read`
  ...
  moment the card showing the number disappears. ([validated by `assembly-lines.test.ts:36`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L102), [`assembly-lines.test.ts:40`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L106), [`assembly-lines.test.ts:52`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L122), [`assembly-lines.test.ts:84`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L169), [`assembly-lines.test.ts:93`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L185), [`assembly-lines.test.ts:104`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L202), [`assembly-lines.test.ts:173`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L297), [`assembly-lines.test.ts:183`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L310), [`assembly-lines.test.ts:193`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L318), [`assembly-lines.test.ts:205`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L330), [`assembly-lines.test.ts:225`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L378), [`assembly-lines.test.ts:237`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L390), [`assembly-lines.test.ts:257`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L410), [`assembly-lines.test.ts:267`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L420))
