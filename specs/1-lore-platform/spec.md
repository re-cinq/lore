...
- FR-14.3: Test files and generated files are excluded. ([validated by `chunks.test.ts:887`](libs/shared/src/project/chunks/chunks.test.ts#L891), [`chunks.test.ts:917`](libs/shared/src/project/chunks/chunks.test.ts#L924))
...
- FR-20.21: Legacy chunk relocation is self-healing: the nightly reindex,
  ...
  `metadata.migrated_from` ([validated by `chunks.test.ts:672`](libs/shared/src/project/chunks/chunks.test.ts#L676), [`chunks.test.ts:686`](libs/shared/src/project/chunks/chunks.test.ts#L693), [`chunks.test.ts:719`](libs/shared/src/project/chunks/chunks.test.ts#L726))
  - Provenance-less rows with a classifyFile content type are adopted via
    `ingested_by = 'reindex-job'`; other content types relocate unowned ([validated by `chunks.test.ts:672`](libs/shared/src/project/chunks/chunks.test.ts#L676), [`chunks.test.ts:709`](libs/shared/src/project/chunks/chunks.test.ts#L716))
  - The Pg adapter issues copy and delete as one statement (shared
    ...
    rows against themselves and delete them ([validated by `chunks.test.ts:735`](libs/shared/src/project/chunks/chunks.test.ts#L739), [`chunks.test.ts:743`](libs/shared/src/project/chunks/chunks.test.ts#L750), [`chunks.test.ts:755`](libs/shared/src/project/chunks/chunks.test.ts#L762))
