...
- **FR-19h — Reading the spend page at a glance** _(added 2026-09-09)_.
  ...
  Anthropic row, falling back to the metered total only when there is no split — and a daily-cost bar chart labels each day
