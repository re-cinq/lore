...
- The gateway also serves an **agent-skills registry** at `/skills` (unauthenticated —
  ...
  `resources.skills` + `skills_source`, ADR-030). ([validated by `skills-registry.test.ts:46`](apps/mcp-server/src/server/skills-registry.test.ts#L46), [`skills-registry.test.ts:54`](apps/mcp-server/src/server/skills-registry.test.ts#L54), [`skills-registry.test.ts:67`](apps/mcp-server/src/server/skills-registry.test.ts#L67), [`skills-registry.test.ts:78`](apps/mcp-server/src/server/skills-registry.test.ts#L78))
...
- FR-8.4: `lore_my_usage` tool exposes per-developer token consumption
  (today / 7-day / 30-day) without leaving Claude Code. ([validated by `usage-tools.test.ts:44`](apps/mcp-server/src/mcp/tools/usage-tools.test.ts#L44), [`usage-pg.test.ts:105`](libs/shared/src/project/usage/usage-pg.test.ts#L145))
...
- FR-11.4: Facts carry temporal validity (`valid_from`/`valid_to`),
  ...
  `half_life_days`). ([validated by `facts.test.ts:96`](libs/server-core/src/features/memory/facts.test.ts#L96), [`memory-ranking.test.ts:162`](libs/shared/src/memory-ranking.test.ts#L162))
- FR-11.5: Contradiction detection: when a new fact has cosine
  ...
  conflicts. ([validated by `facts.test.ts:96`](libs/server-core/src/features/memory/facts.test.ts#L96), [`facts.test.ts:129`](libs/server-core/src/features/memory/facts.test.ts#L129))
...
attempt). ([validated by `TaskDetailView.test.tsx:109`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L109), [`TaskDetailView.test.tsx:318`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L318))
...
- FR-19.2: The agent row, failure row, and review-iterations row each
  ...
  otherwise. ([validated by `TaskDetailView.test.tsx:209`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L209), [`TaskDetailView.test.tsx:215`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L215), [`TaskDetailView.test.tsx:237`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L237), [`TaskDetailView.test.tsx:243`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L243), [`TaskDetailView.test.tsx:249`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L249))
...
- FR-19.3a: When the task has exactly one run attempt, the page
  ...
  shell renders with its runs list. ([validated by `TaskDetailView.test.tsx:340`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L340), [`TaskDetailView.test.tsx:346`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L346), [`TaskDetailView.test.tsx:350`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L350))
- FR-19.4: In-flight controls follow actions-up: a "Run Now" form
  ...
  a PR and is not cancelled. ([validated by `TaskDetailView.test.tsx:162`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L162), [`TaskDetailView.test.tsx:173`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L173), [`TaskDetailView.test.tsx:180`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L180), [`TaskDetailView.test.tsx:189`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L189), [`TaskDetailView.test.tsx:202`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L202), [`TaskDetailView.test.tsx:277`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L277), [`TaskDetailView.test.tsx:298`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L298), [`TaskDetailView.test.tsx:305`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L305), [`CancelTaskButton.test.tsx:7`](apps/web-ui/src/app/tasks/[id]/CancelTaskButton.test.tsx#L7), [`CancelTaskButton.test.tsx:17`](apps/web-ui/src/app/tasks/[id]/CancelTaskButton.test.tsx#L17), [`CancelTaskButton.test.tsx:30`](apps/web-ui/src/app/tasks/[id]/CancelTaskButton.test.tsx#L30))
- FR-19.5: When a failed task carries a failed-event with metadata, the
  ...
  metadata no panel is shown. ([validated by `TaskDetailView.test.tsx:254`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L254), [`TaskDetailView.test.tsx:270`](apps/web-ui/src/app/tasks/[id]/TaskDetailView.test.tsx#L270))
...
- FR-19.13: The task-refresh provider is the page's single scheduler:
  ...
  fresh run in its place. ([validated by `TaskRefreshProvider.test.tsx:149`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L149), [`TaskRefreshProvider.test.tsx:159`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L159), [`TaskRefreshProvider.test.tsx:179`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L179), [`TaskRefreshProvider.test.tsx:195`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L195), [`TaskRefreshProvider.test.tsx:208`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L208), [`TaskRefreshProvider.test.tsx:220`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L220), [`TaskRefreshProvider.test.tsx:234`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L234), [`TaskRefreshProvider.test.tsx:245`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L245), [`TaskRefreshProvider.test.tsx:256`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L256), [`TaskRefreshProvider.test.tsx:271`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L271), [`TaskRefreshProvider.test.tsx:290`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L290), [`TaskRefreshProvider.test.tsx:311`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L311), [`TaskRefreshProvider.test.tsx:338`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L338), [`TaskRefreshProvider.test.tsx:359`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L359), [`TaskRefreshProvider.test.tsx:390`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L390), [`TaskRefreshProvider.test.tsx:419`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L419), [`TaskRefreshProvider.test.tsx:445`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L445), [`TaskRefreshProvider.test.tsx:475`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L475), [`TaskRefreshProvider.test.tsx:494`](apps/web-ui/src/app/tasks/[id]/TaskRefreshProvider.test.tsx#L494))
...
- FR-19.17: lore-api serves one `lore.repos` row at
  ...
  instead of removing it. ([validated by `repo-record.test.ts:66`](apps/lore-api/src/api/routes/repos/repo-record.test.ts#L66), [`repo-record.test.ts:75`](apps/lore-api/src/api/routes/repos/repo-record.test.ts#L75), [`repo-record.test.ts:83`](apps/lore-api/src/api/routes/repos/repo-record.test.ts#L83), [`repo-record.test.ts:92`](apps/lore-api/src/api/routes/repos/repo-record.test.ts#L92))
...
- FR-19.19: lore-api serves the run views' four reads under the `read`
  ...
  moment the card showing the number disappears. ([validated by `assembly-lines.test.ts:86`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L86), [`assembly-lines.test.ts:90`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L90), [`assembly-lines.test.ts:106`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L106), [`assembly-lines.test.ts:153`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L153), [`assembly-lines.test.ts:169`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L169), [`assembly-lines.test.ts:223`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L223), [`assembly-lines.test.ts:397`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L397), [`assembly-lines.test.ts:410`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L410), [`assembly-lines.test.ts:418`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L418), [`assembly-lines.test.ts:430`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L430), [`assembly-lines.test.ts:223`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L223), [`assembly-lines.test.ts:490`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L490), [`assembly-lines.test.ts:508`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L508), [`assembly-lines.test.ts:518`](apps/lore-api/src/api/routes/assembly-lines/assembly-lines.test.ts#L518))
...
- FR-19.23: lore-api serves the two spend/analytics screens whole —
  ...
  confident zero. ([validated by [`spend.test.ts:30`](apps/lore-api/src/api/routes/analytics/spend.test.ts#L30), [`spend.test.ts:34`](apps/lore-api/src/api/routes/analytics/spend.test.ts#L34), [`spend.test.ts:46`](apps/lore-api/src/api/routes/analytics/spend.test.ts#L46), [`spend-window.test.ts:148`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L148), [`spend-window.test.ts:338`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L338), [`spend-window.test.ts:359`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L359), [`spend-window.test.ts:377`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L377))
...
- FR-19.25: lore-api serves the org-wide `lore.settings` under the
  ...
  developers have run a local session against a repo. ([validated by [`org-settings.test.ts:44`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L44), [`org-settings.test.ts:50`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L50), [`org-settings.test.ts:69`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L69), [`org-settings.test.ts:83`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L69), [`org-settings.test.ts:97`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L85), [`org-settings.test.ts:109`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L109), [`org-settings.test.ts:118`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L109), [`org-settings.test.ts:69`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L69), [`org-settings.test.ts:85`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L85), [`org-settings.test.ts:99`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L99), [`org-settings.test.ts:109`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L109), [`org-settings.test.ts:120`](apps/lore-api/src/api/routes/repos/org-settings.test.ts#L120), [`repos.test.ts:107`](apps/web-ui/src/lib/api/repos.test.ts#L107), [`repos.test.ts:117`](apps/web-ui/src/lib/api/repos.test.ts#L117))
...
- FR-19.27: Anthropic's Admin API reports usage and cost and exposes NO
  ...
  ([`credit-ledger.test.ts:51`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L51), [`credit-ledger.test.ts:61`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L61), [`credit-ledger.test.ts:65`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L65), [`credit-ledger.test.ts:72`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L72), [`credit-ledger.test.ts:85`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L85), [`credit-ledger.test.ts:134`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L134), [`credit-ledger.test.ts:149`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L149), [`credit-ledger.test.ts:155`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L155), [`credit-ledger.test.ts:161`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L161), [`credit-ledger.test.ts:167`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L167), [`spend-window.test.ts:397`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L397), [`spend-window.test.ts:406`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L406), [`spend-window.test.ts:416`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L416), [`SpendView.test.tsx:508`](apps/web-ui/src/app/spend/SpendView.test.tsx#L508), [`spend-window.test.ts:427`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L427), [`spend-window.test.ts:427`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L427), [`credit-ledger.test.ts:167`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L167), [`credit-ledger.test.ts:190`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L190), [`credit-ledger.test.ts:100`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L100), [`credit-ledger.test.ts:122`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L122), [`credit-ledger.test.ts:128`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L128), [`credit-ledger.test.ts:175`](apps/lore-api/src/api/routes/analytics/credit-ledger.test.ts#L175), [`spend-window.test.ts:467`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L467))
...
- FR-19.28: `/spend` renders the remaining balance BELOW the
  ...
  ([`SpendView.test.tsx:449`](apps/web-ui/src/app/spend/SpendView.test.tsx#L449), [`SpendView.test.tsx:486`](apps/web-ui/src/app/spend/SpendView.test.tsx#L486), [`SpendView.test.tsx:496`](apps/web-ui/src/app/spend/SpendView.test.tsx#L496), [`SpendView.test.tsx:508`](apps/web-ui/src/app/spend/SpendView.test.tsx#L508), [`SpendView.test.tsx:533`](apps/web-ui/src/app/spend/SpendView.test.tsx#L533), [`SpendView.test.tsx:542`](apps/web-ui/src/app/spend/SpendView.test.tsx#L542), [`SpendView.test.tsx:548`](apps/web-ui/src/app/spend/SpendView.test.tsx#L548), [`SpendView.test.tsx:556`](apps/web-ui/src/app/spend/SpendView.test.tsx#L556), [`SpendView.test.tsx:560`](apps/web-ui/src/app/spend/SpendView.test.tsx#L560), [`actions.test.ts:33`](apps/web-ui/src/app/spend/actions.test.ts#L33), [`actions.test.ts:46`](apps/web-ui/src/app/spend/actions.test.ts#L46), [`actions.test.ts:60`](apps/web-ui/src/app/spend/actions.test.ts#L60), [`actions.test.ts:74`](apps/web-ui/src/app/spend/actions.test.ts#L74), [`actions.test.ts:85`](apps/web-ui/src/app/spend/actions.test.ts#L85), [`actions.test.ts:94`](apps/web-ui/src/app/spend/actions.test.ts#L94), [`actions.test.ts:101`](apps/web-ui/src/app/spend/actions.test.ts#L101), [`actions.test.ts:108`](apps/web-ui/src/app/spend/actions.test.ts#L108), [`actions.test.ts:124`](apps/web-ui/src/app/spend/actions.test.ts#L124), [`actions.test.ts:136`](apps/web-ui/src/app/spend/actions.test.ts#L136), [`SpendView.test.tsx:573`](apps/web-ui/src/app/spend/SpendView.test.tsx#L573), [`SpendView.test.tsx:582`](apps/web-ui/src/app/spend/SpendView.test.tsx#L582), [`SpendView.test.tsx:603`](apps/web-ui/src/app/spend/SpendView.test.tsx#L603), [`SpendView.test.tsx:636`](apps/web-ui/src/app/spend/SpendView.test.tsx#L636), [`SpendView.test.tsx:646`](apps/web-ui/src/app/spend/SpendView.test.tsx#L646), [`SpendView.test.tsx:664`](apps/web-ui/src/app/spend/SpendView.test.tsx#L664), [`SpendView.test.tsx:732`](apps/web-ui/src/app/spend/SpendView.test.tsx#L732), [`SpendView.test.tsx:751`](apps/web-ui/src/app/spend/SpendView.test.tsx#L751), [`SpendView.test.tsx:697`](apps/web-ui/src/app/spend/SpendView.test.tsx#L697), [`SpendView.test.tsx:710`](apps/web-ui/src/app/spend/SpendView.test.tsx#L710), [`SpendView.test.tsx:722`](apps/web-ui/src/app/spend/SpendView.test.tsx#L722), [`SpendView.test.tsx:675`](apps/web-ui/src/app/spend/SpendView.test.tsx#L675), [`SpendView.test.tsx:181`](apps/web-ui/src/app/spend/SpendView.test.tsx#L181), [`SpendView.test.tsx:204`](apps/web-ui/src/app/spend/SpendView.test.tsx#L204), [`SpendView.test.tsx:478`](apps/web-ui/src/app/spend/SpendView.test.tsx#L478))
...
- FR-19.29: `/spend` attributes Lore-computed spend to the execution
  ...
  ([validated by [`spend-window.test.ts:148`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L148), [`spend-window.test.ts:484`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L484), [`spend-window.test.ts:498`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L498), [`spend-window.test.ts:427`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L427), [`SpendView.test.tsx:683`](apps/web-ui/src/app/spend/SpendView.test.tsx#L683), [`SpendView.test.tsx:761`](apps/web-ui/src/app/spend/SpendView.test.tsx#L761), [`SpendView.test.tsx:766`](apps/web-ui/src/app/spend/SpendView.test.tsx#L766)])
...
- **FR-19f — Interval-scoped spend, with the Kubernetes half** *(added
  ...
  truth.
  ([validated by windows the metered llm spend and prices pod-hours at the assumed profile](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L117), [prices each live pod from its ACTUAL requests](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L269), [`spend-window.test.ts:293`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L293), [caps a never-finished station-run row at 2 hours](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L313), [`spend-window.test.ts:326`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L326), [carries every interval-scoped breakdown the merged spend page renders](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L148), [`spend-window.test.ts:248`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L248), [`SpendView.test.tsx:218`](apps/web-ui/src/app/spend/SpendView.test.tsx#L218), [`SpendView.test.tsx:226`](apps/web-ui/src/app/spend/SpendView.test.tsx#L226), [`SpendView.test.tsx:294`](apps/web-ui/src/app/spend/SpendView.test.tsx#L294), [`compute-cost.test.ts:12`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L12), [`compute-cost.test.ts:25`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L25), [`compute-cost.test.ts:34`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L34), [`compute-cost.test.ts:40`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L40), [`compute-cost.test.ts:47`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L47), [`compute-cost.test.ts:56`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L56), [`compute-cost.test.ts:65`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L65), [`compute-cost.test.ts:75`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L75), [`compute-cost.test.ts:82`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L82), [`compute-cost.test.ts:89`](apps/lore-api/src/features/analytics/compute-cost.test.ts#L89), [lists the running pods with their requests](apps/cluster-agent/src/delivery/routes/cluster.test.ts#L154), [fetches the default 7-day window and renders the whole spend view from it](apps/web-ui/src/app/spend/SpendWindowPanel.test.tsx#L98), [`SpendWindowPanel.test.tsx:132`](apps/web-ui/src/app/spend/SpendWindowPanel.test.tsx#L132), [`SpendWindowPanel.test.tsx:147`](apps/web-ui/src/app/spend/SpendWindowPanel.test.tsx#L147), [`SpendWindowPanel.test.tsx:158`](apps/web-ui/src/app/spend/SpendWindowPanel.test.tsx#L158), [`SpendWindowPanel.test.tsx:174`](apps/web-ui/src/app/spend/SpendWindowPanel.test.tsx#L174), [`SpendWindowPanel.test.tsx:195`](apps/web-ui/src/app/spend/SpendWindowPanel.test.tsx#L195), [`spend-window-presets.test.ts:7`](apps/web-ui/src/app/spend/spend-window-presets.test.ts#L7), [`spend-window-presets.test.ts:14`](apps/web-ui/src/app/spend/spend-window-presets.test.ts#L14), [`spend-window-presets.test.ts:25`](apps/web-ui/src/app/spend/spend-window-presets.test.ts#L25), [`spend-window-presets.test.ts:34`](apps/web-ui/src/app/spend/spend-window-presets.test.ts#L34)])
...
- **FR-19g — Whose invoice, and what a run costs** *(added 2026-09-03)*.
  ...
  ([validated by [`spend-window.test.ts:479`](apps/lore-api/src/api/routes/analytics/spend-window.test.ts#L449), [`vendor-split.test.ts:5`](apps/lore-api/src/features/analytics/vendor-split.test.ts#L5), [`vendor-split.test.ts:19`](apps/lore-api/src/features/analytics/vendor-split.test.ts#L19), [`vendor-split.test.ts:25`](apps/lore-api/src/features/analytics/vendor-split.test.ts#L25), [`model-vendor.test.ts:5`](libs/shared/src/llm/model-vendor.test.ts#L5), [`model-vendor.test.ts:17`](libs/shared/src/llm/model-vendor.test.ts#L17), [`model-vendor.test.ts:23`](libs/shared/src/llm/model-vendor.test.ts#L23), [`model-vendor.test.ts:11`](libs/shared/src/llm/model-vendor.test.ts#L11), [`model-vendor.test.ts:27`](libs/shared/src/llm/model-vendor.test.ts#L27), [`model-vendor.test.ts:33`](libs/shared/src/llm/model-vendor.test.ts#L33), [`SpendView.test.tsx:779`](apps/web-ui/src/app/spend/SpendView.test.tsx#L779), [`SpendView.test.tsx:788`](apps/web-ui/src/app/spend/SpendView.test.tsx#L788), [`SpendView.test.tsx:801`](apps/web-ui/src/app/spend/SpendView.test.tsx#L801))
...
- FR-20.17: The `TestRunner` port lists tests in a trusted sandbox (no
  ...
  descriptor. ([validated by `test-suite.test.ts:37`](libs/shared/src/project/test-runner/test-suite.test.ts#L37), [`test-runner-exec.test.ts:42`](libs/shared/src/project/test-runner/test-runner-exec.test.ts#L42), [`test-runner-exec.test.ts:50`](libs/shared/src/project/test-runner/test-runner-exec.test.ts#L50), [`test-runner-exec.test.ts:64`](libs/shared/src/project/test-runner/test-runner-exec.test.ts#L64))
...
- FR-20.21: Legacy chunk relocation is self-healing: the nightly reindex,
  ...
  - `PUT /api/repos/:o/:r/settings` on lore-api emits one
    ...
    with its status ([validated by forwards a team change to lore-api](apps/web-ui/src/app/api/repos/[owner]/[repo]/settings/route.test.ts#L32), [`route.test.ts:43`](apps/web-ui/src/app/api/repos/[owner]/[repo]/settings/route.test.ts#L43), [`route.test.ts:51`](apps/web-ui/src/app/api/repos/[owner]/[repo]/settings/route.test.ts#L51), [`route.test.ts:61`](apps/web-ui/src/app/api/repos/[owner]/[repo]/settings/route.test.ts#L61), [`route.test.ts:76`](apps/web-ui/src/app/api/repos/[owner]/[repo]/settings/route.test.ts#L76), [`repo-settings.test.ts:31`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L31), [`repo-settings.test.ts:35`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L35), [`repo-settings.test.ts:43`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L43), [`repo-settings.test.ts:43`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L43), [`repo-settings.test.ts:66`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L66), [`repo-settings.test.ts:83`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L83), [`repo-settings.test.ts:97`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L97), [`repo-settings.test.ts:115`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L115), [`repo-settings.test.ts:130`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L130), [`repo-settings.test.ts:146`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L146), [`repo-settings.test.ts:169`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L169), [`repo-settings.test.ts:186`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L186), [`repo-settings.test.ts:66`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L66), [`repo-settings.test.ts:83`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L83), [`repo-settings.test.ts:97`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L97), [`repo-settings.test.ts:115`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L115), [`repo-settings.test.ts:130`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L130), [`repo-settings.test.ts:146`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L146), [`repo-settings.test.ts:169`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L169), [`repo-settings.test.ts:186`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L186), [`repo-settings.test.ts:200`](apps/lore-api/src/api/routes/repos/repo-settings.test.ts#L200), [`repos.test.ts:128`](apps/web-ui/src/lib/api/repos.test.ts#L128))
...
- Centralized auth in `routes.ts`: every `/api/*` route enforces bearer
  ...
  and per-client scoped tokens with SHA-256 hashes. ([validated by `auth.test.ts:56`](apps/lore-api/src/api/routes/auth.test.ts#L56), [`bearer-scope.test.ts:45`](apps/lore-api/src/server/plugins/bearer-scope.test.ts#L45))
...
- Rate limiting: 30/min webhooks, 60/min task ops, 200/min other
  (in-memory sliding window). 1 MB body size limit. ([validated by `rate-limit.test.ts:42`](apps/lore-api/src/server/plugins/rate-limit.test.ts#L42), [`auth.test.ts:17`](apps/lore-api/src/api/routes/auth.test.ts#L17), [`webhook-incident.test.ts:144`](apps/lore-api/src/api/routes/webhooks/webhook-incident.test.ts#L144))
- Slack indexing opt-in per channel only; DMs never indexed. ([validated by `notify-slack.test.ts:10`](libs/shared/src/project/notify/notify-slack.test.ts#L10), [`notify-decision.test.ts:35`](libs/shared/src/project/notify/notify-decision.test.ts#L35))
