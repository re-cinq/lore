...
| File | Change |
|------|--------|
| `mcp-server/src/index.ts` | Added `trackLatency()` helper. Wrapped `lore_query_graph` and `lore_assemble_context` handlers. Added latency to `lore_search_memory` audit log. |
