...
- [ ] T024 [US5] Register shared_write MCP tool — **DEFERRED**
- [ ] T025 [US5] Register shared_read MCP tool — **DEFERRED**
...
- [ ] T028 [US6] Register create_snapshot MCP tool — **DEFERRED**
- [ ] T029 [US6] Register restore_snapshot MCP tool — **DEFERRED**
...
- [ ] T033 [US7] Register agent_health MCP tool — **DEFERRED** (agent_stats covers this use case)
