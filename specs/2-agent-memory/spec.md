...
- All memory writes pass through `sanitizeContent()` / `redactSecrets()`
  ...
  bearer tokens before storage. ([validated by `redact.test.ts:5`](libs/shared/src/redact.test.ts#L5), [`episode-writer.test.ts:21`](apps/agent/src/adapters/episode-writer.test.ts#L21))
