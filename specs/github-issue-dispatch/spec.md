...
- Handles `issues` event with action `labeled` ([validated by `github-map.test.ts:298`](apps/floor/src/listeners/github-map.test.ts#L298))
- The event mapper is a guard at the door: it returns nothing when the `repository` is missing or the
  event type is unhandled. ([validated by `github-map.test.ts:334`](apps/floor/src/listeners/github-map.test.ts#L334), [`github-map.test.ts:344`](apps/floor/src/listeners/github-map.test.ts#L344))
...
7. The `POST /api/webhook/github` endpoint is a signed door: `verifyGitHubSignature` rejects a
   ...
   was rejected without saying which ingress rejected it or where the body went wrong. ([validated by `github-webhook.test.ts:21`](apps/floor/src/delivery/http/routes/github-webhook.test.ts#L21), [`github-webhook.test.ts:132`](apps/floor/src/delivery/http/routes/github-webhook.test.ts#L132), [`raw-body.test.ts:6`](apps/floor/src/delivery/http/raw-body.test.ts#L6), [`raw-body.test.ts:12`](apps/floor/src/delivery/http/raw-body.test.ts#L12))
