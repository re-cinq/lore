...
- **FR22 — Web-ui write client.** `saveAgent` POSTs a create to the collection and
  ...
  responses and thrown fetches to typed results. ([validated by returns unconfigured when env is missing](apps/web-ui/src/lib/agents-api.test.ts#L203), [validated by POSTs to the collection on create and returns ok](apps/web-ui/src/lib/agents-api.test.ts#L210), [validated by PUTs to the named resource on update with the approval header](apps/web-ui/src/lib/agents-api.test.ts#L227), [validated by maps 403 two_key_required](apps/web-ui/src/lib/agents-api.test.ts#L252), [validated by maps 403 codeowners_check_failed](apps/web-ui/src/lib/agents-api.test.ts#L259), [validated by maps other non-ok responses to an error](apps/web-ui/src/lib/agents-api.test.ts#L274), [validated by returns an error when fetch throws](apps/web-ui/src/lib/agents-api.test.ts#L282), [validated by returns unconfigured when env is missing](apps/web-ui/src/lib/agents-api.test.ts#L294), [validated by returns ok on a 200](apps/web-ui/src/lib/agents-api.test.ts#L301), [validated by maps a non-ok response to an error](apps/web-ui/src/lib/agents-api.test.ts#L309), [validated by returns an error when fetch throws](apps/web-ui/src/lib/agents-api.test.ts#L317))
