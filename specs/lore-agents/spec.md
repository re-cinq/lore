...
- **FR13 — Agents list.** The `/agents` page lists resolved agent definitions, labelling an inherited one `org` and an overridden one `project`, with a per-card edit link; the New-definition action sits in the section header, and an empty list renders a "no agent definitions resolved" state. ([validated by labels an inherited agent "org" and an overridden one "project"](apps/web-ui/src/app/repos/[owner]/[repo]/agents/AgentList.test.tsx#L22), [validated by links each card to its edit page](apps/web-ui/src/app/repos/[owner]/[repo]/agents/AgentList.test.tsx#L33), [validated by shows an empty state when there are no agent definitions](apps/web-ui/src/app/repos/[owner]/[repo]/agents/AgentList.test.tsx#L42))
...
- **FR21 — Web-ui list client.** `listAgents` reads the agents envelope over the API
  ...
  without an agents key. ([validated by `agents-api.test.ts:38`](apps/web-ui/src/lib/agents-api.test.ts#L39), [`agents-api.test.ts:43`](apps/web-ui/src/lib/agents-api.test.ts#L44), [`agents-api.test.ts:48`](apps/web-ui/src/lib/agents-api.test.ts#L49), [`agents-api.test.ts:69`](apps/web-ui/src/lib/agents-api.test.ts#L70), [`agents-api.test.ts:74`](apps/web-ui/src/lib/agents-api.test.ts#L75), [`agents-api.test.ts:81`](apps/web-ui/src/lib/agents-api.test.ts#L82))
...
- **FR22 — Web-ui write client.** `saveAgent` POSTs a create to the collection and
  ...
  responses and thrown fetches to typed results. ([validated by returns unconfigured when env is missing](apps/web-ui/src/lib/agents-api.test.ts#L89), [validated by POSTs to the collection on create and returns ok](apps/web-ui/src/lib/agents-api.test.ts#L96), [validated by PUTs to the named resource on update with the approval header](apps/web-ui/src/lib/agents-api.test.ts#L113), [validated by maps 403 two_key_required](apps/web-ui/src/lib/agents-api.test.ts#L138), [validated by maps 403 codeowners_check_failed](apps/web-ui/src/lib/agents-api.test.ts#L145), [validated by maps other non-ok responses to an error](apps/web-ui/src/lib/agents-api.test.ts#L160), [validated by returns an error when fetch throws](apps/web-ui/src/lib/agents-api.test.ts#L168), [validated by returns unconfigured when env is missing](apps/web-ui/src/lib/agents-api.test.ts#L180), [validated by returns ok on a 200](apps/web-ui/src/lib/agents-api.test.ts#L187), [validated by maps a non-ok response to an error](apps/web-ui/src/lib/agents-api.test.ts#L195), [validated by returns an error when fetch throws](apps/web-ui/src/lib/agents-api.test.ts#L203))
