...
- **FR10 — a pooled node reports through the path a person already uses.** A
  ...
  ([validated by accepts an outcome on its own, which is all a human station reports](libs/assembly-lines/src/node-result-schema.test.ts#L11), [`node-result-schema.test.ts:17`](libs/assembly-lines/src/node-result-schema.test.ts#L17), [`node-result-schema.test.ts:26`](libs/assembly-lines/src/node-result-schema.test.ts#L26), [`node-result-schema.test.ts:39`](libs/assembly-lines/src/node-result-schema.test.ts#L48), [`node-result-schema.test.ts:43`](libs/assembly-lines/src/node-result-schema.test.ts#L52), [`node-result-schema.test.ts:49`](libs/assembly-lines/src/node-result-schema.test.ts#L58), [`node-result-schema.test.ts:57`](libs/assembly-lines/src/node-result-schema.test.ts#L66), [`node-result-schema.test.ts:71`](libs/assembly-lines/src/node-result-schema.test.ts#L80), [`resume-event-handler.test.ts:118`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L118), [`resume-event-handler.test.ts:135`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L135), [`resume-event-handler.test.ts:156`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L156), [`resume-event-handler.test.ts:164`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L164), [`advance.test.ts:1154`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1154), [`advance.test.ts:1212`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1212), [`advance.test.ts:1237`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1237), [`advance.test.ts:1264`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1264), [`advance.test.ts:1303`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1303), [`run-node.test.ts:34`](apps/stations/src/kernel/run-node.test.ts#L34), [`run-node.test.ts:48`](apps/stations/src/kernel/run-node.test.ts#L48), [`run-node.test.ts:68`](apps/stations/src/kernel/run-node.test.ts#L68), [`run-node.test.ts:81`](apps/stations/src/kernel/run-node.test.ts#L81), [`resume-event-handler.test.ts:179`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L179), [`resume-event-handler.test.ts:193`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L193), [`advance.test.ts:1183`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1183))
...
- **FR18 — a finished run records what it did.** Reaching the exit writes the
  ...
  ([validated by writes the run's episode when the line reaches its exit](apps/floor/src/jobs/assembly-run/advance.test.ts#L1341), [`advance.test.ts:1359`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1359), [`advance.test.ts:1383`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1383), [`run-episode.test.ts:8`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L8), [`run-episode.test.ts:23`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L23), [`run-episode.test.ts:37`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L37))
...
- **FR22 — a node published to the service is never also given a pod.** A service
  ...
  ([validated by waits rather than relaunching it as a pod, since no pod was ever meant to exist](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L692), [`assembly-run-reaper.test.ts:710`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L710), [`assembly-run-reaper.test.ts:724`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L724), [`advance.test.ts:1407`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1407), [`advance.test.ts:1432`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1432))
