...
- **FR1 — one folder, one registry.** Every station's source lives under
  `apps/stations/src/work/<name>/`, one folder per station, holding its
...
- **FR19 — a station that calls a model is given a credential, and says so when
  ...
  ([validated by declares the LLM secret for a station whose recipe says it needs one](apps/floor/src/jobs/agent/agent-catalog.test.ts#L466), [`comment-triage.test.ts:73`](apps/stations/src/work/comment-triage/comment-triage.test.ts#L73), [`comment-triage.test.ts:90`](apps/stations/src/work/comment-triage/comment-triage.test.ts#L90), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71))
...
- **FR26 — a subscriber repairs what it was not there to receive.** Fan-out reads
  ...
  ([validated by reconciles an event captured BEFORE the subscription existed, which ordering alone loses](libs/shared/src/project/events/event-deliveries.contract.test.ts#L247), [`event-deliveries.contract.test.ts:261`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L261), [`event-deliveries.contract.test.ts:272`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L272), [`loop-boot.test.ts:105`](apps/stations/src/events/loop-boot.test.ts#L105), [`loop-boot.test.ts:126`](apps/stations/src/events/loop-boot.test.ts#L126))
