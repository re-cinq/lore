...
- **FR18 — a finished run records what it did.** Reaching the exit writes the
  ...
  ([validated by writes the run's episode when the line reaches its exit](apps/floor/src/jobs/assembly-run/advance.test.ts#L1479), [`advance.test.ts:1497`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1497), [`advance.test.ts:1521`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1521), [`run-episode.test.ts:8`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L8), [`run-episode.test.ts:23`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L23), [`run-episode.test.ts:37`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L37))
...
- **FR22 — a node published to the service is never also given a pod.** A service
  ...
  ([validated by waits rather than relaunching it as a pod, since no pod was ever meant to exist](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L869), [`assembly-run-reaper.test.ts:883`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L883), [`assembly-run-reaper.test.ts:897`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L897), [`advance.test.ts:1545`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1545), [`advance.test.ts:1570`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1570))
