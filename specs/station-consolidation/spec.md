...
- **FR22 — a node published to the service is never also given a pod.** A service
  ...
  ([validated by waits rather than relaunching it as a pod, since no pod was ever meant to exist](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L894), [`assembly-run-reaper.test.ts:710`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L912), [`assembly-run-reaper.test.ts:724`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L926), [`advance.test.ts:1407`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1407), [`advance.test.ts:1432`](apps/floor/src/jobs/assembly-run/advance.test.ts#L1432))
