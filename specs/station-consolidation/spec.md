...
- **FR1 — one folder, one registry.** Every station's source lives under
  ...
  ([validated by registers every station folder, so adding one and forgetting the barrel fails here](apps/stations/src/stations/registry.test.ts#L18), [`index.test.ts:29`](apps/stations/src/stations/registry.test.ts#L22), [`index.test.ts:33`](apps/stations/src/stations/registry.test.ts#L26))
...
- **FR2 — a station declares its triggers.** Each station's manifest names how
  ...
  ([validated by declares at least one trigger per station, so none is unreachable](apps/stations/src/stations/registry.test.ts#L34), [`index.test.ts:94`](apps/stations/src/stations/registry.test.ts#L85), [`index.test.ts:105`](apps/stations/src/stations/registry.test.ts#L96), [`index.test.ts:115`](apps/stations/src/stations/registry.test.ts#L106), [`registry.test.ts:150`](apps/stations/src/stations/registry.test.ts#L150), [`registry.test.ts:164`](apps/stations/src/stations/registry.test.ts#L164))
...
- **FR3 — the contract discriminates rather than merges.** A node station keeps
  ...
  without an edit.
  ([validated by pairs a node manifest with a node runner, never a sweep's](apps/stations/src/stations/registry.test.ts#L74))
...
- **FR4 — drift is a compile error, not a runtime death.** The registry's
  ...
  schedule parses.
  ([validated by has a station for every dispatchable node type, so none dies at runtime](apps/stations/src/stations/registry.test.ts#L48), [`index.test.ts:67`](apps/stations/src/stations/registry.test.ts#L58), [`index.test.ts:75`](apps/stations/src/stations/registry.test.ts#L66), [`node-station-lookup.test.ts:5`](apps/stations/src/stations/node-station-lookup.test.ts#L5), [`node-station-lookup.test.ts:9`](apps/stations/src/stations/node-station-lookup.test.ts#L9), [`node-station-lookup.test.ts:15`](apps/stations/src/stations/node-station-lookup.test.ts#L15), [`node-station-lookup.test.ts:19`](apps/stations/src/stations/node-station-lookup.test.ts#L19))
...
- **FR5 — untrusted execution decides what may pool, not credentials.** A
  ...
  may pool.
  ([validated by keeps validate in its own pod](apps/stations/src/stations/registry.test.ts#L121), [`registry.test.ts:138`](apps/stations/src/stations/registry.test.ts#L138), [`registry.test.ts:106`](apps/stations/src/stations/registry.test.ts#L106))
...
- **FR6 — an event is delivered per subscriber.** Each subscribed consumer gets
  ...
  ([validated by delivers one event to every subscriber that asked for it](libs/shared/src/project/events/event-deliveries.contract.test.ts#L65), [`event-deliveries.contract.test.ts:77`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L77), [`event-deliveries.contract.test.ts:90`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L90), [`event-deliveries.contract.test.ts:116`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L116), [`event-deliveries.contract.test.ts:127`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L127), [`event-deliveries.contract.test.ts:137`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L137), [`event-deliveries.contract.test.ts:152`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L152), [`event-deliveries.contract.test.ts:166`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L166), [`event-deliveries.contract.test.ts:284`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L284), [`event-deliveries.contract.test.ts:49`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L49), [`event-deliveries.contract.test.ts:334`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L334))
...
- **FR7 — fan-out is single-sourced and reaches every writer.** The clause that
  ...
  ([validated by inserts one delivery per subscriber of the named event](libs/shared/src/project/events/fan-out.test.ts#L5), [`fan-out.test.ts:15`](libs/shared/src/project/events/fan-out.test.ts#L15), [`fan-out.test.ts:19`](libs/shared/src/project/events/fan-out.test.ts#L19), [`events-fan-out.test.ts:6`](libs/shared/src/events-fan-out.test.ts#L6), [`events-fan-out.test.ts:20`](libs/shared/src/events-fan-out.test.ts#L20), [`events-fan-out.test.ts:35`](libs/shared/src/events-fan-out.test.ts#L35), [`assembly-runs-fan-out.test.ts:6`](libs/shared/src/project/assembly-runs/assembly-runs-fan-out.test.ts#L6), [`assembly-runs-fan-out.test.ts:19`](libs/shared/src/project/assembly-runs/assembly-runs-fan-out.test.ts#L19), [`fan-out-writers.test.ts:34`](libs/shared/src/project/events/fan-out-writers.test.ts#L34), [`fan-out-writers.test.ts:38`](libs/shared/src/project/events/fan-out-writers.test.ts#L38))
...
- **FR8 — a subscriber registers before it drains.** Each process upserts its
  ...
  ([validated by delivers nothing for an event nobody subscribed to](libs/shared/src/project/events/event-deliveries.contract.test.ts#L106), [`event-deliveries.contract.test.ts:180`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L180), [`event-deliveries.contract.test.ts:350`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L350), [`cron.test.ts:128`](apps/floor/src/jobs/cron.test.ts#L128), [`cron.test.ts:142`](apps/floor/src/jobs/cron.test.ts#L142), [`cron.test.ts:150`](apps/floor/src/jobs/cron.test.ts#L150), [`drain-loop.test.ts:276`](libs/shared/src/project/events/drain-loop.test.ts#L276), [`drain-loop.test.ts:293`](libs/shared/src/project/events/drain-loop.test.ts#L293), [`drain-loop.test.ts:306`](libs/shared/src/project/events/drain-loop.test.ts#L306))
...
- **FR9 — a delivery carries its own deadline.** The visibility timeout is
  ...
  exhausted.
  ([validated by stamps the subscriber's declared timeout on the delivery](libs/shared/src/project/events/event-deliveries.contract.test.ts#L191), [`event-deliveries.contract.test.ts:203`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L203))
...
- **FR10 — a pooled node reports through the path a person already uses.** A
  ...
  ([validated by accepts an outcome on its own, which is all a human station reports](libs/assembly-lines/src/node-result-schema.test.ts#L6), [`node-result-schema.test.ts:12`](libs/assembly-lines/src/node-result-schema.test.ts#L12), [`node-result-schema.test.ts:21`](libs/assembly-lines/src/node-result-schema.test.ts#L21), [`node-result-schema.test.ts:43`](libs/assembly-lines/src/node-result-schema.test.ts#L43), [`node-result-schema.test.ts:47`](libs/assembly-lines/src/node-result-schema.test.ts#L47), [`node-result-schema.test.ts:53`](libs/assembly-lines/src/node-result-schema.test.ts#L53), [`node-result-schema.test.ts:61`](libs/assembly-lines/src/node-result-schema.test.ts#L61), [`node-result-schema.test.ts:75`](libs/assembly-lines/src/node-result-schema.test.ts#L75), [`resume-event-handler.test.ts:109`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L109), [`resume-event-handler.test.ts:126`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L126), [`resume-event-handler.test.ts:147`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L147), [`resume-event-handler.test.ts:155`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L155), [`advance-line.test.ts:853`](apps/floor/src/jobs/assembly-run/advance-line.test.ts#L853), [`finish-node.test.ts:615`](apps/floor/src/jobs/assembly-run/finish-node.test.ts#L615), [`finish-node.test.ts:640`](apps/floor/src/jobs/assembly-run/finish-node.test.ts#L640), [`advance-line.test.ts:882`](apps/floor/src/jobs/assembly-run/advance-line.test.ts#L882), [`advance-line.test.ts:921`](apps/floor/src/jobs/assembly-run/advance-line.test.ts#L921), [`run-node.test.ts:34`](apps/stations/src/runner/run-node.test.ts#L34), [`run-node.test.ts:48`](apps/stations/src/runner/run-node.test.ts#L48), [`run-node.test.ts:68`](apps/stations/src/runner/run-node.test.ts#L68), [`run-node.test.ts:81`](apps/stations/src/runner/run-node.test.ts#L81), [`resume-event-handler.test.ts:170`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L170), [`resume-event-handler.test.ts:184`](apps/floor/src/jobs/assembly-run/resume-event-handler.test.ts#L184), [`finish-node.test.ts:586`](apps/floor/src/jobs/assembly-run/finish-node.test.ts#L586))
...
- **FR11 — detection is short units, not one long one.** No detection work runs
  ...
  ([validated by starts one unit per specification, not one per repository](apps/stations/src/stations/backfill-scan/backfill-scan.test.ts#L14), [`backfill-scan.test.ts:33`](apps/stations/src/stations/backfill-scan/backfill-scan.test.ts#L33), [`backfill-scan.test.ts:54`](apps/stations/src/stations/backfill-scan/backfill-scan.test.ts#L54), [`backfill-scan.test.ts:65`](apps/stations/src/stations/backfill-scan/backfill-scan.test.ts#L65), [`backfill-scan.test.ts:88`](apps/stations/src/stations/backfill-scan/backfill-scan.test.ts#L88), [`detect.test.ts:46`](apps/stations/src/stations/detect/detect.test.ts#L46), [`detect.test.ts:79`](apps/stations/src/stations/detect/detect.test.ts#L79))
...
- **FR12 — a merged pull request walks an assembly line.** The work that follows
  ...
  ([validated by routes a failed step FORWARD, so one failure cannot skip the steps after it](libs/assembly-lines/src/merge-line.test.ts#L31), [`merge-line.test.ts:16`](libs/assembly-lines/src/merge-line.test.ts#L16), [`merge-line.test.ts:45`](libs/assembly-lines/src/merge-line.test.ts#L45), [`merge-line.test.ts:45`](libs/assembly-lines/src/merge-line.test.ts#L45), [`merge-step.test.ts:32`](apps/stations/src/stations/merge-step/merge-step.test.ts#L32), [`merge-step.test.ts:46`](apps/stations/src/stations/merge-step/merge-step.test.ts#L46), [`merge-step.test.ts:65`](apps/stations/src/stations/merge-step/merge-step.test.ts#L65), [`merge-step.test.ts:81`](apps/stations/src/stations/merge-step/merge-step.test.ts#L81), [`merge-step.test.ts:95`](apps/stations/src/stations/merge-step/merge-step.test.ts#L95), [`merge-step.test.ts:112`](apps/stations/src/stations/merge-step/merge-step.test.ts#L112), [`merge-step.test.ts:129`](apps/stations/src/stations/merge-step/merge-step.test.ts#L129), [`merge-step.test.ts:135`](apps/stations/src/stations/merge-step/merge-step.test.ts#L135), [`start-merge-line.test.ts:17`](apps/stations/src/stations/merge-check/start-merge-line.test.ts#L17), [`start-merge-line.test.ts:38`](apps/stations/src/stations/merge-check/start-merge-line.test.ts#L38), [`start-merge-line.test.ts:55`](apps/stations/src/stations/merge-check/start-merge-line.test.ts#L55), [`start-merge-line.test.ts:74`](apps/stations/src/stations/merge-check/start-merge-line.test.ts#L74), [`start-merge-line.test.ts:93`](apps/stations/src/stations/merge-check/start-merge-line.test.ts#L93), [`assembly-runs.contract.test.ts:722`](libs/shared/src/project/assembly-runs/assembly-runs.contract.test.ts#L722), [`loader.test.ts:548`](libs/assembly-lines/src/loader.test.ts#L575), [`merge-line.test.ts:49`](libs/assembly-lines/src/merge-line.test.ts#L49), [`merge-line.test.ts:85`](libs/assembly-lines/src/merge-line.test.ts#L85), [`merge-line.test.ts:102`](libs/assembly-lines/src/merge-line.test.ts#L102), [`merge-line.test.ts:111`](libs/assembly-lines/src/merge-line.test.ts#L111), [`run.test.ts:25`](apps/stations/src/stations/merge-step/run.test.ts#L25), [`run.test.ts:29`](apps/stations/src/stations/merge-step/run.test.ts#L29), [`run.test.ts:33`](apps/stations/src/stations/merge-step/run.test.ts#L33), [`run.test.ts:39`](apps/stations/src/stations/merge-step/run.test.ts#L39), [`run.test.ts:54`](apps/stations/src/stations/merge-step/run.test.ts#L54), [`run.test.ts:63`](apps/stations/src/stations/merge-step/run.test.ts#L63), [`run.test.ts:86`](apps/stations/src/stations/merge-step/run.test.ts#L86), [`run.test.ts:109`](apps/stations/src/stations/merge-step/run.test.ts#L109))
...
- **FR13 — a model call runs where a compromise is contained.** The original
  ...
  ([validated by pools comment-triage — its one model call is enum-constrained, not agentic](apps/stations/src/stations/registry.test.ts#L132))
...
- **FR14 — curation is a node, not a tail.** Extracting a lesson from a finished
  ...
  ([validated by carries every step the merged-PR handler did](libs/assembly-lines/src/merge-line.test.ts#L16), [`merge-step.test.ts:32`](apps/stations/src/stations/merge-step/merge-step.test.ts#L32))
...
- **FR15 — a subscriber that holds no pool consumes over HTTP.** Registration,
  ...
  field never sent.
  ([validated by registers a subscription and claims back the event it asked for](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L46), [`event-deliveries-roundtrip.test.ts:59`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L59), [`event-deliveries-roundtrip.test.ts:70`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L70), [`event-deliveries-roundtrip.test.ts:83`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L83), [`event-deliveries-roundtrip.test.ts:96`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L96), [`event-deliveries-roundtrip.test.ts:107`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L107), [`event-deliveries-roundtrip.test.ts:118`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L118), [`event-deliveries-roundtrip.test.ts:126`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L126), [`event-deliveries-http.test.ts:39`](libs/shared/src/project/events/event-deliveries-http.test.ts#L39), [`event-deliveries-http.test.ts:52`](libs/shared/src/project/events/event-deliveries-http.test.ts#L52), [`event-deliveries-http.test.ts:67`](libs/shared/src/project/events/event-deliveries-http.test.ts#L67), [`event-deliveries-http.test.ts:79`](libs/shared/src/project/events/event-deliveries-http.test.ts#L79), [`event-deliveries-http.test.ts:87`](libs/shared/src/project/events/event-deliveries-http.test.ts#L87))
...
- **FR17 — a station is given its data, never resolves it.** A station that needs
  ...
  ([validated by reports nothing to do when no task is waiting](apps/stations/src/stations/approval-check/approval-check.test.ts#L47), [`approval-check.test.ts:53`](apps/stations/src/stations/approval-check/approval-check.test.ts#L53), [`approval-check.test.ts:61`](apps/stations/src/stations/approval-check/approval-check.test.ts#L61), [`approval-check.test.ts:70`](apps/stations/src/stations/approval-check/approval-check.test.ts#L70), [`approval-check.test.ts:78`](apps/stations/src/stations/approval-check/approval-check.test.ts#L78), [`approval-check.test.ts:87`](apps/stations/src/stations/approval-check/approval-check.test.ts#L87), [`service-stations.test.ts:17`](apps/stations/src/runner/service-stations.test.ts#L17), [`service-stations.test.ts:27`](apps/stations/src/runner/service-stations.test.ts#L27), [`service-stations.test.ts:37`](apps/stations/src/runner/service-stations.test.ts#L37), [`service-stations.test.ts:43`](apps/stations/src/runner/service-stations.test.ts#L43), [`station.test.ts:5`](apps/stations/src/stations/lib/station.test.ts#L5), [`station.test.ts:9`](apps/stations/src/stations/lib/station.test.ts#L9), [`maintenance.test.ts:80`](apps/lore-api/src/api/routes/maintenance/maintenance.test.ts#L80), [`maintenance.test.ts:90`](apps/lore-api/src/api/routes/maintenance/maintenance.test.ts#L90))
...
- **FR18 — a finished run records what it did.** Reaching the exit writes the
  ...
  ([validated by writes the run's episode when the line reaches its exit](apps/floor/src/jobs/assembly-run/advance-line.test.ts#L958), [`finish-node.test.ts:667`](apps/floor/src/jobs/assembly-run/finish-node.test.ts#L667), [`finish-node.test.ts:691`](apps/floor/src/jobs/assembly-run/finish-node.test.ts#L691), [`run-episode.test.ts:8`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L8), [`run-episode.test.ts:23`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L23), [`run-episode.test.ts:37`](apps/floor/src/jobs/assembly-run/run-episode.test.ts#L37))
...
- **FR19 — a station that calls a model is given a credential, and says so when
  ...
  ([validated by declares the LLM secret for a station whose recipe says it needs one](apps/floor/src/jobs/agent/agent-catalog.test.ts#L466), [`comment-triage.test.ts:73`](apps/stations/src/stations/comment-triage/comment-triage.test.ts#L73), [`comment-triage.test.ts:90`](apps/stations/src/stations/comment-triage/comment-triage.test.ts#L90), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71))
...
- **FR21 — a published node is claimed by the service that runs it.** The
  ...
  ([validated by claims the published-node event, without which a service-form node never runs](apps/stations/src/drain/subscriptions.test.ts#L8), [`subscriptions.test.ts:14`](apps/stations/src/drain/subscriptions.test.ts#L14), [`subscriptions.test.ts:26`](apps/stations/src/drain/subscriptions.test.ts#L26), [`subscriptions.test.ts:32`](apps/stations/src/drain/subscriptions.test.ts#L32), [`subscriptions.test.ts:47`](apps/stations/src/drain/subscriptions.test.ts#L47), [`loop-boot.test.ts:19`](apps/stations/src/drain/loop-boot.test.ts#L19), [`loop-boot.test.ts:41`](apps/stations/src/drain/loop-boot.test.ts#L41), [`loop-boot.test.ts:56`](apps/stations/src/drain/loop-boot.test.ts#L56), [`run-node.test.ts:92`](apps/stations/src/runner/run-node.test.ts#L92), [`run-node.test.ts:100`](apps/stations/src/runner/run-node.test.ts#L100), [`run-node.test.ts:106`](apps/stations/src/runner/run-node.test.ts#L106), [`run-node.test.ts:112`](apps/stations/src/runner/run-node.test.ts#L112), [`loop-boot.test.ts:19`](apps/stations/src/drain/loop-boot.test.ts#L19), [`loop-boot.test.ts:56`](apps/stations/src/drain/loop-boot.test.ts#L56), [`loop-boot.test.ts:71`](apps/stations/src/drain/loop-boot.test.ts#L71), [`loop-boot.test.ts:90`](apps/stations/src/drain/loop-boot.test.ts#L90))
...
- **FR22 — a node published to the service is never also given a pod.** A service
  ...
  ([validated by waits rather than relaunching it as a pod, since no pod was ever meant to exist](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L869), [`assembly-run-reaper.test.ts:883`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L883), [`assembly-run-reaper.test.ts:897`](apps/floor/src/jobs/assembly-run/assembly-run-reaper.test.ts#L897), [`finish-node.test.ts:715`](apps/floor/src/jobs/assembly-run/finish-node.test.ts#L715), [`advance-line.test.ts:976`](apps/floor/src/jobs/assembly-run/advance-line.test.ts#L976))
...
- **FR23 — what a subscriber asks for, it can handle and does receive.** Every
  ...
  ([validated by maps a handler for each name it subscribes to, so nothing dead-letters on arrival](apps/stations/src/drain/subscriptions.test.ts#L53), [`subscriptions.test.ts:62`](apps/stations/src/drain/subscriptions.test.ts#L62), [`event-deliveries-roundtrip.test.ts:139`](apps/event-router/src/transport/routes/event-deliveries-roundtrip.test.ts#L139))
...
- **FR24 — a subscription set is declared whole, and a pruned bus keeps only
  ...
  ([validated by drops a name the subscriber no longer handles, so a removed handler stops being delivered](libs/shared/src/project/events/event-deliveries.contract.test.ts#L221), [`event-deliveries.contract.test.ts:235`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L235), [`event-deliveries.contract.test.ts:295`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L295), [`event-deliveries.contract.test.ts:309`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L309), [`event-deliveries.contract.test.ts:324`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L324))
...
- **FR26 — a subscriber repairs what it was not there to receive.** Fan-out reads
  ...
  ([validated by reconciles an event captured BEFORE the subscription existed, which ordering alone loses](libs/shared/src/project/events/event-deliveries.contract.test.ts#L247), [`event-deliveries.contract.test.ts:261`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L261), [`event-deliveries.contract.test.ts:272`](libs/shared/src/project/events/event-deliveries.contract.test.ts#L272), [`loop-boot.test.ts:105`](apps/stations/src/drain/loop-boot.test.ts#L105), [`loop-boot.test.ts:126`](apps/stations/src/drain/loop-boot.test.ts#L126))
...
- **FR27 — an overlapping tick is a skip, not a failure.** A sweep station
  ...
  ([validated by reports an overlapping tick as a skip, not a failure](libs/shared/src/project/stations/station-client.test.ts#L21), [`station-client.test.ts:15`](libs/shared/src/project/stations/station-client.test.ts#L15), [`station-client.test.ts:27`](libs/shared/src/project/stations/station-client.test.ts#L27), [`station-client.test.ts:33`](libs/shared/src/project/stations/station-client.test.ts#L33))
