...
- **FR22 — a node published to the service is never also given a pod.** A service
  ...
  ([validated by waits rather than relaunching it as a pod, since no pod was ever meant to exist](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L939), [`assembly-run-reaper.test.ts:953`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L953), [`assembly-run-reaper.test.ts:967`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L967), [`finish-node.test.ts:715`](apps/floor/src/work/assembly-run/finish-node.test.ts#L720), [`advance-line.test.ts:976`](apps/floor/src/work/assembly-run/advance-line.test.ts#L977))
