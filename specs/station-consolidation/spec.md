...
- **FR18 — a finished run records what it did.** Reaching the exit writes the
  ...
  ([validated by writes the run's episode when the line reaches its exit](apps/floor/src/work/assembly-run/advance-line.test.ts#L958), [`finish-node.test.ts:667`](apps/floor/src/work/assembly-run/finish-node.test.ts#L671), [`finish-node.test.ts:691`](apps/floor/src/work/assembly-run/finish-node.test.ts#L695), [`run-episode.test.ts:8`](apps/floor/src/work/assembly-run/run-episode.test.ts#L8), [`run-episode.test.ts:23`](apps/floor/src/work/assembly-run/run-episode.test.ts#L23), [`run-episode.test.ts:37`](apps/floor/src/work/assembly-run/run-episode.test.ts#L37))
...
- **FR22 — a node published to the service is never also given a pod.** A service
  ...
  ([validated by waits rather than relaunching it as a pod, since no pod was ever meant to exist](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L869), [`assembly-run-reaper.test.ts:883`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L883), [`assembly-run-reaper.test.ts:897`](apps/floor/src/work/assembly-run/assembly-run-reaper.test.ts#L897), [`finish-node.test.ts:715`](apps/floor/src/work/assembly-run/finish-node.test.ts#L719), [`advance-line.test.ts:976`](apps/floor/src/work/assembly-run/advance-line.test.ts#L976))
