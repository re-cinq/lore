...
- **FR15 — a subscriber that holds no pool consumes over HTTP.** Registration,
  ...
  field never sent.
  ([validated by registers a subscription and claims back the event it asked for](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L46), [`event-deliveries-roundtrip.test.ts:59`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L59), [`event-deliveries-roundtrip.test.ts:70`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L70), [`event-deliveries-roundtrip.test.ts:83`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L83), [`event-deliveries-roundtrip.test.ts:96`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L96), [`event-deliveries-roundtrip.test.ts:107`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L107), [`event-deliveries-roundtrip.test.ts:118`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L118), [`event-deliveries-roundtrip.test.ts:126`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L126), [`event-deliveries-http.test.ts:39`](libs/shared/src/project/events/event-deliveries-http.test.ts#L39), [`event-deliveries-http.test.ts:52`](libs/shared/src/project/events/event-deliveries-http.test.ts#L52), [`event-deliveries-http.test.ts:67`](libs/shared/src/project/events/event-deliveries-http.test.ts#L67), [`event-deliveries-http.test.ts:79`](libs/shared/src/project/events/event-deliveries-http.test.ts#L79), [`event-deliveries-http.test.ts:87`](libs/shared/src/project/events/event-deliveries-http.test.ts#L87))
...
- **FR23 — what a subscriber asks for, it can handle and does receive.** Every
  ...
  ([validated by maps a handler for each name it subscribes to, so nothing dead-letters on arrival](apps/stations/src/drain/subscriptions.test.ts#L53), [`subscriptions.test.ts:62`](apps/stations/src/drain/subscriptions.test.ts#L62), [`event-deliveries-roundtrip.test.ts:139`](apps/event-router/src/http/routes/event-deliveries-roundtrip.test.ts#L139))
