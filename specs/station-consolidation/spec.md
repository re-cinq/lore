...
- **FR18 — a finished run records what it did.** Reaching the exit writes the
  ...
  ([validated by writes the run's episode when the line reaches its exit](apps/floor/src/work/assembly-run/advance-line.test.ts#L1005), [`finish-node.test.ts:667`](apps/floor/src/work/assembly-run/finish-node.test.ts#L673), [`finish-node.test.ts:691`](apps/floor/src/work/assembly-run/finish-node.test.ts#L697), [`run-episode.test.ts:8`](apps/floor/src/work/assembly-run/run-episode.test.ts#L8), [`run-episode.test.ts:23`](apps/floor/src/work/assembly-run/run-episode.test.ts#L23), [`run-episode.test.ts:37`](apps/floor/src/work/assembly-run/run-episode.test.ts#L37))
