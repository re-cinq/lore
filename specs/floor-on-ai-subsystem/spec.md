...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:16`](apps/floor/src/jobs/agent/agent-events.test.ts#L16), [`agent-events.test.ts:110`](apps/floor/src/jobs/agent/agent-events.test.ts#L110), [`agent-events.test.ts:122`](apps/floor/src/jobs/agent/agent-events.test.ts#L122), [`agent-events.test.ts:133`](apps/floor/src/jobs/agent/agent-events.test.ts#L133), [`agent-events.test.ts:143`](apps/floor/src/jobs/agent/agent-events.test.ts#L143), [`agent-events.test.ts:150`](apps/floor/src/jobs/agent/agent-events.test.ts#L150), [`agent-events.test.ts:214`](apps/floor/src/jobs/agent/agent-events.test.ts#L214), [`agent-events.test.ts:64`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L85), [`agent-events.test.ts:72`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L81), [`agent-events.test.ts:214`](apps/floor/src/jobs/agent/agent-events.test.ts#L214), [`agent-events.test.ts:202`](apps/floor/src/jobs/agent/agent-events.test.ts#L202), [`agent-output.test.ts:183`](libs/assembly-lines/src/agent-output.test.ts#L184), [`agent-output.test.ts:189`](libs/assembly-lines/src/agent-output.test.ts#L190), [`agent-output.test.ts:198`](libs/assembly-lines/src/agent-output.test.ts#L199), [`agent-output.test.ts:213`](libs/assembly-lines/src/agent-output.test.ts#L214), [`agent-output.test.ts:222`](libs/assembly-lines/src/agent-output.test.ts#L223), [`agent-output.test.ts:231`](libs/assembly-lines/src/agent-output.test.ts#L232), [`agent-output.test.ts:242`](libs/assembly-lines/src/agent-output.test.ts#L243), [`agent-output.test.ts:253`](libs/assembly-lines/src/agent-output.test.ts#L254), [`agent-output.test.ts:259`](libs/assembly-lines/src/agent-output.test.ts#L260), [`agent-events.test.ts:162`](apps/floor/src/jobs/agent/agent-events.test.ts#L162), [`agent-events.test.ts:190`](apps/floor/src/jobs/agent/agent-events.test.ts#L190); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
23. *(added 2026-07-31)* A station that makes its own LLM calls (comment-triage today) MUST report
    ...
    classification reports no usage. ([validated by `agent-output.test.ts:354`](libs/assembly-lines/src/agent-output.test.ts#L355), [`agent-output.test.ts:369`](libs/assembly-lines/src/agent-output.test.ts#L370), [`agent-output.test.ts:380`](libs/assembly-lines/src/agent-output.test.ts#L381), [`agent-events.test.ts:232`](apps/floor/src/jobs/agent/agent-events.test.ts#L232), [`agent-events.test.ts:266`](apps/floor/src/jobs/agent/agent-events.test.ts#L266), [`comment-triage.test.ts:51`](apps/stations/src/stations/comment-triage/comment-triage.test.ts#L51), [`comment-triage.test.ts:49`](libs/shared/src/review/comment-triage.test.ts#L49), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180))
...
29. *(added 2026-08-10)* The Floor MUST project those artifact events off the
    ...
    exactly like an uncorrelated cost row ([validated by `agent-events.test.ts:276`](apps/floor/src/jobs/agent/agent-events.test.ts#L276), [`agent-events.test.ts:298`](apps/floor/src/jobs/agent/agent-events.test.ts#L298), [`agent-events.test.ts:311`](apps/floor/src/jobs/agent/agent-events.test.ts#L311), [`agent-events.test.ts:320`](apps/floor/src/jobs/agent/agent-events.test.ts#L320), [`agent-events.test.ts:334`](apps/floor/src/jobs/agent/agent-events.test.ts#L334), [`agent-events.test.ts:347`](apps/floor/src/jobs/agent/agent-events.test.ts#L347); implemented by [`agent-events.ts:96`](apps/floor/src/jobs/agent/agent-events.ts#L96))
...
34. *(added 2026-08-30)* A recipe MAY declare its own `skills`, and they are APPENDED
    ...
    one level down and just as silent. ([validated by `agent-catalog.test.ts:108`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L108), [`agent-catalog.test.ts:117`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L117), [`agent-crd.test.ts:281`](apps/lore-api/src/features/agents/agent-crd.test.ts#L281), [`skills-registry.test.ts:101`](apps/mcp-server/src/server/skills-registry.test.ts#L101); implemented by [`agent-catalog.ts:141`](apps/floor/src/jobs/agent/agent-catalog.ts#L141))
...
- **Recipe → CRD materialisation.** `agentDefToCrds` maps an `AgentDefinition` recipe to a paired
  ...
  `{station_input}` prompt, `max_turns:1`, `lore-station <type>` command) on its own image. ([validated by `agent-crd.test.ts:17`](apps/lore-api/src/features/agents/agent-crd.test.ts#L18), [`agent-crd.test.ts:87`](apps/lore-api/src/features/agents/agent-crd.test.ts#L87), [`agent-crd.test.ts:159`](apps/lore-api/src/features/agents/agent-crd.test.ts#L159), [`agent-crd.test.ts:167`](apps/lore-api/src/features/agents/agent-crd.test.ts#L167))
