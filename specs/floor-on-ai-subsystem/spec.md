...
5. `AgentBackend.launch` produces a correct `Agent` CR from a task (stationRef from task type,
   ...
   non-terminal, conservatively true when the probe fails). ([validated by `agent-watcher-logic.test.ts:14`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L18), [`agent-watcher-logic.test.ts:31`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L31), [`agent-backend.test.ts:47`](libs/shared/src/cluster/agent-backend.test.ts#L47), [`agent-backend.test.ts:70`](libs/shared/src/cluster/agent-backend.test.ts#L70), [`agent-backend.test.ts:87`](libs/shared/src/cluster/agent-backend.test.ts#L87), [`agent-backend.test.ts:97`](libs/shared/src/cluster/agent-backend.test.ts#L97), [`agent-backend.test.ts:118`](libs/shared/src/cluster/agent-backend.test.ts#L118), [`agent-backend.test.ts:127`](libs/shared/src/cluster/agent-backend.test.ts#L127), [`agent-backend.test.ts:136`](libs/shared/src/cluster/agent-backend.test.ts#L136), [`agent-backend.test.ts:166`](libs/shared/src/cluster/agent-backend.test.ts#L166), [`agent-backend.test.ts:172`](libs/shared/src/cluster/agent-backend.test.ts#L172), [`agent-backend.test.ts:178`](libs/shared/src/cluster/agent-backend.test.ts#L178), [`agent-backend.test.ts:184`](libs/shared/src/cluster/agent-backend.test.ts#L184))
...
7. The deterministic gate reads the **conclusion of the GitHub Actions referenced by the assembly line**:
   a red conclusion routes to the address loop, a green conclusion proceeds. ([validated by `agent-watcher-logic.test.ts:51`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L55), [`agent-watcher-logic.test.ts:59`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L59))
...
9. Secrets in `ai-agents` are mirrored from the existing remoteRefs; the per-task GitHub token is
   ...
   Station's `agentDefRef` at it (template preserved, empty-template fallback). ([validated by `agent-watcher-logic.test.ts:66`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L66), [`agent-watcher-logic.test.ts:74`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L74), [`per-task-token.test.ts:57`](libs/shared/src/cluster/per-task-token.test.ts#L57), [`per-task-token.test.ts:76`](libs/shared/src/cluster/per-task-token.test.ts#L76), [`per-task-token.test.ts:79`](libs/shared/src/cluster/per-task-token.test.ts#L79), [`per-task-token.test.ts:92`](libs/shared/src/cluster/per-task-token.test.ts#L92), [`per-task-token.test.ts:107`](libs/shared/src/cluster/per-task-token.test.ts#L107), [`per-task-token.test.ts:141`](libs/shared/src/cluster/per-task-token.test.ts#L141), [`per-task-token.test.ts:147`](libs/shared/src/cluster/per-task-token.test.ts#L147), [`per-task-token.test.ts:159`](libs/shared/src/cluster/per-task-token.test.ts#L159), [`per-task-token.test.ts:173`](libs/shared/src/cluster/per-task-token.test.ts#L173), [`per-task-token.test.ts:191`](libs/shared/src/cluster/per-task-token.test.ts#L191))
...
- **Run-outcome mapping.** `runOutcomeFromTaskStatus` records the watcher's run outcome: `pr-created`
  ...
  `completed`. ([validated by `agent-watcher-logic.test.ts:90`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L90), [`agent-watcher-logic.test.ts:94`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L94), [`agent-watcher-logic.test.ts:98`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L98), [`agent-watcher-logic.test.ts:79`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L79), [`agent-watcher-logic.test.ts:101`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L101), [`agent-watcher-logic.test.ts:105`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L105))
- **Issue-body log links.** `taskPageUrl` builds the web-ui task-page link (`{LORE_UI_URL}/tasks/{taskId}`,
  ...
  degrades to plain "See logs" rather than fabricating a dead link. ([validated by `agent-watcher-logic.test.ts:141`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L141), [`agent-watcher-logic.test.ts:147`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L147), [`agent-watcher-logic.test.ts:153`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L153), [`agent-watcher-logic.test.ts:157`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L157))
