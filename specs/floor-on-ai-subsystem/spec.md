...
5. `AgentBackend.launch` produces a correct `Agent` CR from a task (stationRef from task type,
   ...
   non-terminal, conservatively true when the probe fails). ([validated by `agent-watcher-logic.test.ts:14`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L18), [`agent-watcher-logic.test.ts:31`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L31), [`agent-backend.test.ts:47`](libs/shared/src/cluster/agent-backend.test.ts#L47), [`agent-backend.test.ts:70`](libs/shared/src/cluster/agent-backend.test.ts#L70), [`agent-backend.test.ts:87`](libs/shared/src/cluster/agent-backend.test.ts#L87), [`agent-backend.test.ts:97`](libs/shared/src/cluster/agent-backend.test.ts#L97), [`agent-backend.test.ts:118`](libs/shared/src/cluster/agent-backend.test.ts#L118), [`agent-backend.test.ts:127`](libs/shared/src/cluster/agent-backend.test.ts#L127), [`agent-backend.test.ts:136`](libs/shared/src/cluster/agent-backend.test.ts#L136), [`agent-backend.test.ts:166`](libs/shared/src/cluster/agent-backend.test.ts#L166), [`agent-backend.test.ts:172`](libs/shared/src/cluster/agent-backend.test.ts#L172), [`agent-backend.test.ts:178`](libs/shared/src/cluster/agent-backend.test.ts#L178), [`agent-backend.test.ts:184`](libs/shared/src/cluster/agent-backend.test.ts#L184))
...
7. The deterministic gate reads the **conclusion of the GitHub Actions referenced by the assembly line**:
   a red conclusion routes to the address loop, a green conclusion proceeds. ([validated by `agent-watcher-logic.test.ts:51`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L55), [`agent-watcher-logic.test.ts:59`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L59))
...
9. Secrets in `ai-agents` are mirrored from the existing remoteRefs; the per-task GitHub token is
   ...
   Station's `agentDefRef` at it (template preserved, empty-template fallback). ([validated by `agent-watcher-logic.test.ts:66`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L66), [`agent-watcher-logic.test.ts:74`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L74), [`per-task-token.test.ts:57`](libs/shared/src/cluster/per-task-token.test.ts#L57), [`per-task-token.test.ts:76`](libs/shared/src/cluster/per-task-token.test.ts#L76), [`per-task-token.test.ts:79`](libs/shared/src/cluster/per-task-token.test.ts#L79), [`per-task-token.test.ts:92`](libs/shared/src/cluster/per-task-token.test.ts#L92), [`per-task-token.test.ts:107`](libs/shared/src/cluster/per-task-token.test.ts#L107), [`per-task-token.test.ts:141`](libs/shared/src/cluster/per-task-token.test.ts#L141), [`per-task-token.test.ts:147`](libs/shared/src/cluster/per-task-token.test.ts#L147), [`per-task-token.test.ts:159`](libs/shared/src/cluster/per-task-token.test.ts#L159), [`per-task-token.test.ts:173`](libs/shared/src/cluster/per-task-token.test.ts#L173), [`per-task-token.test.ts:191`](libs/shared/src/cluster/per-task-token.test.ts#L191))
...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:16`](apps/floor/src/work/agent/agent-events.test.ts#L16), [`agent-events.test.ts:107`](apps/floor/src/work/agent/agent-events.test.ts#L107), [`agent-events.test.ts:119`](apps/floor/src/work/agent/agent-events.test.ts#L119), [`agent-events.test.ts:130`](apps/floor/src/work/agent/agent-events.test.ts#L130), [`agent-events.test.ts:140`](apps/floor/src/work/agent/agent-events.test.ts#L140), [`agent-events.test.ts:147`](apps/floor/src/work/agent/agent-events.test.ts#L147), [`agent-events.test.ts:211`](apps/floor/src/work/agent/agent-events.test.ts#L211), [`agent-events.test.ts:80`](apps/floor/src/transport/http/routes/agent-events.test.ts#L80), [`agent-events.test.ts:80`](apps/floor/src/transport/http/routes/agent-events.test.ts#L80), [`agent-events.test.ts:211`](apps/floor/src/work/agent/agent-events.test.ts#L211), [`agent-events.test.ts:199`](apps/floor/src/work/agent/agent-events.test.ts#L199), [`agent-output.test.ts:182`](libs/assembly-lines/src/agent-output.test.ts#L182), [`agent-output.test.ts:188`](libs/assembly-lines/src/agent-output.test.ts#L188), [`agent-output.test.ts:197`](libs/assembly-lines/src/agent-output.test.ts#L197), [`agent-output.test.ts:212`](libs/assembly-lines/src/agent-output.test.ts#L212), [`agent-output.test.ts:221`](libs/assembly-lines/src/agent-output.test.ts#L221), [`agent-output.test.ts:230`](libs/assembly-lines/src/agent-output.test.ts#L230), [`agent-output.test.ts:241`](libs/assembly-lines/src/agent-output.test.ts#L241), [`agent-output.test.ts:252`](libs/assembly-lines/src/agent-output.test.ts#L252), [`agent-output.test.ts:258`](libs/assembly-lines/src/agent-output.test.ts#L258), [`agent-events.test.ts:159`](apps/floor/src/work/agent/agent-events.test.ts#L159), [`agent-events.test.ts:187`](apps/floor/src/work/agent/agent-events.test.ts#L187); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
23. *(added 2026-07-31)* A station that makes its own LLM calls (comment-triage today) MUST report
    ...
    classification reports no usage. ([validated by `agent-output.test.ts:353`](libs/assembly-lines/src/agent-output.test.ts#L353), [`agent-output.test.ts:368`](libs/assembly-lines/src/agent-output.test.ts#L368), [`agent-output.test.ts:379`](libs/assembly-lines/src/agent-output.test.ts#L379), [`agent-events.test.ts:229`](apps/floor/src/work/agent/agent-events.test.ts#L229), [`agent-events.test.ts:263`](apps/floor/src/work/agent/agent-events.test.ts#L263), [`comment-triage.test.ts:51`](apps/stations/src/work/comment-triage/comment-triage.test.ts#L51), [`comment-triage.test.ts:49`](libs/shared/src/review/comment-triage.test.ts#L49), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180))
...
30. *(added 2026-08-10)* Settling a round from an artifact event is skip-not-fail: an
    ...
    500 an ingest carrying cost and run-viz rows for unrelated runs ([validated by `planning-result.test.ts:64`](apps/floor/src/work/agent/planning-result.test.ts#L63), [`planning-result.test.ts:74`](apps/floor/src/work/agent/planning-result.test.ts#L74), [`planning-result.test.ts:74`](apps/floor/src/work/agent/planning-result.test.ts#L74), [`planning-result.test.ts:103`](apps/floor/src/work/agent/planning-result.test.ts#L103), [`planning-result.test.ts:114`](apps/floor/src/work/agent/planning-result.test.ts#L114), [`planning-result.test.ts:135`](apps/floor/src/work/agent/planning-result.test.ts#L135), [`planning-result.test.ts:149`](apps/floor/src/work/agent/planning-result.test.ts#L149), [`planning-result.test.ts:159`](apps/floor/src/work/agent/planning-result.test.ts#L159); implemented by [`planning-result.ts:44`](apps/floor/src/work/agent/planning-result.ts#L44))
...
- **Run-outcome mapping.** `runOutcomeFromTaskStatus` records the watcher's run outcome: `pr-created`
  ...
  `completed`. ([validated by `agent-watcher-logic.test.ts:90`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L90), [`agent-watcher-logic.test.ts:94`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L94), [`agent-watcher-logic.test.ts:98`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L98), [`agent-watcher-logic.test.ts:79`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L79), [`agent-watcher-logic.test.ts:101`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L101), [`agent-watcher-logic.test.ts:105`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L105))
- **Issue-body log links.** `taskPageUrl` builds the web-ui task-page link (`{LORE_UI_URL}/tasks/{taskId}`,
  ...
  degrades to plain "See logs" rather than fabricating a dead link. ([validated by `agent-watcher-logic.test.ts:141`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L141), [`agent-watcher-logic.test.ts:147`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L147), [`agent-watcher-logic.test.ts:153`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L153), [`agent-watcher-logic.test.ts:157`](apps/floor/src/work/lib/agent-watcher-logic.test.ts#L157))
...
- **CR-watch idempotency.** Event dedupe keys collapse redundant deliveries so a Floor restart replays
  ...
  than defaulting. ([validated by `dedupe.test.ts:5`](libs/shared/src/project/events/dedupe.test.ts#L5), [`dedupe.test.ts:11`](libs/shared/src/project/events/dedupe.test.ts#L11), [`dedupe.test.ts:17`](libs/shared/src/project/events/dedupe.test.ts#L17), [`dedupe.test.ts:23`](libs/shared/src/project/events/dedupe.test.ts#L23), [`kubernetes.test.ts:21`](apps/floor/src/events/handlers/kubernetes.test.ts#L21), [`kubernetes.test.ts:33`](apps/floor/src/events/handlers/kubernetes.test.ts#L33))
