...
16. Node YAML accepts optional `station_ref` (custom station, default `def-<type>`) and
    `timeout_minutes`. ([validated by accepts station_ref and timeout_minutes on a node](libs/assembly-lines/src/loader.test.ts#L460))
...
29. *(added 2026-08-10)* The Floor MUST project those artifact events off the
    ...
    exactly like an uncorrelated cost row ([validated by `agent-events.test.ts:203`](apps/floor/src/jobs/agent/agent-events.test.ts#L203), [`agent-events.test.ts:225`](apps/floor/src/jobs/agent/agent-events.test.ts#L225), [`agent-events.test.ts:238`](apps/floor/src/jobs/agent/agent-events.test.ts#L238), [`agent-events.test.ts:247`](apps/floor/src/jobs/agent/agent-events.test.ts#L247), [`agent-events.test.ts:261`](apps/floor/src/jobs/agent/agent-events.test.ts#L261), [`agent-events.test.ts:274`](apps/floor/src/jobs/agent/agent-events.test.ts#L274); implemented by [`agent-events.ts:96`](apps/floor/src/jobs/agent/agent-events.ts#L96))
