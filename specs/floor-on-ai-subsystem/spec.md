...
18. A station pod ends with the claude-style result line carrying `LORE_NODE_RESULT: {outcome,
    ...
    ([validated by parseNodeResult tests](libs/assembly-lines/src/node-outcome.test.ts#L19), [`agent-output.test.ts:139`](libs/assembly-lines/src/agent-output.test.ts#L105), [`agent-output.test.ts:150`](libs/assembly-lines/src/agent-output.test.ts#L116), [`agent-output.test.ts:162`](libs/assembly-lines/src/agent-output.test.ts#L128), [`agent-output.test.ts:170`](libs/assembly-lines/src/agent-output.test.ts#L136), [`agent-output.test.ts:180`](libs/assembly-lines/src/agent-output.test.ts#L146), [`agent-output.test.ts:188`](libs/assembly-lines/src/agent-output.test.ts#L154), [`agent-output.test.ts:198`](libs/assembly-lines/src/agent-output.test.ts#L164); implemented by [`agent-output.ts:104`](libs/assembly-lines/src/agent-output.ts#L96))
