...
11. *(restated late 2026-07)* A node CR's terminal status maps to a node outcome
    ...
    stage-trailer-resume mechanics are retired (6-dark-factory FR6.9) ([validated by `node-outcome.test.ts:35`](libs/assembly-lines/src/node-outcome.test.ts#L34), [`advance.test.ts:437`](apps/floor/src/jobs/assembly-run/advance.test.ts#L438))
