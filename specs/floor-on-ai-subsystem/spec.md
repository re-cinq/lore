...
- A UI save REPLACES nothing it does not render *(added 2026-08-18, #1301; extended to `spec.resources` 2026-08-28)*: the /agents apply path carries every field the live CR holds that the editor's mapping does not know — `output.watch`, helm's labels and annotations, and the members of `spec.resources` the render omits (`skills`, `skills_source`, `secrets`) — through the replace, with the editor winning only the fields it renders. A plain replace amputated `output.watch` from the feature-planning recipe on 2026-08-13 and silently killed planning-artifact delivery for five days; the same replace stripped `skills_source` from `implementation-tdd` and `spec-write` in 2026-08, and every Claude-agent node cloned from them died at startup with "Settings file not found" — skills config is per-cluster (owned by each cluster's catalog seed), which is exactly why the editor cannot re-render it and must preserve it. ([validated by carries output.watch through a save whose render does not know it](apps/lore-api/src/features/agents/agent-crd.test.ts#L196), [`agent-crd.test.ts:204`](apps/lore-api/src/features/agents/agent-crd.test.ts#L204), [`agent-crd.test.ts:217`](apps/lore-api/src/features/agents/agent-crd.test.ts#L217), [`agent-crd.test.ts:225`](apps/lore-api/src/features/agents/agent-crd.test.ts#L225), [carries resources.skills_source and secrets through a save that renders only mcp_servers](apps/lore-api/src/features/agents/agent-crd.test.ts#L253), [`agent-crd.test.ts:266`](apps/lore-api/src/features/agents/agent-crd.test.ts#L266), [`agent-crd.test.ts:277`](apps/lore-api/src/features/agents/agent-crd.test.ts#L277), [`agent-crd.test.ts:286`](apps/lore-api/src/features/agents/agent-crd.test.ts#L286); implemented by [`agent-crd.ts:37`](apps/lore-api/src/features/agents/agent-crd.ts#L37))
...
9. Secrets in `ai-agents` are mirrored from the existing remoteRefs; the per-task GitHub token is
   ...
   Station's `agentDefRef` at it (template preserved, empty-template fallback). ([validated by `agent-watcher-logic.test.ts:65`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L69), [`agent-watcher-logic.test.ts:73`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L77), [`per-task-token.test.ts:57`](libs/shared/src/cluster/per-task-token.test.ts#L57), [`per-task-token.test.ts:76`](libs/shared/src/cluster/per-task-token.test.ts#L76), [`per-task-token.test.ts:79`](libs/shared/src/cluster/per-task-token.test.ts#L79), [`per-task-token.test.ts:92`](libs/shared/src/cluster/per-task-token.test.ts#L92), [`per-task-token.test.ts:107`](libs/shared/src/cluster/per-task-token.test.ts#L107), [`per-task-token.test.ts:117`](libs/shared/src/cluster/per-task-token.test.ts#L143), [`per-task-token.test.ts:123`](libs/shared/src/cluster/per-task-token.test.ts#L149), [`per-task-token.test.ts:135`](libs/shared/src/cluster/per-task-token.test.ts#L161), [`per-task-token.test.ts:152`](libs/shared/src/cluster/per-task-token.test.ts#L178), [`per-task-token.test.ts:170`](libs/shared/src/cluster/per-task-token.test.ts#L196))
...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:15`](apps/floor/src/jobs/agent/agent-events.test.ts#L15), [`agent-events.test.ts:39`](apps/floor/src/jobs/agent/agent-events.test.ts#L40), [`agent-events.test.ts:51`](apps/floor/src/jobs/agent/agent-events.test.ts#L52), [`agent-events.test.ts:62`](apps/floor/src/jobs/agent/agent-events.test.ts#L63), [`agent-events.test.ts:72`](apps/floor/src/jobs/agent/agent-events.test.ts#L73), [`agent-events.test.ts:81`](apps/floor/src/jobs/agent/agent-events.test.ts#L80), [`agent-events.test.ts:142`](apps/floor/src/jobs/agent/agent-events.test.ts#L144), [`agent-events.test.ts:64`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L85), [`agent-events.test.ts:72`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L81), [`agent-events.test.ts:142`](apps/floor/src/jobs/agent/agent-events.test.ts#L144), [`agent-events.test.ts:131`](apps/floor/src/jobs/agent/agent-events.test.ts#L132), [`agent-output.test.ts:183`](libs/assembly-lines/src/agent-output.test.ts#L184), [`agent-output.test.ts:189`](libs/assembly-lines/src/agent-output.test.ts#L190), [`agent-output.test.ts:198`](libs/assembly-lines/src/agent-output.test.ts#L199), [`agent-output.test.ts:213`](libs/assembly-lines/src/agent-output.test.ts#L214), [`agent-output.test.ts:222`](libs/assembly-lines/src/agent-output.test.ts#L223), [`agent-output.test.ts:231`](libs/assembly-lines/src/agent-output.test.ts#L232), [`agent-output.test.ts:242`](libs/assembly-lines/src/agent-output.test.ts#L243), [`agent-output.test.ts:253`](libs/assembly-lines/src/agent-output.test.ts#L254), [`agent-output.test.ts:259`](libs/assembly-lines/src/agent-output.test.ts#L260), [`agent-events.test.ts:91`](apps/floor/src/jobs/agent/agent-events.test.ts#L92), [`agent-events.test.ts:118`](apps/floor/src/jobs/agent/agent-events.test.ts#L120); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
11. *(restated late 2026-07)* A node CR's terminal status maps to a node outcome
    ...
    stage-trailer-resume mechanics are retired (6-dark-factory FR6.9) ([validated by `node-outcome.test.ts:35`](libs/assembly-lines/src/node-outcome.test.ts#L34), [`advance.test.ts:437`](apps/floor/src/jobs/assembly-run/advance.test.ts#L437))
...
18. A station pod ends with the claude-style result line carrying `LORE_NODE_RESULT: {outcome,
    ...
    ([validated by parseNodeResult tests](libs/assembly-lines/src/node-outcome.test.ts#L20), [`agent-output.test.ts:270`](libs/assembly-lines/src/agent-output.test.ts#L271), [`agent-output.test.ts:281`](libs/assembly-lines/src/agent-output.test.ts#L282), [`agent-output.test.ts:293`](libs/assembly-lines/src/agent-output.test.ts#L294), [`agent-output.test.ts:301`](libs/assembly-lines/src/agent-output.test.ts#L302), [`agent-output.test.ts:311`](libs/assembly-lines/src/agent-output.test.ts#L312), [`agent-output.test.ts:319`](libs/assembly-lines/src/agent-output.test.ts#L320), [`agent-output.test.ts:329`](libs/assembly-lines/src/agent-output.test.ts#L330); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180))
...
20. `scripts/task-types.yaml` `stations:` seeds `def-<type>` AgentDefinition/Station pairs (exec
    ...
    environment. ([validated by station catalog tests](apps/floor/src/jobs/agent/agent-catalog.test.ts#L274), [`agent-catalog.test.ts:21`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L21), [`agent-catalog.test.ts:63`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L63), [`agent-catalog.test.ts:99`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L99), [`agent-catalog.test.ts:131`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L131), [`agent-catalog.test.ts:139`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L139), [`agent-catalog.test.ts:167`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L167), [`agent-catalog.test.ts:175`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L175), [`agent-catalog.test.ts:193`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L193), [`agent-catalog.test.ts:216`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L216), [`agent-catalog.test.ts:212`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L212), [`agent-catalog.test.ts:231`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L231), [`agent-catalog.test.ts:240`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L240), [`agent-catalog.test.ts:257`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L257), [`agent-catalog.test.ts:261`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L261), [`agent-catalog.test.ts:274`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L274), [`agent-catalog.test.ts:307`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L307), [`agent-catalog.test.ts:374`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L374), [`agent-catalog.test.ts:389`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L389))
...
23. *(added 2026-07-31)* A station that makes its own LLM calls (comment-triage today) MUST report
    ...
    classification reports no usage. ([validated by `agent-output.test.ts:354`](libs/assembly-lines/src/agent-output.test.ts#L355), [`agent-output.test.ts:369`](libs/assembly-lines/src/agent-output.test.ts#L370), [`agent-output.test.ts:380`](libs/assembly-lines/src/agent-output.test.ts#L381), [`agent-events.test.ts:160`](apps/floor/src/jobs/agent/agent-events.test.ts#L162), [`agent-events.test.ts:193`](apps/floor/src/jobs/agent/agent-events.test.ts#L196), [`comment-triage.test.ts:51`](apps/stations/src/stations/comment-triage/comment-triage.test.ts#L51), [`comment-triage.test.ts:49`](libs/shared/src/review/comment-triage.test.ts#L49), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180))
...
26. *(added 2026-08-10)* A seeded recipe MUST NOT declare `skills` without a
    ...
    leaving it empty ([validated by `agent-catalog.test.ts:245`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L245); implemented by [`agent-catalog.ts:363`](apps/floor/src/jobs/agent/agent-catalog.ts#L363))
...
27. *(added 2026-08-10)* The agent container MUST run in the cloned repo
    ...
    ([validated by `agent-catalog.test.ts:157`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L157); implemented by [`agent-catalog.ts:211`](apps/floor/src/jobs/agent/agent-catalog.ts#L211))
...
28. *(added 2026-08-10)* A run whose deliverable is a **file** MUST declare it, so the
    ...
    ([validated by `agent-catalog.test.ts:113`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L113), [`agent-catalog.test.ts:124`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L124); implemented by [`agent-catalog.ts:173`](apps/floor/src/jobs/agent/agent-catalog.ts#L173))
...
31. *(added 2026-08-13)* The review family's recipes (`review`, `code-review`,
    ...
    ([validated by `agent-catalog.test.ts:412`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L412), [`agent-catalog.test.ts:422`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L422), [`agent-catalog.test.ts:428`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L428); implemented by [`agent-catalog.ts:166`](apps/floor/src/jobs/agent/agent-catalog.ts#L166), [`agent-catalog.ts:209`](apps/floor/src/jobs/agent/agent-catalog.ts#L209))
...
33. *(added 2026-08-28, #1629)* The `{context}` placeholder is guarded on
    ...
    ([validated by `agent-catalog.test.ts:201`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L201); implemented by [`agent-catalog.ts:424`](apps/floor/src/jobs/agent/agent-catalog.ts#L424))
...
- **Run-outcome mapping.** `runOutcomeFromTaskStatus` records the watcher's run outcome: `pr-created`
  ...
  `completed`. ([validated by `agent-watcher-logic.test.ts:89`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L93), [`agent-watcher-logic.test.ts:93`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L97), [`agent-watcher-logic.test.ts:97`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L101), [`agent-watcher-logic.test.ts:78`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L82), [`agent-watcher-logic.test.ts:100`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L104), [`agent-watcher-logic.test.ts:106`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L110))
- **Issue-body log links.** `taskPageUrl` builds the web-ui task-page link (`{LORE_UI_URL}/tasks/{taskId}`,
  ...
  degrades to plain "See logs" rather than fabricating a dead link. ([validated by `agent-watcher-logic.test.ts:150`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L154), [`agent-watcher-logic.test.ts:156`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L160), [`agent-watcher-logic.test.ts:162`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L166), [`agent-watcher-logic.test.ts:166`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L170))
...
- **CR-watch idempotency.** Event dedupe keys collapse redundant deliveries so a Floor restart replays
  ...
  than defaulting. ([validated by `dedupe.test.ts:5`](libs/shared/src/project/events/dedupe.test.ts#L5), [`dedupe.test.ts:11`](libs/shared/src/project/events/dedupe.test.ts#L11), [`dedupe.test.ts:17`](libs/shared/src/project/events/dedupe.test.ts#L17), [`dedupe.test.ts:23`](libs/shared/src/project/events/dedupe.test.ts#L23), [`kubernetes.test.ts:30`](apps/floor/src/jobs/kubernetes.test.ts#L30), [`kubernetes.test.ts:42`](apps/floor/src/jobs/kubernetes.test.ts#L42))
