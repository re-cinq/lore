...
5. `AgentBackend.launch` produces a correct `Agent` CR from a task (stationRef from task type,
   ...
   non-terminal, conservatively true when the probe fails). ([validated by `agent-watcher-logic.test.ts:13`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L13), [`agent-watcher-logic.test.ts:26`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L26), [`agent-backend.test.ts:52`](apps/floor/src/jobs/station/agent-backend.test.ts#L52), [`agent-backend.test.ts:57`](apps/floor/src/jobs/station/agent-backend.test.ts#L57), [`agent-backend.test.ts:62`](apps/floor/src/jobs/station/agent-backend.test.ts#L62), [`agent-backend.test.ts:68`](apps/floor/src/jobs/station/agent-backend.test.ts#L86), [`agent-backend.test.ts:74`](apps/floor/src/jobs/station/agent-backend.test.ts#L92), [`agent-backend.test.ts:83`](apps/floor/src/jobs/station/agent-backend.test.ts#L101), [`agent-backend.test.ts:102`](apps/floor/src/jobs/station/agent-backend.test.ts#L120), [`agent-backend.test.ts:119`](apps/floor/src/jobs/station/agent-backend.test.ts#L137), [`agent-backend.test.ts:129`](apps/floor/src/jobs/station/agent-backend.test.ts#L147), [`agent-backend.test.ts:151`](apps/floor/src/jobs/station/agent-backend.test.ts#L169), [`agent-backend.test.ts:160`](apps/floor/src/jobs/station/agent-backend.test.ts#L178), [`agent-backend.test.ts:171`](apps/floor/src/jobs/station/agent-backend.test.ts#L189), [`agent-backend.test.ts:188`](apps/floor/src/jobs/station/agent-backend.test.ts#L206), [`agent-backend.test.ts:194`](apps/floor/src/jobs/station/agent-backend.test.ts#L212), [`agent-backend.test.ts:200`](apps/floor/src/jobs/station/agent-backend.test.ts#L218), [`agent-backend.test.ts:206`](apps/floor/src/jobs/station/agent-backend.test.ts#L224))
...
17. `nodeStationSpec` builds the CR spec: stationRef, `parameters.station_input` JSON
    (assembly_line_id/node_id/node_type/repo/branch/task_id/params). ([validated by station-flagged node types dispatch a station CR](apps/floor/src/jobs/assembly-line/floor-assembly-line.test.ts#L93), [honors an explicit station_ref override](apps/floor/src/jobs/assembly-line/floor-assembly-line.test.ts#L134))
...
19. Cutover complete: every non-agent node on the Floor-assembly-line path dispatches a station
    ...
    supervisor path (gap-fill/runbook) is untouched. ([validated by every non-agent node dispatches a station CR](apps/floor/src/jobs/assembly-line/floor-assembly-line.test.ts#L93))
...
20. `scripts/task-types.yaml` `stations:` seeds `def-<type>` AgentDefinition/Station pairs (exec
    ...
    image from helm values (no sentinel leaks). ([validated by station catalog tests](apps/floor/src/jobs/agent/agent-catalog.test.ts#L147), [`agent-catalog.test.ts:20`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L20), [`agent-catalog.test.ts:51`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L51), [`agent-catalog.test.ts:59`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L59), [`agent-catalog.test.ts:68`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L68), [`agent-catalog.test.ts:76`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L76), [`agent-catalog.test.ts:94`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L94), [`agent-catalog.test.ts:102`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L102), [`agent-catalog.test.ts:120`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L120), [`agent-catalog.test.ts:126`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L126), [`agent-catalog.test.ts:130`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L130), [`agent-catalog.test.ts:134`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L134), [`agent-catalog.test.ts:147`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L147), [`agent-catalog.test.ts:176`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L176), [`agent-catalog.test.ts:228`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L228), [`agent-catalog.test.ts:243`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L243))
