...
11. *(restated late 2026-07)* A node CR's terminal status maps to a node outcome
    ...
    stage-trailer-resume mechanics are retired (6-dark-factory FR6.9) ([validated by `node-outcome.test.ts:35`](libs/assembly-lines/src/node-outcome.test.ts#L35), [`advance-line.test.ts:379`](apps/floor/src/work/assembly-run/advance-line.test.ts#L426))
