...
5. `AgentBackend.launch` produces a correct `Agent` CR from a task (stationRef from task type,
   ...
   non-terminal, conservatively true when the probe fails). ([validated by `agent-watcher-logic.test.ts:13`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L13), [`agent-watcher-logic.test.ts:26`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L26), [`agent-backend.test.ts:52`](apps/floor/src/jobs/station/agent-backend.test.ts#L52), [`agent-backend.test.ts:57`](apps/floor/src/jobs/station/agent-backend.test.ts#L57), [`agent-backend.test.ts:62`](apps/floor/src/jobs/station/agent-backend.test.ts#L62), [`agent-backend.test.ts:86`](apps/floor/src/jobs/station/agent-backend.test.ts#L86), [`agent-backend.test.ts:92`](apps/floor/src/jobs/station/agent-backend.test.ts#L92), [`agent-backend.test.ts:101`](apps/floor/src/jobs/station/agent-backend.test.ts#L101), [`agent-backend.test.ts:120`](apps/floor/src/jobs/station/agent-backend.test.ts#L120), [`agent-backend.test.ts:137`](apps/floor/src/jobs/station/agent-backend.test.ts#L137), [`agent-backend.test.ts:147`](apps/floor/src/jobs/station/agent-backend.test.ts#L147), [`agent-backend.test.ts:169`](apps/floor/src/jobs/station/agent-backend.test.ts#L169), [`agent-backend.test.ts:178`](apps/floor/src/jobs/station/agent-backend.test.ts#L178), [`agent-backend.test.ts:189`](apps/floor/src/jobs/station/agent-backend.test.ts#L189), [`agent-backend.test.ts:219`](apps/floor/src/jobs/station/agent-backend.test.ts#L219), [`agent-backend.test.ts:225`](apps/floor/src/jobs/station/agent-backend.test.ts#L225), [`agent-backend.test.ts:231`](apps/floor/src/jobs/station/agent-backend.test.ts#L231), [`agent-backend.test.ts:237`](apps/floor/src/jobs/station/agent-backend.test.ts#L237))
...
9. Secrets in `ai-agents` are mirrored from the existing remoteRefs; the per-task GitHub token is
   ...
   Station's `agentDefRef` at it (template preserved, empty-template fallback). ([validated by `agent-watcher-logic.test.ts:64`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L64), [`agent-watcher-logic.test.ts:72`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L72), [`per-task-token.test.ts:57`](apps/floor/src/jobs/station/per-task-token.test.ts#L57), [`per-task-token.test.ts:76`](apps/floor/src/jobs/station/per-task-token.test.ts#L76), [`per-task-token.test.ts:79`](apps/floor/src/jobs/station/per-task-token.test.ts#L79), [`per-task-token.test.ts:92`](apps/floor/src/jobs/station/per-task-token.test.ts#L92), [`per-task-token.test.ts:107`](apps/floor/src/jobs/station/per-task-token.test.ts#L107), [`per-task-token.test.ts:117`](apps/floor/src/jobs/station/per-task-token.test.ts#L138), [`per-task-token.test.ts:123`](apps/floor/src/jobs/station/per-task-token.test.ts#L144), [`per-task-token.test.ts:135`](apps/floor/src/jobs/station/per-task-token.test.ts#L156), [`per-task-token.test.ts:152`](apps/floor/src/jobs/station/per-task-token.test.ts#L173), [`per-task-token.test.ts:170`](apps/floor/src/jobs/station/per-task-token.test.ts#L191))
...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:19`](apps/floor/src/jobs/agent/agent-events.test.ts#L19), [`agent-events.test.ts:43`](apps/floor/src/jobs/agent/agent-events.test.ts#L43), [`agent-events.test.ts:55`](apps/floor/src/jobs/agent/agent-events.test.ts#L55), [`agent-events.test.ts:66`](apps/floor/src/jobs/agent/agent-events.test.ts#L66), [`agent-events.test.ts:76`](apps/floor/src/jobs/agent/agent-events.test.ts#L76), [`agent-events.test.ts:83`](apps/floor/src/jobs/agent/agent-events.test.ts#L83), [`agent-events.test.ts:146`](apps/floor/src/jobs/agent/agent-events.test.ts#L146), [`agent-events.test.ts:164`](apps/floor/src/jobs/agent/agent-events.test.ts#L164), [`agent-events.test.ts:172`](apps/floor/src/jobs/agent/agent-events.test.ts#L172), [`agent-events.test.ts:64`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L64), [`agent-events.test.ts:76`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L76), [`agent-events.test.ts:146`](apps/floor/src/jobs/agent/agent-events.test.ts#L146), [`agent-events.test.ts:172`](apps/floor/src/jobs/agent/agent-events.test.ts#L172), [`agent-events.test.ts:134`](apps/floor/src/jobs/agent/agent-events.test.ts#L134), [`agent-output.test.ts:183`](libs/assembly-lines/src/agent-output.test.ts#L183), [`agent-output.test.ts:189`](libs/assembly-lines/src/agent-output.test.ts#L189), [`agent-output.test.ts:198`](libs/assembly-lines/src/agent-output.test.ts#L198), [`agent-output.test.ts:213`](libs/assembly-lines/src/agent-output.test.ts#L213), [`agent-output.test.ts:222`](libs/assembly-lines/src/agent-output.test.ts#L222), [`agent-output.test.ts:231`](libs/assembly-lines/src/agent-output.test.ts#L231), [`agent-output.test.ts:242`](libs/assembly-lines/src/agent-output.test.ts#L242), [`agent-output.test.ts:253`](libs/assembly-lines/src/agent-output.test.ts#L253), [`agent-output.test.ts:259`](libs/assembly-lines/src/agent-output.test.ts#L259), [`agent-events.test.ts:95`](apps/floor/src/jobs/agent/agent-events.test.ts#L95), [`agent-events.test.ts:122`](apps/floor/src/jobs/agent/agent-events.test.ts#L122); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
16. Node YAML accepts optional `station_ref` (custom station, default `def-<type>`) and
    `timeout_minutes`. ([validated by accepts station_ref and timeout_minutes on a node](libs/assembly-lines/src/loader.test.ts#L257))
...
23. *(added 2026-07-31)* A station that makes its own LLM calls (comment-triage today) MUST report
    ...
    classification reports no usage. ([validated by `agent-output.test.ts:354`](libs/assembly-lines/src/agent-output.test.ts#L354), [`agent-output.test.ts:369`](libs/assembly-lines/src/agent-output.test.ts#L369), [`agent-output.test.ts:380`](libs/assembly-lines/src/agent-output.test.ts#L380), [`agent-events.test.ts:180`](apps/floor/src/jobs/agent/agent-events.test.ts#L180), [`agent-events.test.ts:213`](apps/floor/src/jobs/agent/agent-events.test.ts#L213), [`comment-triage.test.ts:51`](apps/lore-station/src/stations/comment-triage.test.ts#L51), [`comment-triage.test.ts:49`](libs/shared/src/review/comment-triage.test.ts#L49), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180))
...
29. *(added 2026-08-10)* The Floor MUST project those artifact events off the
    ...
    exactly like an uncorrelated cost row ([validated by `agent-events.test.ts:223`](apps/floor/src/jobs/agent/agent-events.test.ts#L223), [`agent-events.test.ts:245`](apps/floor/src/jobs/agent/agent-events.test.ts#L245), [`agent-events.test.ts:258`](apps/floor/src/jobs/agent/agent-events.test.ts#L258), [`agent-events.test.ts:267`](apps/floor/src/jobs/agent/agent-events.test.ts#L267), [`agent-events.test.ts:281`](apps/floor/src/jobs/agent/agent-events.test.ts#L281), [`agent-events.test.ts:294`](apps/floor/src/jobs/agent/agent-events.test.ts#L294); implemented by [`agent-events.ts:96`](apps/floor/src/jobs/agent/agent-events.ts#L96))
...
30. *(added 2026-08-10)* Settling a round from an artifact event is skip-not-fail: an
    ...
    500 an ingest carrying cost and run-viz rows for unrelated runs ([validated by `planning-result.test.ts:59`](apps/floor/src/jobs/agent/planning-result.test.ts#L59), [`planning-result.test.ts:70`](apps/floor/src/jobs/agent/planning-result.test.ts#L70), [`planning-result.test.ts:86`](apps/floor/src/jobs/agent/planning-result.test.ts#L86), [`planning-result.test.ts:99`](apps/floor/src/jobs/agent/planning-result.test.ts#L99), [`planning-result.test.ts:110`](apps/floor/src/jobs/agent/planning-result.test.ts#L110), [`planning-result.test.ts:130`](apps/floor/src/jobs/agent/planning-result.test.ts#L130), [`planning-result.test.ts:143`](apps/floor/src/jobs/agent/planning-result.test.ts#L143), [`planning-result.test.ts:153`](apps/floor/src/jobs/agent/planning-result.test.ts#L153); implemented by [`planning-result.ts:44`](apps/floor/src/jobs/agent/planning-result.ts#L44))
