...
- **Paginated CR listing.** The reconcile safety net and the watch catch-up walk the Agent CRs
  ...
  (task/line still in flight) and the prune-after-an-hour behavior unchanged. ([validated by `agent-reconcile.test.ts:57`](apps/floor/src/listeners/agent-reconcile.test.ts#L57), [`agent-reconcile.test.ts:78`](apps/floor/src/listeners/agent-reconcile.test.ts#L78), [`agent-reconcile.test.ts:95`](apps/floor/src/listeners/agent-reconcile.test.ts#L95), [`agent-reconcile.test.ts:113`](apps/floor/src/listeners/agent-reconcile.test.ts#L113))
