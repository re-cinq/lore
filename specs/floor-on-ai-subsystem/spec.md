...
5. `AgentBackend.launch` produces a correct `Agent` CR from a task (stationRef from task type,
   ...
   non-terminal, conservatively true when the probe fails). ([validated by `agent-watcher-logic.test.ts:14`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L18), [`agent-watcher-logic.test.ts:31`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L31), [`agent-backend.test.ts:47`](libs/shared/src/cluster/agent-backend.test.ts#L47), [`agent-backend.test.ts:70`](libs/shared/src/cluster/agent-backend.test.ts#L70), [`agent-backend.test.ts:87`](libs/shared/src/cluster/agent-backend.test.ts#L87), [`agent-backend.test.ts:97`](libs/shared/src/cluster/agent-backend.test.ts#L97), [`agent-backend.test.ts:118`](libs/shared/src/cluster/agent-backend.test.ts#L118), [`agent-backend.test.ts:127`](libs/shared/src/cluster/agent-backend.test.ts#L127), [`agent-backend.test.ts:136`](libs/shared/src/cluster/agent-backend.test.ts#L136), [`agent-backend.test.ts:166`](libs/shared/src/cluster/agent-backend.test.ts#L166), [`agent-backend.test.ts:172`](libs/shared/src/cluster/agent-backend.test.ts#L172), [`agent-backend.test.ts:178`](libs/shared/src/cluster/agent-backend.test.ts#L178), [`agent-backend.test.ts:184`](libs/shared/src/cluster/agent-backend.test.ts#L184))
...
7. The deterministic gate reads the **conclusion of the GitHub Actions referenced by the assembly line**:
   a red conclusion routes to the address loop, a green conclusion proceeds. ([validated by `agent-watcher-logic.test.ts:51`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L55), [`agent-watcher-logic.test.ts:59`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L59))
...
9. Secrets in `ai-agents` are mirrored from the existing remoteRefs; the per-task GitHub token is
   ...
   Station's `agentDefRef` at it (template preserved, empty-template fallback). ([validated by `agent-watcher-logic.test.ts:66`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L66), [`agent-watcher-logic.test.ts:74`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L74), [`per-task-token.test.ts:57`](libs/shared/src/cluster/per-task-token.test.ts#L57), [`per-task-token.test.ts:76`](libs/shared/src/cluster/per-task-token.test.ts#L76), [`per-task-token.test.ts:79`](libs/shared/src/cluster/per-task-token.test.ts#L79), [`per-task-token.test.ts:92`](libs/shared/src/cluster/per-task-token.test.ts#L92), [`per-task-token.test.ts:107`](libs/shared/src/cluster/per-task-token.test.ts#L107), [`per-task-token.test.ts:141`](libs/shared/src/cluster/per-task-token.test.ts#L141), [`per-task-token.test.ts:147`](libs/shared/src/cluster/per-task-token.test.ts#L147), [`per-task-token.test.ts:159`](libs/shared/src/cluster/per-task-token.test.ts#L159), [`per-task-token.test.ts:173`](libs/shared/src/cluster/per-task-token.test.ts#L173), [`per-task-token.test.ts:191`](libs/shared/src/cluster/per-task-token.test.ts#L191))
...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:16`](apps/floor/src/jobs/agent/agent-events.test.ts#L16), [`agent-events.test.ts:107`](apps/floor/src/jobs/agent/agent-events.test.ts#L107), [`agent-events.test.ts:119`](apps/floor/src/jobs/agent/agent-events.test.ts#L119), [`agent-events.test.ts:130`](apps/floor/src/jobs/agent/agent-events.test.ts#L130), [`agent-events.test.ts:140`](apps/floor/src/jobs/agent/agent-events.test.ts#L140), [`agent-events.test.ts:147`](apps/floor/src/jobs/agent/agent-events.test.ts#L147), [`agent-events.test.ts:211`](apps/floor/src/jobs/agent/agent-events.test.ts#L211), [`agent-events.test.ts:80`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L80), [`agent-events.test.ts:80`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L80), [`agent-events.test.ts:211`](apps/floor/src/jobs/agent/agent-events.test.ts#L211), [`agent-events.test.ts:199`](apps/floor/src/jobs/agent/agent-events.test.ts#L199), [`agent-output.test.ts:182`](libs/assembly-lines/src/agent-output.test.ts#L182), [`agent-output.test.ts:188`](libs/assembly-lines/src/agent-output.test.ts#L188), [`agent-output.test.ts:197`](libs/assembly-lines/src/agent-output.test.ts#L197), [`agent-output.test.ts:212`](libs/assembly-lines/src/agent-output.test.ts#L212), [`agent-output.test.ts:221`](libs/assembly-lines/src/agent-output.test.ts#L221), [`agent-output.test.ts:230`](libs/assembly-lines/src/agent-output.test.ts#L230), [`agent-output.test.ts:241`](libs/assembly-lines/src/agent-output.test.ts#L241), [`agent-output.test.ts:252`](libs/assembly-lines/src/agent-output.test.ts#L252), [`agent-output.test.ts:258`](libs/assembly-lines/src/agent-output.test.ts#L258), [`agent-events.test.ts:159`](apps/floor/src/jobs/agent/agent-events.test.ts#L159), [`agent-events.test.ts:187`](apps/floor/src/jobs/agent/agent-events.test.ts#L187); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
11. *(restated late 2026-07)* A node CR's terminal status maps to a node outcome
    ...
    stage-trailer-resume mechanics are retired (6-dark-factory FR6.9) ([validated by `node-outcome.test.ts:35`](libs/assembly-lines/src/node-outcome.test.ts#L34), [`advance-line.test.ts:379`](apps/floor/src/jobs/assembly-run/advance-line.test.ts#L379))
...
18. A station pod ends with the claude-style result line carrying `LORE_NODE_RESULT: {outcome,
    ...
    ([validated by parseNodeResult tests](libs/assembly-lines/src/node-outcome.test.ts#L20), [`agent-output.test.ts:269`](libs/assembly-lines/src/agent-output.test.ts#L269), [`agent-output.test.ts:280`](libs/assembly-lines/src/agent-output.test.ts#L280), [`agent-output.test.ts:292`](libs/assembly-lines/src/agent-output.test.ts#L292), [`agent-output.test.ts:300`](libs/assembly-lines/src/agent-output.test.ts#L300), [`agent-output.test.ts:310`](libs/assembly-lines/src/agent-output.test.ts#L310), [`agent-output.test.ts:318`](libs/assembly-lines/src/agent-output.test.ts#L318), [`agent-output.test.ts:328`](libs/assembly-lines/src/agent-output.test.ts#L328); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180), [validated by reassembles the final assistant message when the result line carries no text](libs/assembly-lines/src/agent-output.test.ts#L493), [validated by stops at the first non-assistant event, so a marker mentioned in an earlier turn cannot shadow the block actually written](libs/assembly-lines/src/agent-output.test.ts#L501), [validated by falls back to the raw output when a text-less result has no assistant chunks before it](libs/assembly-lines/src/agent-output.test.ts#L512), [validated by still prefers the claude-style result text when both shapes appear](libs/assembly-lines/src/agent-output.test.ts#L518))
...
19. Cutover complete: every non-agent node on the Floor-assembly-line path dispatches a station
    ...
    `handleClaudeCodeTask` with no Floor-side clone or App token. ([validated by every non-agent node dispatches a station CR](apps/floor/src/jobs/assembly-run/floor-assembly-run.test.ts#L119))
...
20. `scripts/task-types.yaml` `stations:` seeds `def-<type>` AgentDefinition/Station pairs (exec
    ...
    environment. ([validated by station catalog tests](apps/floor/src/jobs/agent/agent-catalog.test.ts#L280), [`agent-catalog.test.ts:21`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L21), [`agent-catalog.test.ts:69`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L69), [`agent-catalog.test.ts:122`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L122), [`agent-catalog.test.ts:154`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L154), [`agent-catalog.test.ts:162`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L162), [`agent-catalog.test.ts:190`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L190), [`agent-catalog.test.ts:198`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L198), [`agent-catalog.test.ts:216`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L216), [`agent-catalog.test.ts:231`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L231), [`agent-catalog.test.ts:227`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L227), [`agent-catalog.test.ts:241`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L241), [`agent-catalog.test.ts:250`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L250), [`agent-catalog.test.ts:263`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L263), [`agent-catalog.test.ts:267`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L267), [`agent-catalog.test.ts:280`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L280), [`agent-catalog.test.ts:313`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L313), [`agent-catalog.test.ts:380`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L380), [`agent-catalog.test.ts:395`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L395))
...
22. The `lore-station` image runs one module per non-agent node type, each reading the Floor's
    ...
    an unknown `job_ref`). ([validated by `validate.test.ts:39`](apps/stations/src/stations/validate/validate.test.ts#L39), [`gate.test.ts:17`](apps/stations/src/stations/gate/gate.test.ts#L17), [`github-action.test.ts:23`](apps/stations/src/stations/github-action/github-action.test.ts#L23), [`detect.test.ts:18`](apps/stations/src/stations/detect/detect.test.ts#L18), [`detect.test.ts:34`](apps/stations/src/stations/detect/detect.test.ts#L34), [`station-input.test.ts:19`](libs/shared/src/station-input.test.ts#L19), [`station-input.test.ts:31`](libs/shared/src/station-input.test.ts#L31), [`station-input.test.ts:46`](libs/shared/src/station-input.test.ts#L46), [`station-input.test.ts:63`](libs/shared/src/station-input.test.ts#L63), [`station-input.test.ts:67`](libs/shared/src/station-input.test.ts#L67), [`station-input.test.ts:73`](libs/shared/src/station-input.test.ts#L73), [`station-input.test.ts:88`](libs/shared/src/station-input.test.ts#L88), [`station-input.test.ts:107`](libs/shared/src/station-input.test.ts#L107))
...
23. *(added 2026-07-31)* A station that makes its own LLM calls (comment-triage today) MUST report
    ...
    classification reports no usage. ([validated by `agent-output.test.ts:353`](libs/assembly-lines/src/agent-output.test.ts#L353), [`agent-output.test.ts:368`](libs/assembly-lines/src/agent-output.test.ts#L368), [`agent-output.test.ts:379`](libs/assembly-lines/src/agent-output.test.ts#L379), [`agent-events.test.ts:229`](apps/floor/src/jobs/agent/agent-events.test.ts#L229), [`agent-events.test.ts:263`](apps/floor/src/jobs/agent/agent-events.test.ts#L263), [`comment-triage.test.ts:51`](apps/stations/src/stations/comment-triage/comment-triage.test.ts#L51), [`comment-triage.test.ts:49`](libs/shared/src/review/comment-triage.test.ts#L49), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180))
...
26. *(added 2026-08-10)* A seeded recipe MUST NOT declare `skills` without a
    ...
    leaving it empty ([validated by `agent-catalog.test.ts:255`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L255); implemented by [`agent-catalog.ts:363`](apps/floor/src/jobs/agent/agent-catalog.ts#L363))
...
27. *(added 2026-08-10)* The agent container MUST run in the cloned repo
    ...
    ([validated by `agent-catalog.test.ts:180`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L180); implemented by [`agent-catalog.ts:211`](apps/floor/src/jobs/agent/agent-catalog.ts#L211))
...
28. *(added 2026-08-10)* A run whose deliverable is a **file** MUST declare it, so the
    ...
    ([validated by `agent-catalog.test.ts:136`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L136), [`agent-catalog.test.ts:147`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L147); implemented by [`agent-catalog.ts:173`](apps/floor/src/jobs/agent/agent-catalog.ts#L173))
...
29. *(added 2026-08-10)* The Floor MUST project those artifact events off the
    ...
    exactly like an uncorrelated cost row ([validated by `agent-events.test.ts:273`](apps/floor/src/jobs/agent/agent-events.test.ts#L273), [`agent-events.test.ts:295`](apps/floor/src/jobs/agent/agent-events.test.ts#L295), [`agent-events.test.ts:308`](apps/floor/src/jobs/agent/agent-events.test.ts#L308), [`agent-events.test.ts:317`](apps/floor/src/jobs/agent/agent-events.test.ts#L317), [`agent-events.test.ts:331`](apps/floor/src/jobs/agent/agent-events.test.ts#L331), [`agent-events.test.ts:344`](apps/floor/src/jobs/agent/agent-events.test.ts#L344); implemented by [`agent-events.ts:96`](apps/floor/src/jobs/agent/agent-events.ts#L96))
...
30. *(added 2026-08-10)* Settling a round from an artifact event is skip-not-fail: an
    ...
    500 an ingest carrying cost and run-viz rows for unrelated runs ([validated by `planning-result.test.ts:64`](apps/floor/src/jobs/agent/planning-result.test.ts#L63), [`planning-result.test.ts:74`](apps/floor/src/jobs/agent/planning-result.test.ts#L74), [`planning-result.test.ts:74`](apps/floor/src/jobs/agent/planning-result.test.ts#L74), [`planning-result.test.ts:103`](apps/floor/src/jobs/agent/planning-result.test.ts#L103), [`planning-result.test.ts:114`](apps/floor/src/jobs/agent/planning-result.test.ts#L114), [`planning-result.test.ts:135`](apps/floor/src/jobs/agent/planning-result.test.ts#L135), [`planning-result.test.ts:149`](apps/floor/src/jobs/agent/planning-result.test.ts#L149), [`planning-result.test.ts:159`](apps/floor/src/jobs/agent/planning-result.test.ts#L159); implemented by [`planning-result.ts:44`](apps/floor/src/jobs/agent/planning-result.ts#L44))
...
31. *(added 2026-08-13)* The review family's recipes (`review`, `code-review`,
    ...
    ([validated by `agent-catalog.test.ts:418`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L418), [`agent-catalog.test.ts:428`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L428), [`agent-catalog.test.ts:434`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L434); implemented by [`agent-catalog.ts:166`](apps/floor/src/jobs/agent/agent-catalog.ts#L166), [`agent-catalog.ts:209`](apps/floor/src/jobs/agent/agent-catalog.ts#L209))
...
33. *(added 2026-08-28, #1629)* The `{context}` placeholder is guarded on
    ...
    ([validated by `agent-catalog.test.ts:221`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L221); implemented by [`agent-catalog.ts:424`](apps/floor/src/jobs/agent/agent-catalog.ts#L424))
...
34. *(added 2026-08-30)* A recipe MAY declare its own `skills`, and they are APPENDED
    ...
    otherwise silently lose the context skill that makes `lore_assemble_context` the
    first thing every run does — the same shape of loss as FR26's `skills_source`, and
...
- **One namespace default.** The namespace Agent CRs live in is
  ...
  ([validated by returns ai-agents when LORE_AGENTS_NAMESPACE is unset](libs/shared/src/kube-config.test.ts#L83), [`kube-config.test.ts:87`](libs/shared/src/kube-config.test.ts#L87))
...
- **Run-outcome mapping.** `runOutcomeFromTaskStatus` records the watcher's run outcome: `pr-created`
  ...
  `completed`. ([validated by `agent-watcher-logic.test.ts:90`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L90), [`agent-watcher-logic.test.ts:94`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L94), [`agent-watcher-logic.test.ts:98`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L98), [`agent-watcher-logic.test.ts:79`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L79), [`agent-watcher-logic.test.ts:101`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L101), [`agent-watcher-logic.test.ts:105`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L105))
- **Issue-body log links.** `taskPageUrl` builds the web-ui task-page link (`{LORE_UI_URL}/tasks/{taskId}`,
  ...
  degrades to plain "See logs" rather than fabricating a dead link. ([validated by `agent-watcher-logic.test.ts:141`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L141), [`agent-watcher-logic.test.ts:147`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L147), [`agent-watcher-logic.test.ts:153`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L153), [`agent-watcher-logic.test.ts:157`](apps/floor/src/jobs/lib/agent-watcher-logic.test.ts#L157))
...
- **Agent pod-log retrieval.** `readAgentLogs` resolves an Agent CR's newest job pod and returns its
  ...
  50 000, keeps a sane value, and defaults non-positive/non-numeric input. ([validated by `agent-pod-logs.test.ts:57`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L57), [`agent-pod-logs.test.ts:65`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L65), [`agent-pod-logs.test.ts:69`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L69), [`agent-pod-logs.test.ts:84`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L84), [`agent-pod-logs.test.ts:105`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L105), [`agent-pod-logs.test.ts:113`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L113), [`agent-pod-logs.test.ts:129`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L129), [`agent-pod-logs.test.ts:145`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L145), [`agent-pod-logs.test.ts:163`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L163), [`agent-pod-logs.test.ts:179`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L179), [`agent-logs.test.ts:40`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L40), [`agent-logs.test.ts:51`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L51), [`agent-logs.test.ts:68`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L68), [`agent-logs.test.ts:82`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L82), [`agent-logs.test.ts:86`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L86), [`agent-logs.test.ts:90`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L90))
- **Durable pod-log fallback.** When the live pod is gone, `readAgentLogs` consults a `PodLogArchive`
  ...
  reverses the newest-first entries into chronological text (null when empty). ([validated by `agent-pod-logs.test.ts:198`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L198), [`agent-pod-logs.test.ts:215`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L215), [`agent-pod-logs.test.ts:237`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L237), [`agent-pod-logs.test.ts:250`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L250), [`agent-pod-logs.test.ts:259`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L259), [`agent-pod-logs.test.ts:279`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L279), [`agent-pod-logs.test.ts:285`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L285), [`agent-pod-logs.test.ts:291`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L291), [`agent-pod-logs.test.ts:297`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L297), [`agent-pod-logs.test.ts:303`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L303), [`agent-pod-logs.test.ts:307`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L307), [`agent-pod-logs.test.ts:319`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L319))
- **Silent-500 guard.** The Floor's HTTP server logs every boomified handler or auth-scheme throw
  ...
  Deliberate Boom 4xx/503 responses do not hit the channel and are unchanged. ([validated by `agent-logs.test.ts:97`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L98))
...
- **CR-watch idempotency.** Event dedupe keys collapse redundant deliveries so a Floor restart replays
  ...
  than defaulting. ([validated by `dedupe.test.ts:5`](libs/shared/src/project/events/dedupe.test.ts#L5), [`dedupe.test.ts:11`](libs/shared/src/project/events/dedupe.test.ts#L11), [`dedupe.test.ts:17`](libs/shared/src/project/events/dedupe.test.ts#L17), [`dedupe.test.ts:23`](libs/shared/src/project/events/dedupe.test.ts#L23), [`kubernetes.test.ts:21`](apps/floor/src/jobs/kubernetes.test.ts#L21), [`kubernetes.test.ts:33`](apps/floor/src/jobs/kubernetes.test.ts#L33))
