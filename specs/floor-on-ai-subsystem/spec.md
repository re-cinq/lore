...
5. `AgentBackend.launch` produces a correct `Agent` CR from a task (stationRef from task type,
   ...
   non-terminal, conservatively true when the probe fails). ([validated by `agent-watcher-logic.test.ts:14`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L15), [`agent-watcher-logic.test.ts:27`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L28), [`agent-backend.test.ts:48`](libs/shared/src/cluster/agent-backend.test.ts#L48), [`agent-backend.test.ts:71`](libs/shared/src/cluster/agent-backend.test.ts#L71), [`agent-backend.test.ts:88`](libs/shared/src/cluster/agent-backend.test.ts#L88), [`agent-backend.test.ts:98`](libs/shared/src/cluster/agent-backend.test.ts#L98), [`agent-backend.test.ts:120`](libs/shared/src/cluster/agent-backend.test.ts#L120), [`agent-backend.test.ts:129`](libs/shared/src/cluster/agent-backend.test.ts#L129), [`agent-backend.test.ts:136`](libs/shared/src/cluster/agent-backend.test.ts#L136), [`agent-backend.test.ts:166`](libs/shared/src/cluster/agent-backend.test.ts#L166), [`agent-backend.test.ts:172`](libs/shared/src/cluster/agent-backend.test.ts#L172), [`agent-backend.test.ts:178`](libs/shared/src/cluster/agent-backend.test.ts#L178), [`agent-backend.test.ts:184`](libs/shared/src/cluster/agent-backend.test.ts#L184))
...
7. The deterministic gate reads the **conclusion of the GitHub Actions referenced by the assembly line**:
   a red conclusion routes to the address loop, a green conclusion proceeds. ([validated by `agent-watcher-logic.test.ts:51`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L52), [`agent-watcher-logic.test.ts:55`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L56))
...
9. Secrets in `ai-agents` are mirrored from the existing remoteRefs; the per-task GitHub token is
   ...
   Station's `agentDefRef` at it (template preserved, empty-template fallback). ([validated by `agent-watcher-logic.test.ts:65`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L66), [`agent-watcher-logic.test.ts:73`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L74), [`per-task-token.test.ts:57`](libs/shared/src/cluster/per-task-token.test.ts#L57), [`per-task-token.test.ts:76`](libs/shared/src/cluster/per-task-token.test.ts#L76), [`per-task-token.test.ts:79`](libs/shared/src/cluster/per-task-token.test.ts#L79), [`per-task-token.test.ts:92`](libs/shared/src/cluster/per-task-token.test.ts#L92), [`per-task-token.test.ts:107`](libs/shared/src/cluster/per-task-token.test.ts#L107), [`per-task-token.test.ts:117`](libs/shared/src/cluster/per-task-token.test.ts#L143), [`per-task-token.test.ts:123`](libs/shared/src/cluster/per-task-token.test.ts#L149), [`per-task-token.test.ts:135`](libs/shared/src/cluster/per-task-token.test.ts#L161), [`per-task-token.test.ts:152`](libs/shared/src/cluster/per-task-token.test.ts#L178), [`per-task-token.test.ts:170`](libs/shared/src/cluster/per-task-token.test.ts#L196))
...
- **Run-outcome mapping.** `runOutcomeFromTaskStatus` records the watcher's run outcome: `pr-created`
  ...
  `completed`. ([validated by `agent-watcher-logic.test.ts:89`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L90), [`agent-watcher-logic.test.ts:93`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L94), [`agent-watcher-logic.test.ts:97`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L98), [`agent-watcher-logic.test.ts:78`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L79), [`agent-watcher-logic.test.ts:100`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L101), [`agent-watcher-logic.test.ts:106`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L107))
- **Issue-body log links.** `taskPageUrl` builds the web-ui task-page link (`{LORE_UI_URL}/tasks/{taskId}`,
  ...
  degrades to plain "See logs" rather than fabricating a dead link. ([validated by `agent-watcher-logic.test.ts:150`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L151), [`agent-watcher-logic.test.ts:156`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L157), [`agent-watcher-logic.test.ts:162`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L163), [`agent-watcher-logic.test.ts:166`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L167))
...
- **CR-watch idempotency.** Event dedupe keys collapse redundant deliveries so a Floor restart replays
  ...
  and rethrows a 403 so the loop retries rather than marking it handled. ([validated by `dedupe.test.ts:5`](libs/shared/src/project/events/dedupe.test.ts#L5), [`dedupe.test.ts:11`](libs/shared/src/project/events/dedupe.test.ts#L11), [`dedupe.test.ts:17`](libs/shared/src/project/events/dedupe.test.ts#L17), [`dedupe.test.ts:23`](libs/shared/src/project/events/dedupe.test.ts#L23), [`kubernetes.test.ts:26`](apps/floor/src/jobs/kubernetes.test.ts#L26), [`kubernetes.test.ts:26`](apps/floor/src/jobs/kubernetes.test.ts#L26))
