...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:16`](apps/floor/src/jobs/agent/agent-events.test.ts#L16), [`agent-events.test.ts:100`](apps/floor/src/jobs/agent/agent-events.test.ts#L100), [`agent-events.test.ts:112`](apps/floor/src/jobs/agent/agent-events.test.ts#L112), [`agent-events.test.ts:123`](apps/floor/src/jobs/agent/agent-events.test.ts#L123), [`agent-events.test.ts:133`](apps/floor/src/jobs/agent/agent-events.test.ts#L133), [`agent-events.test.ts:140`](apps/floor/src/jobs/agent/agent-events.test.ts#L140), [`agent-events.test.ts:204`](apps/floor/src/jobs/agent/agent-events.test.ts#L204), [`agent-events.test.ts:64`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L85), [`agent-events.test.ts:72`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L81), [`agent-events.test.ts:204`](apps/floor/src/jobs/agent/agent-events.test.ts#L204), [`agent-events.test.ts:192`](apps/floor/src/jobs/agent/agent-events.test.ts#L192), [`agent-output.test.ts:183`](libs/assembly-lines/src/agent-output.test.ts#L184), [`agent-output.test.ts:189`](libs/assembly-lines/src/agent-output.test.ts#L190), [`agent-output.test.ts:198`](libs/assembly-lines/src/agent-output.test.ts#L199), [`agent-output.test.ts:213`](libs/assembly-lines/src/agent-output.test.ts#L214), [`agent-output.test.ts:222`](libs/assembly-lines/src/agent-output.test.ts#L223), [`agent-output.test.ts:231`](libs/assembly-lines/src/agent-output.test.ts#L232), [`agent-output.test.ts:242`](libs/assembly-lines/src/agent-output.test.ts#L243), [`agent-output.test.ts:253`](libs/assembly-lines/src/agent-output.test.ts#L254), [`agent-output.test.ts:259`](libs/assembly-lines/src/agent-output.test.ts#L260), [`agent-events.test.ts:152`](apps/floor/src/jobs/agent/agent-events.test.ts#L152), [`agent-events.test.ts:180`](apps/floor/src/jobs/agent/agent-events.test.ts#L180); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
23. *(added 2026-07-31)* A station that makes its own LLM calls (comment-triage today) MUST report
    ...
    classification reports no usage. ([validated by `agent-output.test.ts:354`](libs/assembly-lines/src/agent-output.test.ts#L355), [`agent-output.test.ts:369`](libs/assembly-lines/src/agent-output.test.ts#L370), [`agent-output.test.ts:380`](libs/assembly-lines/src/agent-output.test.ts#L381), [`agent-events.test.ts:222`](apps/floor/src/jobs/agent/agent-events.test.ts#L222), [`agent-events.test.ts:256`](apps/floor/src/jobs/agent/agent-events.test.ts#L256), [`comment-triage.test.ts:51`](apps/stations/src/stations/comment-triage/comment-triage.test.ts#L51), [`comment-triage.test.ts:49`](libs/shared/src/review/comment-triage.test.ts#L49), [`comment-triage.test.ts:71`](libs/shared/src/review/comment-triage.test.ts#L71); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180))
...
29. *(added 2026-08-10)* The Floor MUST project those artifact events off the
    ...
    exactly like an uncorrelated cost row ([validated by `agent-events.test.ts:266`](apps/floor/src/jobs/agent/agent-events.test.ts#L266), [`agent-events.test.ts:288`](apps/floor/src/jobs/agent/agent-events.test.ts#L288), [`agent-events.test.ts:301`](apps/floor/src/jobs/agent/agent-events.test.ts#L301), [`agent-events.test.ts:310`](apps/floor/src/jobs/agent/agent-events.test.ts#L310), [`agent-events.test.ts:324`](apps/floor/src/jobs/agent/agent-events.test.ts#L324), [`agent-events.test.ts:337`](apps/floor/src/jobs/agent/agent-events.test.ts#L337); implemented by [`agent-events.ts:96`](apps/floor/src/jobs/agent/agent-events.ts#L96))
