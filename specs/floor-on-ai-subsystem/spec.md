...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:15`](apps/floor/src/jobs/agent/agent-events.test.ts#L15), [`agent-events.test.ts:39`](apps/floor/src/jobs/agent/agent-events.test.ts#L39), [`agent-events.test.ts:51`](apps/floor/src/jobs/agent/agent-events.test.ts#L51), [`agent-events.test.ts:62`](apps/floor/src/jobs/agent/agent-events.test.ts#L62), [`agent-events.test.ts:72`](apps/floor/src/jobs/agent/agent-events.test.ts#L72), [`agent-events.test.ts:79`](apps/floor/src/jobs/agent/agent-events.test.ts#L79), [`agent-events.test.ts:142`](apps/floor/src/jobs/agent/agent-events.test.ts#L142), [`agent-events.test.ts:160`](apps/floor/src/jobs/agent/agent-events.test.ts#L160), [`agent-events.test.ts:168`](apps/floor/src/jobs/agent/agent-events.test.ts#L168), [`agent-events.test.ts:64`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L64), [`agent-events.test.ts:76`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L76), [`agent-events.test.ts:142`](apps/floor/src/jobs/agent/agent-events.test.ts#L142), [`agent-events.test.ts:168`](apps/floor/src/jobs/agent/agent-events.test.ts#L168), [`agent-events.test.ts:131`](apps/floor/src/jobs/agent/agent-events.test.ts#L131), [`agent-output.test.ts:183`](libs/assembly-lines/src/agent-output.test.ts#L183), [`agent-output.test.ts:189`](libs/assembly-lines/src/agent-output.test.ts#L189), [`agent-output.test.ts:198`](libs/assembly-lines/src/agent-output.test.ts#L198), [`agent-output.test.ts:213`](libs/assembly-lines/src/agent-output.test.ts#L213), [`agent-output.test.ts:222`](libs/assembly-lines/src/agent-output.test.ts#L222), [`agent-output.test.ts:231`](libs/assembly-lines/src/agent-output.test.ts#L231), [`agent-output.test.ts:242`](libs/assembly-lines/src/agent-output.test.ts#L242), [`agent-output.test.ts:253`](libs/assembly-lines/src/agent-output.test.ts#L253), [`agent-output.test.ts:259`](libs/assembly-lines/src/agent-output.test.ts#L259), [`agent-events.test.ts:91`](apps/floor/src/jobs/agent/agent-events.test.ts#L91), [`agent-events.test.ts:118`](apps/floor/src/jobs/agent/agent-events.test.ts#L118); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
20. `scripts/task-types.yaml` `stations:` seeds `def-<type>` AgentDefinition/Station pairs (exec
    ...
    image from helm values (no sentinel leaks). ([validated by station catalog tests](apps/floor/src/jobs/agent/agent-catalog.test.ts#L178), [`agent-catalog.test.ts:20`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L20), [`agent-catalog.test.ts:60`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L60), [`agent-catalog.test.ts:76`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L76), [`agent-catalog.test.ts:90`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L90), [`agent-catalog.test.ts:98`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L98), [`agent-catalog.test.ts:116`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L116), [`agent-catalog.test.ts:124`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L124), [`agent-catalog.test.ts:142`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L142), [`agent-catalog.test.ts:148`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L148), [`agent-catalog.test.ts:152`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L152), [`agent-catalog.test.ts:161`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L161), [`agent-catalog.test.ts:165`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L165), [`agent-catalog.test.ts:178`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L178), [`agent-catalog.test.ts:211`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L211), [`agent-catalog.test.ts:278`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L278), [`agent-catalog.test.ts:293`](apps/floor/src/jobs/agent/agent-catalog.test.ts#L293))
