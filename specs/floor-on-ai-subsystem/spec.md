...
7. The deterministic gate reads the **conclusion of the GitHub Actions referenced by the assembly line**:
   a red conclusion routes to the address loop, a green conclusion proceeds. ([validated by `agent-watcher-logic.test.ts:51`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L55), [`agent-watcher-logic.test.ts:55`](apps/floor/src/jobs/watcher/agent-watcher-logic.test.ts#L59))
