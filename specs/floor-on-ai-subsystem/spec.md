...
10. Run output reaches the Floor over the public-LB http sink and is recorded in
    ...
    looping, so a third envelope layer is left intact as the event and yields no row. ([validated by `agent-events.test.ts:16`](apps/floor/src/jobs/agent/agent-events.test.ts#L16), [`agent-events.test.ts:110`](apps/floor/src/jobs/agent/agent-events.test.ts#L110), [`agent-events.test.ts:122`](apps/floor/src/jobs/agent/agent-events.test.ts#L122), [`agent-events.test.ts:133`](apps/floor/src/jobs/agent/agent-events.test.ts#L133), [`agent-events.test.ts:143`](apps/floor/src/jobs/agent/agent-events.test.ts#L143), [`agent-events.test.ts:150`](apps/floor/src/jobs/agent/agent-events.test.ts#L150), [`agent-events.test.ts:214`](apps/floor/src/jobs/agent/agent-events.test.ts#L214), [`agent-events.test.ts:64`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L86), [`agent-events.test.ts:72`](apps/floor/src/delivery/http/routes/agent-events.test.ts#L82), [`agent-events.test.ts:214`](apps/floor/src/jobs/agent/agent-events.test.ts#L214), [`agent-events.test.ts:202`](apps/floor/src/jobs/agent/agent-events.test.ts#L202), [`agent-output.test.ts:183`](libs/assembly-lines/src/agent-output.test.ts#L184), [`agent-output.test.ts:189`](libs/assembly-lines/src/agent-output.test.ts#L190), [`agent-output.test.ts:198`](libs/assembly-lines/src/agent-output.test.ts#L199), [`agent-output.test.ts:213`](libs/assembly-lines/src/agent-output.test.ts#L214), [`agent-output.test.ts:222`](libs/assembly-lines/src/agent-output.test.ts#L223), [`agent-output.test.ts:231`](libs/assembly-lines/src/agent-output.test.ts#L232), [`agent-output.test.ts:242`](libs/assembly-lines/src/agent-output.test.ts#L243), [`agent-output.test.ts:253`](libs/assembly-lines/src/agent-output.test.ts#L254), [`agent-output.test.ts:259`](libs/assembly-lines/src/agent-output.test.ts#L260), [`agent-events.test.ts:162`](apps/floor/src/jobs/agent/agent-events.test.ts#L162), [`agent-events.test.ts:190`](apps/floor/src/jobs/agent/agent-events.test.ts#L190); implemented by [`agent-output.ts:80`](libs/assembly-lines/src/agent-output.ts#L80))
...
11. *(restated late 2026-07)* A node CR's terminal status maps to a node outcome
    ...
    stage-trailer-resume mechanics are retired (6-dark-factory FR6.9) ([validated by `node-outcome.test.ts:35`](libs/assembly-lines/src/node-outcome.test.ts#L34), [`advance.test.ts:437`](apps/floor/src/jobs/assembly-run/advance.test.ts#L439))
...
18. A station pod ends with the claude-style result line carrying `LORE_NODE_RESULT: {outcome,
    ...
    ([validated by parseNodeResult tests](libs/assembly-lines/src/node-outcome.test.ts#L20), [`agent-output.test.ts:270`](libs/assembly-lines/src/agent-output.test.ts#L271), [`agent-output.test.ts:281`](libs/assembly-lines/src/agent-output.test.ts#L282), [`agent-output.test.ts:293`](libs/assembly-lines/src/agent-output.test.ts#L294), [`agent-output.test.ts:301`](libs/assembly-lines/src/agent-output.test.ts#L302), [`agent-output.test.ts:311`](libs/assembly-lines/src/agent-output.test.ts#L312), [`agent-output.test.ts:319`](libs/assembly-lines/src/agent-output.test.ts#L320), [`agent-output.test.ts:329`](libs/assembly-lines/src/agent-output.test.ts#L330); implemented by [`agent-output.ts:180`](libs/assembly-lines/src/agent-output.ts#L180), [validated by reassembles the final assistant message when the result line carries no text](libs/assembly-lines/src/agent-output.test.ts#L510), [validated by stops at the first non-assistant event, so a marker mentioned in an earlier turn cannot shadow the block actually written](libs/assembly-lines/src/agent-output.test.ts#L518), [validated by falls back to the raw output when a text-less result has no assistant chunks before it](libs/assembly-lines/src/agent-output.test.ts#L529), [validated by still prefers the claude-style result text when both shapes appear](libs/assembly-lines/src/agent-output.test.ts#L535))
...
- **Agent pod-log retrieval.** `readAgentLogs` resolves an Agent CR's newest job pod and returns its
  ...
  50 000, keeps a sane value, and defaults non-positive/non-numeric input. ([validated by `agent-pod-logs.test.ts:59`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L59), [`agent-pod-logs.test.ts:67`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L67), [`agent-pod-logs.test.ts:71`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L71), [`agent-pod-logs.test.ts:86`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L86), [`agent-pod-logs.test.ts:107`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L107), [`agent-pod-logs.test.ts:115`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L115), [`agent-pod-logs.test.ts:131`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L131), [`agent-pod-logs.test.ts:147`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L147), [`agent-pod-logs.test.ts:165`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L165), [`agent-pod-logs.test.ts:181`](apps/floor/src/jobs/station/agent-pod-logs.test.ts#L181), [`agent-logs.test.ts:39`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L40), [`agent-logs.test.ts:50`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L51), [`agent-logs.test.ts:67`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L68), [`agent-logs.test.ts:81`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L82), [`agent-logs.test.ts:85`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L86), [`agent-logs.test.ts:89`](apps/floor/src/delivery/http/routes/agent-logs.test.ts#L90))
