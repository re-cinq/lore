...
- A node with no stored turns and a failed fetch each get an explicit message, so an empty panel is never ambiguous between "pruned", "never stored", and "broken"; a failed walk retries when the panel is reopened instead of pinning the error until a page reload, showing the loading state rather than the stale error while the retry is in flight. ([validated by `FullTranscriptPanel.test.tsx:219`](apps/web-ui/src/app/assembly-runs/[id]/FullTranscriptPanel.test.tsx#L218), [`FullTranscriptPanel.test.tsx:232`](apps/web-ui/src/app/assembly-runs/[id]/FullTranscriptPanel.test.tsx#L231), [`FullTranscriptPanel.test.tsx:243`](apps/web-ui/src/app/assembly-runs/[id]/FullTranscriptPanel.test.tsx#L242), [`FullTranscriptPanel.test.tsx:262`](apps/web-ui/src/app/assembly-runs/[id]/FullTranscriptPanel.test.tsx#L261))
