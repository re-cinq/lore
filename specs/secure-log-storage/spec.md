...
- Common secret patterns:
  - API keys (sk-*, ghp_*, ghs_*, AKIA*, xoxb-*) ([validated by `redacts GitHub personal access tokens (ghp_)`](apps/mcp-server/src/platform/redact.test.ts#L5), [validated by `redacts GitHub server tokens (ghs_)`](apps/mcp-server/src/platform/redact.test.ts#L13), [validated by `redacts Anthropic API keys (sk-ant-)`](apps/mcp-server/src/platform/redact.test.ts#L21), [validated by `redacts generic sk- prefixed keys`](apps/mcp-server/src/platform/redact.test.ts#L29), [validated by `redacts AWS access keys (AKIA)`](apps/mcp-server/src/platform/redact.test.ts#L37), [validated by `redacts Slack tokens (xoxb-, xoxp-)`](apps/mcp-server/src/platform/redact.test.ts#L45), [validated by `redacts GitLab tokens (glpat-)`](apps/mcp-server/src/platform/redact.test.ts#L53))
  - JWT tokens (eyJ*) ([validated by `redacts JWTs`](apps/mcp-server/src/platform/redact.test.ts#L61))
  - Private keys (-----BEGIN.*PRIVATE KEY-----) ([validated by `redacts RSA private keys`](apps/mcp-server/src/platform/redact.test.ts#L74), [validated by `redacts generic private keys (EC, DSA)`](apps/mcp-server/src/platform/redact.test.ts#L87))
  - Connection strings (postgres://, mysql://, mongodb://) ([validated by `redacts PostgreSQL connection strings`](apps/mcp-server/src/platform/redact.test.ts#L99), [validated by `redacts MySQL connection strings`](apps/mcp-server/src/platform/redact.test.ts#L107), [validated by `redacts MongoDB connection strings`](apps/mcp-server/src/platform/redact.test.ts#L115), [validated by `redacts Redis connection strings`](apps/mcp-server/src/platform/redact.test.ts#L123), [validated by `redacts AMQP connection strings`](apps/mcp-server/src/platform/redact.test.ts#L131))
  - Base64-encoded blobs > 100 chars ([validated by `redacts long base64 blobs`](apps/mcp-server/src/platform/redact.test.ts#L147))
...
Benign text with no secret pattern is passed through unchanged — normal log lines, code snippets, base64 strings shorter than 100 chars, and the empty string are never redacted. ([validated by `does not redact short base64 strings (< 100 chars)`](apps/mcp-server/src/platform/redact.test.ts#L156), [validated by `preserves normal text`](apps/mcp-server/src/platform/redact.test.ts#L164), [validated by `preserves code snippets`](apps/mcp-server/src/platform/redact.test.ts#L171), [validated by `handles empty string`](apps/mcp-server/src/platform/redact.test.ts#L177))
...
2. Secrets redacted before storage (API keys, JWTs, private keys, connection strings) ([validated by `redact.test.ts:5`](libs/shared/src/redact.test.ts#L5), [`redact.test.ts:48`](libs/shared/src/redact.test.ts#L48), [validated by `redacts Bearer tokens`](apps/mcp-server/src/platform/redact.test.ts#L139), [validated by `handles text with multiple secrets`](apps/mcp-server/src/platform/redact.test.ts#L181), [validated by `redacts secrets embedded in JSON`](apps/mcp-server/src/platform/redact.test.ts#L196))
