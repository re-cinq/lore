...
- Common secret patterns:
  - API keys (sk-*, ghp_*, ghs_*, AKIA*, xoxb-*) ([validated by `redacts GitHub personal access tokens (ghp_)`](apps/mcp-server/src/platform/redact.test.ts#L43), [validated by `redacts GitHub server tokens (ghs_)`](apps/mcp-server/src/platform/redact.test.ts#L51), [validated by `redacts Anthropic API keys (sk-ant-)`](apps/mcp-server/src/platform/redact.test.ts#L59), [validated by `redacts generic sk- prefixed keys`](apps/mcp-server/src/platform/redact.test.ts#L67), [validated by `redacts AWS access keys (AKIA)`](apps/mcp-server/src/platform/redact.test.ts#L75), [validated by `redacts Slack tokens (xoxb-, xoxp-)`](apps/mcp-server/src/platform/redact.test.ts#L83), [validated by `redacts GitLab tokens (glpat-)`](apps/mcp-server/src/platform/redact.test.ts#L91))
  - JWT tokens (eyJ*) ([validated by `redacts JWTs`](apps/mcp-server/src/platform/redact.test.ts#L99))
  - Private keys (-----BEGIN.*PRIVATE KEY-----) ([validated by `redacts RSA private keys`](apps/mcp-server/src/platform/redact.test.ts#L112), [validated by `redacts generic private keys (EC, DSA)`](apps/mcp-server/src/platform/redact.test.ts#L125))
  - Connection strings (postgres://, mysql://, mongodb://) ([validated by `redacts PostgreSQL connection strings`](apps/mcp-server/src/platform/redact.test.ts#L137), [validated by `redacts MySQL connection strings`](apps/mcp-server/src/platform/redact.test.ts#L145), [validated by `redacts MongoDB connection strings`](apps/mcp-server/src/platform/redact.test.ts#L153), [validated by `redacts Redis connection strings`](apps/mcp-server/src/platform/redact.test.ts#L161), [validated by `redacts AMQP connection strings`](apps/mcp-server/src/platform/redact.test.ts#L169))
  - Base64-encoded blobs > 100 chars ([validated by `redacts long base64 blobs`](apps/mcp-server/src/platform/redact.test.ts#L185))
...
Benign text with no secret pattern is passed through unchanged — normal log lines, code snippets, base64 strings shorter than 100 chars, and the empty string are never redacted. ([validated by `does not redact short base64 strings (< 100 chars)`](apps/mcp-server/src/platform/redact.test.ts#L194), [validated by `preserves normal text`](apps/mcp-server/src/platform/redact.test.ts#L202), [validated by `preserves code snippets`](apps/mcp-server/src/platform/redact.test.ts#L209), [validated by `handles empty string`](apps/mcp-server/src/platform/redact.test.ts#L215))
...
2. Secrets redacted before storage (API keys, JWTs, private keys, connection strings) ([validated by `redact.test.ts:5`](libs/shared/src/redact.test.ts#L5), [`redact.test.ts:48`](libs/shared/src/redact.test.ts#L48), [validated by `redacts Bearer tokens`](apps/mcp-server/src/platform/redact.test.ts#L177), [validated by `handles text with multiple secrets`](apps/mcp-server/src/platform/redact.test.ts#L219), [validated by `redacts secrets embedded in JSON`](apps/mcp-server/src/platform/redact.test.ts#L234))
