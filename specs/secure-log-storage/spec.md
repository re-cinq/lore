...
- Common secret patterns:
  - API keys (sk-*, ghp_*, ghs_*, AKIA*, xoxb-*) ([validated by `redacts GitHub personal access tokens (ghp_)`](apps/mcp-server/src/platform/redact.test.ts#L35), [validated by `redacts GitHub server tokens (ghs_)`](apps/mcp-server/src/platform/redact.test.ts#L43), [validated by `redacts Anthropic API keys (sk-ant-)`](apps/mcp-server/src/platform/redact.test.ts#L51), [validated by `redacts generic sk- prefixed keys`](apps/mcp-server/src/platform/redact.test.ts#L59), [validated by `redacts AWS access keys (AKIA)`](apps/mcp-server/src/platform/redact.test.ts#L67), [validated by `redacts Slack tokens (xoxb-, xoxp-)`](apps/mcp-server/src/platform/redact.test.ts#L75), [validated by `redacts GitLab tokens (glpat-)`](apps/mcp-server/src/platform/redact.test.ts#L83))
  - JWT tokens (eyJ*) ([validated by `redacts JWTs`](apps/mcp-server/src/platform/redact.test.ts#L91))
  - Private keys (-----BEGIN.*PRIVATE KEY-----) ([validated by `redacts RSA private keys`](apps/mcp-server/src/platform/redact.test.ts#L104), [validated by `redacts generic private keys (EC, DSA)`](apps/mcp-server/src/platform/redact.test.ts#L117))
  - Connection strings (postgres://, mysql://, mongodb://) ([validated by `redacts PostgreSQL connection strings`](apps/mcp-server/src/platform/redact.test.ts#L129), [validated by `redacts MySQL connection strings`](apps/mcp-server/src/platform/redact.test.ts#L137), [validated by `redacts MongoDB connection strings`](apps/mcp-server/src/platform/redact.test.ts#L145), [validated by `redacts Redis connection strings`](apps/mcp-server/src/platform/redact.test.ts#L153), [validated by `redacts AMQP connection strings`](apps/mcp-server/src/platform/redact.test.ts#L161))
  - Base64-encoded blobs > 100 chars ([validated by `redacts long base64 blobs`](apps/mcp-server/src/platform/redact.test.ts#L177))
...
Benign text with no secret pattern is passed through unchanged — normal log lines, code snippets, base64 strings shorter than 100 chars, and the empty string are never redacted. ([validated by `does not redact short base64 strings (< 100 chars)`](apps/mcp-server/src/platform/redact.test.ts#L186), [validated by `preserves normal text`](apps/mcp-server/src/platform/redact.test.ts#L194), [validated by `preserves code snippets`](apps/mcp-server/src/platform/redact.test.ts#L201), [validated by `handles empty string`](apps/mcp-server/src/platform/redact.test.ts#L207))
...
2. Secrets redacted before storage (API keys, JWTs, private keys, connection strings) ([validated by `redact.test.ts:5`](libs/shared/src/redact.test.ts#L5), [`redact.test.ts:48`](libs/shared/src/redact.test.ts#L48), [validated by `redacts Bearer tokens`](apps/mcp-server/src/platform/redact.test.ts#L169), [validated by `handles text with multiple secrets`](apps/mcp-server/src/platform/redact.test.ts#L211), [validated by `redacts secrets embedded in JSON`](apps/mcp-server/src/platform/redact.test.ts#L226))
