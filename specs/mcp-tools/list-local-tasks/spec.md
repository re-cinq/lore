...
Registered via `server.tool` ([registration](apps/mcp-server/src/transport/tools/local-runner-tools.local.ts#L123)).
...
1. Call `listLocalTasks()`
   ([reader](../../../apps/mcp-server/src/work/pipeline/runner.local.ts#L976)):
