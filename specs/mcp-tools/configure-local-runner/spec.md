...
Registered via `server.tool` ([registration](apps/mcp-server/src/transport/tools/local-runner-tools.local.ts#L208)).
...
1. `readConfig()`
   ([reader](../../../apps/mcp-server/src/work/pipeline/runner-local-storage.ts#L25)) —
...
3. **Update mode** — overwrite each provided field
   ...
   ([writer](../../../apps/mcp-server/src/work/pipeline/runner-local-storage.ts#L39))
...
types). ([validated by `runner.local.test.ts:74`](apps/mcp-server/src/work/pipeline/runner.local.test.ts#L77))
