...
A `revise` action queues a follow-up task from human feedback and answers with its id; an unknown task is 404 and blank feedback is 409, because an empty revision is worse than a refusal. ([validated by queues a revision and answers with the new task id](apps/lore-api/src/transport/routes/tasks/task-post.test.ts#L153), [`task-post.test.ts:155`](apps/lore-api/src/transport/routes/tasks/task-post.test.ts#L171), [`task-post.test.ts:167`](apps/lore-api/src/transport/routes/tasks/task-post.test.ts#L183), [`task-post.test.ts:177`](apps/lore-api/src/transport/routes/tasks/task-post.test.ts#L193))
...
A create threads `group_id` through to `createTask` as its trailing argument when provided. ([validated by `task-post.test.ts:299`](apps/lore-api/src/transport/routes/tasks/task-post.test.ts#L348))
...
Invalid JSON returns 500. ([validated by `returns 400 on invalid JSON`](apps/lore-api/src/transport/routes/tasks/task-post.test.ts#L366))
