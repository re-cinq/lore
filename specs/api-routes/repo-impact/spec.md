...
A client that does not declare `protocol: 2` has its findings suppressed and is told why, because a diff taken against the base-branch tip carries every commit merged to the base since the branch point. ([validated by `trace-impact:716`](libs/shared/src/work/spec-trace/trace-impact.test.ts#L661), [validated by `trace-impact:729`](libs/shared/src/work/spec-trace/trace-impact.test.ts#L674))
...
provides. ([validated by `trace-impact:254`](libs/shared/src/work/spec-trace/trace-impact.test.ts#L213), [validated by `trace-impact:325`](libs/shared/src/work/spec-trace/trace-impact.test.ts#L284), [validated by `trace-impact:404`](libs/shared/src/work/spec-trace/trace-impact.test.ts#L363), [validated by `trace-impact:539`](libs/shared/src/work/spec-trace/trace-impact.test.ts#L492))
