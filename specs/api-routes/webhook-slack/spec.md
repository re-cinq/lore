...
A valid `v0=` signature over `v0:{ts}:{body}` verifies; a mismatched timestamp or a length-mismatched signature is rejected without throwing. ([validated by `returns true for a matching v0 signature`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L16), [`returns false when the timestamp differs`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L20), [`returns false on a length mismatch without throwing`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L24), [`slack-webhook.test.ts:8`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L8), [`slack-webhook.test.ts:20`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L20), [`slack-webhook.test.ts:29`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L29), [`slack-webhook.test.ts:46`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L46), [`slack-webhook.test.ts:53`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L53))

An unset secret returns 503; missing signature headers, a stale timestamp, and an invalid signature each return 401. ([validated by `returns 503 when the signing secret is unset`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L62), [`returns 401 when signature headers are missing`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L69), [`returns 401 when the timestamp is too old`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L79), [`returns 401 on an invalid signature`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L88))

The url_verification handshake echoes the challenge, and an absent challenge yields an empty body. ([validated by `answers the url_verification challenge`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L62), [`answers url_verification with an empty challenge when absent`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L101), [`webhook-slack.test.ts:94`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L94))

An empty command returns the ephemeral usage help. ([validated by `returns usage help when text is empty`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L108))

`retry <id>` retries the task and reports the new id; a failing retry reports it ephemerally; a bare `retry` with no id is treated as a general-task description. ([validated by `retries a task`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L114), [`reports a failed retry`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L122), [`treats a bare retry with no task id as a general-task description`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L225))

An unmapped channel, a null pool, an absent `channel_id`, and a failing channel lookup all return the "No repo mapped" ephemeral message. ([validated by `returns the no-repo message when the channel is unmapped`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L135), [`returns the no-repo message when pool is null`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L148), [`defaults the channel id to empty and returns the no-repo message when channel_id is absent`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L129), [`falls through to no-repo when the channel query throws`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L158))

A `! implementation …` command creates an immediate implementation task with the exact createTask arguments; a `! …` with no known type creates an immediate general task; a normal-priority command reports the backlog; a createTask failure is reported ephemerally. ([validated by `creates an immediate task with a known type`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L171), [`creates an immediate general-typed task when no known type follows the bang`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L247), [`creates a normal-priority task and reports the backlog`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L197), [`reports a failed task creation`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L211))

The pure command parser extracts the type, defaults to general, handles the `!` prefix, and does not match partial type names. ([validated by `parses /lore implementation add auth`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L62), [`defaults to general when no type specified`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L71), [`parses ! prefix as immediate priority`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L115), [`does not match partial type names`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L89), [`slack-webhook.test.ts:80`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L80), [`slack-webhook.test.ts:95`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L95), [`slack-webhook.test.ts:102`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L102), [`slack-webhook.test.ts:109`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L109), [`slack-webhook.test.ts:125`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L125), [`slack-webhook.test.ts:131`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L131), [`slack-webhook.test.ts:141`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L141))
