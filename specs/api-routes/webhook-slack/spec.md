...
A valid `v0=` signature over `v0:{ts}:{body}` verifies; a mismatched timestamp or a length-mismatched signature is rejected without throwing. ([validated by `returns true for a matching v0 signature`](apps/lore-api/src/transport/routes/webhooks/webhook-signature.test.ts#L16), [`returns false when the timestamp differs`](apps/lore-api/src/transport/routes/webhooks/webhook-signature.test.ts#L20), [`returns false on a length mismatch without throwing`](apps/lore-api/src/transport/routes/webhooks/webhook-signature.test.ts#L24), [`slack-webhook.test.ts:8`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L8), [`slack-webhook.test.ts:20`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L20), [`slack-webhook.test.ts:29`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L29), [`slack-webhook.test.ts:46`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L46), [`slack-webhook.test.ts:53`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L53))
...
The pure command parser extracts the type, defaults to general, handles the `!` prefix, and does not match partial type names. ([validated by `parses /lore implementation add auth`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L62), [`defaults to general when no type specified`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L71), [`parses ! prefix as immediate priority`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L115), [`does not match partial type names`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L89), [`slack-webhook.test.ts:80`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L80), [`slack-webhook.test.ts:95`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L95), [`slack-webhook.test.ts:102`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L102), [`slack-webhook.test.ts:109`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L109), [`slack-webhook.test.ts:125`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L125), [`slack-webhook.test.ts:131`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L131), [`slack-webhook.test.ts:141`](apps/lore-api/src/transport/routes/webhooks/slack-webhook.test.ts#L141))
