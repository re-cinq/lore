...
A valid `v0=` signature over `v0:{ts}:{body}` verifies; a mismatched timestamp or a length-mismatched signature is rejected without throwing. ([validated by `returns true for a matching v0 signature`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L16), [`returns false when the timestamp differs`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L20), [`returns false on a length mismatch without throwing`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L24), [`slack-webhook.test.ts:32`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L32), [`slack-webhook.test.ts:44`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L44), [`slack-webhook.test.ts:53`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L53), [`slack-webhook.test.ts:71`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L71), [`slack-webhook.test.ts:78`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L78))
...
The pure command parser extracts the type, defaults to general, handles the `!` prefix, and does not match partial type names. ([validated by `parses /lore implementation add auth`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L123), [`defaults to general when no type specified`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L130), [`parses ! prefix as immediate priority`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L173), [`does not match partial type names`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L146), [`slack-webhook.test.ts:137`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L137), [`slack-webhook.test.ts:152`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L152), [`slack-webhook.test.ts:160`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L160), [`slack-webhook.test.ts:167`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L167), [`slack-webhook.test.ts:183`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L183), [`slack-webhook.test.ts:189`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L189), [`slack-webhook.test.ts:199`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L199))
