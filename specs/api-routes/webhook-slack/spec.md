...
A valid `v0=` signature over `v0:{ts}:{body}` verifies; a mismatched timestamp or a length-mismatched signature is rejected without throwing. ([validated by `returns true for a matching v0 signature`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L16), [`returns false when the timestamp differs`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L20), [`returns false on a length mismatch without throwing`](apps/lore-api/src/api/routes/webhooks/webhook-signature.test.ts#L24), [`slack-webhook.test.ts:26`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L26), [`slack-webhook.test.ts:38`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L38), [`slack-webhook.test.ts:47`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L47), [`slack-webhook.test.ts:64`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L64), [`slack-webhook.test.ts:71`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L71))
...
`retry <id>` retries the task and reports the new id; a failing retry reports it ephemerally; a bare `retry` with no id is treated as a general-task description. ([validated by `retries a task`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L114), [`reports a failed retry`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L122), [`treats a bare retry with no task id as a general-task description`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L219))

An unmapped channel, a null pool, and a failing channel lookup all return the "No repo mapped" ephemeral message. ([validated by `returns the no-repo message when the channel is unmapped`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L129), [`returns the no-repo message when pool is null`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L142), [`falls through to no-repo when the channel query throws`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L152))

A `! implementation …` command creates an immediate implementation task with the exact createTask arguments; a `! …` with no known type creates an immediate general task; a normal-priority command reports the backlog; a createTask failure is reported ephemerally. ([validated by `creates an immediate task with a known type`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L165), [`creates an immediate general-typed task when no known type follows the bang`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L241), [`creates a normal-priority task and reports the backlog`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L191), [`reports a failed task creation`](apps/lore-api/src/api/routes/webhooks/webhook-slack.test.ts#L205))

The pure command parser extracts the type, defaults to general, handles the `!` prefix, and does not match partial type names. ([validated by `parses /lore implementation add auth`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L112), [`defaults to general when no type specified`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L119), [`parses ! prefix as immediate priority`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L161), [`does not match partial type names`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L135), [`slack-webhook.test.ts:126`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L126), [`slack-webhook.test.ts:141`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L141), [`slack-webhook.test.ts:148`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L148), [`slack-webhook.test.ts:155`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L155), [`slack-webhook.test.ts:171`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L171), [`slack-webhook.test.ts:177`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L177), [`slack-webhook.test.ts:187`](apps/lore-api/src/api/routes/webhooks/slack-webhook.test.ts#L187))
