...
1a. Each runner invocation writes a `pipeline.job_runs` row — `running` on start,
   ...
   in-process run. ([validated by `job-run.test.ts:16`](agent/src/lib/job-run.test.ts#L16), [`job-run.test.ts:32`](agent/src/lib/job-run.test.ts#L32), [`job-run.test.ts:63`](agent/src/lib/job-run.test.ts#L63))
1b. A completed or failed CronJob run's full output is retained in GCS (redacted,
   ...
   `pipeline.job_runs.log_path` — not lost to ephemeral pod stdout. ([validated by `log-storage.test.ts:42`](agent/src/lib/log-storage.test.ts#L42), [`job-run.test.ts:45`](agent/src/lib/job-run.test.ts#L45))
