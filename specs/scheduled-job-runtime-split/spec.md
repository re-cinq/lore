...
(`apps/floor/src/work/detect/fan-out.ts`) starts one per-repo assembly line via
...
- **FR9.4 — Importance decay follows the same route.** Scoring memories against
  ...
  differently within a run. ([validated by `importance-decay.test.ts:28`](apps/stations/src/work/importance-decay/importance-decay.test.ts#L28), [`importance-decay.test.ts:40`](apps/stations/src/work/importance-decay/importance-decay.test.ts#L40), [`importance-decay.test.ts:50`](apps/stations/src/work/importance-decay/importance-decay.test.ts#L50), [`importance-decay.test.ts:63`](apps/stations/src/work/importance-decay/importance-decay.test.ts#L63), [`importance-decay.test.ts:75`](apps/stations/src/work/importance-decay/importance-decay.test.ts#L75), [`importance-decay.test.ts:102`](apps/stations/src/work/importance-decay/importance-decay.test.ts#L102), [`importance-decay.test.ts:123`](apps/stations/src/work/importance-decay/importance-decay.test.ts#L123))
- **FR9.5 — The Anthropic cost sync follows, credential and all.** Reading the
  ...
  makes the job report a skip rather than fail. ([validated by `anthropic-cost-sync.test.ts:10`](apps/stations/src/work/anthropic-cost-sync/anthropic-cost-sync.test.ts#L10))
...
9. Each migrated batch job is an independently-runnable unit the runner dispatches and whose one-line
   ...
   excluding source code, root docs, and binary/unsupported files. ([validated by `ttl-cleanup.test.ts:25`](apps/floor/src/work/memory/ttl-cleanup/ttl-cleanup.test.ts#L25), [`ttl-cleanup.test.ts:34`](apps/floor/src/work/memory/ttl-cleanup/ttl-cleanup.test.ts#L34), [`anthropic-cost-sync.test.ts:10`](apps/stations/src/work/anthropic-cost-sync/anthropic-cost-sync.test.ts#L10), [`anthropic-cost.test.ts:9`](apps/stations/src/work/anthropic-cost-sync/anthropic-cost.test.ts#L9), [`anthropic-cost.test.ts:37`](apps/stations/src/work/anthropic-cost-sync/anthropic-cost.test.ts#L37), [`anthropic-cost.test.ts:73`](apps/stations/src/work/anthropic-cost-sync/anthropic-cost.test.ts#L73), [`anthropic-cost.test.ts:92`](apps/stations/src/work/anthropic-cost-sync/anthropic-cost.test.ts#L92), [`reindex-seed.test.ts:5`](apps/floor/src/work/context-jobs/reindex/reindex-seed.test.ts#L5), [`reindex-seed.test.ts:30`](apps/floor/src/work/context-jobs/reindex/reindex-seed.test.ts#L30), [`reindex-seed.test.ts:36`](apps/floor/src/work/context-jobs/reindex/reindex-seed.test.ts#L36))
...
11. `context_reindex` ends every per-repo pass with a verification sweep (ADR-019 amendment
   ...
   - Each team-resolved per-repo pass also begins with legacy relocation (issue #979, FR-20.21
     ...
     the org_shared-resolved pass skips relocation entirely ([validated by `chunks.test.ts:699`](libs/shared/src/outbound/project/chunks/chunks.test.ts#L699), [`chunks.test.ts:762`](libs/shared/src/outbound/project/chunks/chunks.test.ts#L762), [`chunks.test.ts:773`](libs/shared/src/outbound/project/chunks/chunks.test.ts#L773))
   ...
   - Each pass also runs a chunker-upgrade heal sweep (issue #995): `staleChunkerFiles` returns
     ...
     ([validated by `chunks.test.ts:808`](libs/shared/src/outbound/project/chunks/chunks.test.ts#L808), [`chunks.test.ts:847`](libs/shared/src/outbound/project/chunks/chunks.test.ts#L847), [`reindex-heal.test.ts:27`](apps/floor/src/work/context-jobs/reindex/reindex-heal.test.ts#L27), [`reindex-heal.test.ts:52`](apps/floor/src/work/context-jobs/reindex/reindex-heal.test.ts#L52), [`reindex-heal.test.ts:73`](apps/floor/src/work/context-jobs/reindex/reindex-heal.test.ts#L73), [`reindex-heal.test.ts:94`](apps/floor/src/work/context-jobs/reindex/reindex-heal.test.ts#L94))
   - Each pass ends with a never-ingested backfill sweep (issue #999): the repo tree is diffed
     ...
     ([validated by `chunks.test.ts:873`](libs/shared/src/outbound/project/chunks/chunks.test.ts#L873), [`chunks.test.ts:895`](libs/shared/src/outbound/project/chunks/chunks.test.ts#L895), [`reindex-backfill.test.ts:24`](apps/floor/src/work/context-jobs/reindex/reindex-backfill.test.ts#L24), [`reindex-backfill.test.ts:58`](apps/floor/src/work/context-jobs/reindex/reindex-backfill.test.ts#L58), [`reindex-backfill.test.ts:80`](apps/floor/src/work/context-jobs/reindex/reindex-backfill.test.ts#L80), [`reindex-backfill.test.ts:106`](apps/floor/src/work/context-jobs/reindex/reindex-backfill.test.ts#L106), [`reindex-backfill.test.ts:125`](apps/floor/src/work/context-jobs/reindex/reindex-backfill.test.ts#L125))
