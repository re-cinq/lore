...
1. `node dist/job-runner.js <jobName>` runs each of the 10 batch jobs, initializes
   ...
   an unknown name exits non-zero. ([validated by `job-runner.test.ts:42`](apps/agent/src/job-runner.test.ts#L42), [`job-runner.test.ts:47`](apps/agent/src/job-runner.test.ts#L47))
1a. Each runner invocation writes a `pipeline.job_runs` row — `running` on start,
   ...
   in-process run. ([validated by `job-run.test.ts:16`](apps/agent/src/lib/job-run.test.ts#L16), [`job-run.test.ts:32`](apps/agent/src/lib/job-run.test.ts#L32), [`job-run.test.ts:63`](apps/agent/src/lib/job-run.test.ts#L63))
1b. A completed or failed CronJob run's full output is retained in GCS (redacted,
   ...
   `pipeline.job_runs.log_path` — not lost to ephemeral pod stdout. ([validated by `log-storage.test.ts:42`](apps/agent/src/lib/log-storage.test.ts#L42), [`job-run.test.ts:45`](apps/agent/src/lib/job-run.test.ts#L45))
...
8. No job is scheduled both in-process and as a CronJob in any release. ([validated by `job-runner.test.ts:47`](apps/agent/src/job-runner.test.ts#L47))
