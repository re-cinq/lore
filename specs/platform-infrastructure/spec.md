...
boundary loses no bucket. ([validated by `anthropic-cost-sync.test.ts:31`](libs/stations/src/stations/anthropic-cost-sync/anthropic-cost-sync.test.ts#L31), [`anthropic-cost-sync.test.ts:37`](libs/stations/src/stations/anthropic-cost-sync/anthropic-cost-sync.test.ts#L37), [`anthropic-cost-sync.test.ts:43`](libs/stations/src/stations/anthropic-cost-sync/anthropic-cost-sync.test.ts#L43), [`anthropic-cost-sync.test.ts:49`](libs/stations/src/stations/anthropic-cost-sync/anthropic-cost-sync.test.ts#L49), [`anthropic-cost-sync.test.ts:56`](libs/stations/src/stations/anthropic-cost-sync/anthropic-cost-sync.test.ts#L56), [`anthropic-cost-sync.test.ts:62`](libs/stations/src/stations/anthropic-cost-sync/anthropic-cost-sync.test.ts#L62))
