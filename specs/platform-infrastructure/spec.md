...
boundary loses no bucket. ([validated by `anthropic-cost-sync.test.ts:31`](apps/lore-api/src/features/maintenance/cost/anthropic-cost-sync.test.ts#L31), [`anthropic-cost-sync.test.ts:37`](apps/lore-api/src/features/maintenance/cost/anthropic-cost-sync.test.ts#L37), [`anthropic-cost-sync.test.ts:43`](apps/lore-api/src/features/maintenance/cost/anthropic-cost-sync.test.ts#L43), [`anthropic-cost-sync.test.ts:49`](apps/lore-api/src/features/maintenance/cost/anthropic-cost-sync.test.ts#L49), [`anthropic-cost-sync.test.ts:56`](apps/lore-api/src/features/maintenance/cost/anthropic-cost-sync.test.ts#L56), [`anthropic-cost-sync.test.ts:62`](apps/lore-api/src/features/maintenance/cost/anthropic-cost-sync.test.ts#L62))
