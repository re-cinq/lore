...
14. Prose chunk markdown is sanitized after raw-HTML parsing: an injected `<script>` renders nothing executable, an `onerror` attribute is stripped from raw `<img>` HTML, and an injected `<svg onload>` is dropped, while fenced-code syntax highlighting and GFM tables survive the sanitizer. ([validated by `ChunkBody.test.tsx:112`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L112), [`ChunkBody.test.tsx:128`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L128), [`ChunkBody.test.tsx:146`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L146), [`ChunkBody.test.tsx:161`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L161), [`ChunkBody.test.tsx:175`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L175))
