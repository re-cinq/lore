...
3. The content-type filter renders one chip per type actually present in the data — never a hardcoded list — in a canonical order (unknown types sorted after known ones, alphabetically), each chip labelled with underscores turned to spaces and linking to its filtered view (a `?type=`/`?q=` href built off the base path). ([validated by `ContextFilters.test.tsx:27`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ContextFilters.test.tsx#L27), [`RepoContextView.test.tsx:63`](apps/web-ui/src/app/repos/[owner]/[repo]/context/RepoContextView.test.tsx#L63), [`content-types.test.ts:32`](apps/web-ui/src/lib/content-types.test.ts#L32), [`content-types.test.ts:41`](apps/web-ui/src/lib/content-types.test.ts#L41), [`content-types.test.ts:22`](apps/web-ui/src/lib/content-types.test.ts#L22), [`content-types.test.ts:26`](apps/web-ui/src/lib/content-types.test.ts#L26), [`content-types.test.ts:51`](apps/web-ui/src/lib/content-types.test.ts#L51), [`content-types.test.ts:55`](apps/web-ui/src/lib/content-types.test.ts#L55), [`content-types.test.ts:59`](apps/web-ui/src/lib/content-types.test.ts#L59), [`content-types.test.ts:65`](apps/web-ui/src/lib/content-types.test.ts#L65), [`ContextView.test.tsx:66`](apps/web-ui/src/app/context/ContextView.test.tsx#L66), [`FilterChip.test.tsx:31`](apps/web-ui/src/app/repos/[owner]/[repo]/context/FilterChip.test.tsx#L31))
...
10. Each list card shows the chunk's content type as a badge in the type's color, falling back to a plain badge for unknown types. ([validated by `ContextCard.test.tsx:33`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ContextCard.test.tsx#L33), [`content-types.test.ts:10`](apps/web-ui/src/lib/content-types.test.ts#L10), [`content-types.test.ts:16`](apps/web-ui/src/lib/content-types.test.ts#L16))
...
14. Prose chunk markdown is sanitized after raw-HTML parsing: an injected `<script>` renders nothing executable and an `onerror` attribute is stripped from raw `<img>` HTML, while fenced-code syntax highlighting and GFM tables survive the sanitizer. ([validated by `ChunkBody.test.tsx:111`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L111), [`ChunkBody.test.tsx:127`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L127), [`ChunkBody.test.tsx:145`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L145), [`ChunkBody.test.tsx:160`](apps/web-ui/src/app/repos/[owner]/[repo]/context/ChunkBody.test.tsx#L160))
