...
7a. The `lore-code-trace` binary is served for CI download by the lore-api `/dist/<os>-<arch>` route: `distArtifactFromUrl` resolves an allowed os-arch artifact name (or `checksums.txt`), strips a query string, and rejects an unknown artifact, a non-dist url, or a path-traversal attempt; the handler serves a baked binary as `application/octet-stream` with its byte length, and 404s an artifact missing from the image or an unknown name without touching the filesystem. ([validated by `dist.test.ts:10`](apps/lore-api/src/api/routes/dist/dist.test.ts#L10), [`dist.test.ts:14`](apps/lore-api/src/api/routes/dist/dist.test.ts#L14), [`dist.test.ts:18`](apps/lore-api/src/api/routes/dist/dist.test.ts#L18), [`dist.test.ts:22`](apps/lore-api/src/api/routes/dist/dist.test.ts#L22), [`dist.test.ts:26`](apps/lore-api/src/api/routes/dist/dist.test.ts#L26), [`dist.test.ts:30`](apps/lore-api/src/api/routes/dist/dist.test.ts#L30), [`dist.test.ts:47`](apps/lore-api/src/api/routes/dist/dist.test.ts#L47), [`dist.test.ts:59`](apps/lore-api/src/api/routes/dist/dist.test.ts#L59), [`dist.test.ts:68`](apps/lore-api/src/api/routes/dist/dist.test.ts#L68))
