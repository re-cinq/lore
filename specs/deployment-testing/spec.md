...
5. Redaction patterns have 100% coverage ([validated by `redact.test.ts:7`](apps/agent/src/lib/redact.test.ts#L7))
6. Task routing logic has tests for every task type ([validated by `orchestrator.test.ts:8`](apps/agent/src/application/orchestrator.test.ts#L8), [`worker.test.ts:57`](apps/agent/src/worker.test.ts#L57))
7. Watcher re-entry guard has a test
8. 409 CR handling has a test ([validated by `k8s-errors.test.ts:5`](apps/agent/src/lib/k8s-errors.test.ts#L5))
