...
6. Task routing logic has tests for every task type ([validated by `orchestrator.test.ts:8`](apps/agent/src/supervisor/orchestrator.test.ts#L8), [`worker.test.ts:57`](apps/agent/src/worker.test.ts#L57))
