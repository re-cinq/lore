...
6. Task routing logic has tests for every task type — onboard→`handleOnboard`,
   ...
   →`handleClaudeCodeTask`. ([validated by `worker.test.ts:55`](apps/floor/src/jobs/task/worker.test.ts#L55), [`worker.test.ts:55`](apps/floor/src/jobs/task/worker.test.ts#L55), [`worker.test.ts:59`](apps/floor/src/jobs/task/worker.test.ts#L59), [`worker.test.ts:63`](apps/floor/src/jobs/task/worker.test.ts#L63), [`worker.test.ts:67`](apps/floor/src/jobs/task/worker.test.ts#L67), [`worker.test.ts:71`](apps/floor/src/jobs/task/worker.test.ts#L71), [`worker.test.ts:75`](apps/floor/src/jobs/task/worker.test.ts#L75), [`worker.test.ts:79`](apps/floor/src/jobs/task/worker.test.ts#L79), [`worker.test.ts:83`](apps/floor/src/jobs/task/worker.test.ts#L83))
...
6a. Worker pure helpers are unit-tested: `slugify` lowercases, strips special chars, collapses runs to
   ...
   emits `Refs #N` for a number and empty for null. ([validated by `worker.test.ts:11`](apps/floor/src/jobs/task/worker.test.ts#L11), [`worker.test.ts:17`](apps/floor/src/jobs/task/worker.test.ts#L17), [`worker.test.ts:21`](apps/floor/src/jobs/task/worker.test.ts#L21), [`worker.test.ts:25`](apps/floor/src/jobs/task/worker.test.ts#L25), [`worker.test.ts:32`](apps/floor/src/jobs/task/worker.test.ts#L32), [`worker.test.ts:36`](apps/floor/src/jobs/task/worker.test.ts#L36), [`worker.test.ts:40`](apps/floor/src/jobs/task/worker.test.ts#L40), [`worker.test.ts:104`](apps/floor/src/jobs/task/worker.test.ts#L104), [`worker.test.ts:114`](apps/floor/src/jobs/task/worker.test.ts#L114), [`worker.test.ts:124`](apps/floor/src/jobs/task/worker.test.ts#L124), [`worker.test.ts:132`](apps/floor/src/jobs/task/worker.test.ts#L132), [`worker.test.ts:150`](apps/floor/src/jobs/task/worker.test.ts#L150), [`worker.test.ts:154`](apps/floor/src/jobs/task/worker.test.ts#L154), [`agent-invocation.test.ts:18`](apps/floor/src/kernel/agent-invocation.test.ts#L18), [`config.test.ts:128`](apps/floor/src/kernel/config.test.ts#L128), [`config.test.ts:134`](apps/floor/src/kernel/config.test.ts#L134))
