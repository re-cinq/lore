...
- *(added 2026-09-24)* The deep review reads the change as its user before it reads
  ...
  ([validated by](libs/shared/src/outbound/project/agents/agent-defaults-content.test.ts#L347))
- Lint, types, formatting and tests are CI's verdict, read through
  ...
  install. ([validated by](libs/shared/src/outbound/project/agents/agent-defaults-content.test.ts#L357))
- The diff is read once, in place, never dumped to a file and read back.
  ([validated by](libs/shared/src/outbound/project/agents/agent-defaults-content.test.ts#L367))
- Context is queried with the PR title, the spec sections it touches and the surface
  ...
  overview. ([validated by](libs/shared/src/outbound/project/agents/agent-defaults-content.test.ts#L373))
- `changes_requested` is for a defect in the changed code or a mismatch between what
  ...
  never blocks. ([validated by](libs/shared/src/outbound/project/agents/agent-defaults-content.test.ts#L382))
