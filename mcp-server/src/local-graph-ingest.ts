...
/** Recursively lists markdown files under `root` as repo-relative POSIX paths (specs/adrs are the only file-projectable kinds; CodeChunks are coverage-defined). */
