...
- FR-2.2: Agent receives: task description, context bundle (Lore
  ...
  repo for a type that declares one and falls back to `re-cinq/lore` otherwise. ([validated by `pipeline-config.test.ts:223`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L223), [`pipeline-config.test.ts:217`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L217))
...
run-now bumps a pending task's priority from `normal` to `immediate`. ([validated by `pipeline.test.ts:30`](apps/lore-api/src/integration-tests/pipeline.test.ts#L28), [`pipeline.test.ts:38`](apps/lore-api/src/integration-tests/pipeline.test.ts#L38), [`pipeline.test.ts:68`](apps/lore-api/src/integration-tests/pipeline.test.ts#L68), [`pipeline.test.ts:86`](apps/lore-api/src/integration-tests/pipeline.test.ts#L86), [`pipeline.test.ts:118`](apps/lore-api/src/integration-tests/pipeline.test.ts#L118), [`pipeline.test.ts:149`](apps/lore-api/src/integration-tests/pipeline.test.ts#L149), [`pipeline.test.ts:171`](apps/lore-api/src/integration-tests/pipeline.test.ts#L171), [`pipeline.test.ts:192`](apps/lore-api/src/integration-tests/pipeline.test.ts#L192), [`pipeline.test.ts:202`](apps/lore-api/src/integration-tests/pipeline.test.ts#L202), [`pipeline.test.ts:212`](apps/lore-api/src/integration-tests/pipeline.test.ts#L212), [`pipeline.test.ts:234`](apps/lore-api/src/integration-tests/pipeline.test.ts#L234))
...
- FR-6.1: Task types defined in a config file (e.g., `runbook`,
  ...
  handled gracefully as an empty config rather than throwing. ([validated by `pipeline-config.test.ts:20`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L20), [`pipeline-config.test.ts:46`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L46))
- FR-6.2: Each type specifies: agent prompt template, target repo,
  ...
  null for an unknown type. ([validated by `pipeline-config.test.ts:119`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L119), [`pipeline-config.test.ts:112`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L112), [`pipeline-config.test.ts:92`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L92), [`pipeline-config.test.ts:101`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L101), [`pipeline-config.test.ts:105`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L105))
...
- FR-6.5: `buildPrompt` renders a task by substituting the task `{description}` into the
  ...
  unrendered `{description}` placeholder for empty or special-character descriptions. ([validated by `pipeline-config.test.ts:165`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L165), [`pipeline-config.test.ts:173`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L173), [`pipeline-config.test.ts:181`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L181), [`pipeline-config.test.ts:188`](libs/server-core/src/work/pipeline/pipeline-config.test.ts#L188))
