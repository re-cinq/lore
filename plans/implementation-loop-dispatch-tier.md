...
1. A queue-timeout is stamped `infra` (reaper [:486](apps/floor/src/work/assembly-run/assembly-run-reaper.ts#L486) graph arm, [:269](apps/floor/src/work/assembly-run/assembly-run-reaper.ts#L269) single-CR arm); `infra` is not in `PERMANENT` ([error-classify.ts:135](libs/shared/src/error-classify.ts#L135)), so [transition.ts:147](libs/assembly-lines/src/transition.ts#L147) spends a budgeted back-edge on it.
