...
export const CatalogConfigSchema = z
  .object({
    ...
    // eslint-disable-next-line re-lint/no-duplicate-code -- the agent_definitions catalog blob, passed to the pod as stored; a shipped default's frontmatter overlaps in field names only, and a hand-edited config and a DB passthrough must stay free to diverge
