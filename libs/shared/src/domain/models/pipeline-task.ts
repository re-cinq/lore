...
export const PipelineTaskSchema = z.object({
  ...
  contextBundle: z.record(z.string(), z.unknown()).nullable(),
  contextRefs: z.record(z.string(), z.unknown()).nullable(),
  darkFactoryOverrides: z.record(z.string(), z.unknown()).nullable(),
