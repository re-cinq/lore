...
// behind a 202.
//
// Flipped 2026-08-17: every deployed Floor is at or past the readers-first release
// (8cc5609c, deployed from e499668e, deploy+smoke green), so all readers accept both
// spellings. The legacy READERS stay one more release — events queued and CRs created
// before this flip still carry the old name.
//
