...
describe("run event names", () => {
  ...
  it("RUN_STATION_EVENT is assembly_run.run_station, a wire spelling an unrecognizing Floor dead-letters", () => {
    expect(RUN_STATION_EVENT).toBe("assembly_run.run_station");
  });
});
