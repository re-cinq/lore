// github_action node graph handler (ADR-031 D3, #686 Wave 2). Non-AI workflow steps gate
...
import type { NodeHandler, NodeResult, NodeContext, StageOutcome } from "./graph-executor.js";
 ...
 *  (no CI configured for the repo) passes so the graph isn't blocked on a missing gate. */
