...
vi.mock("../../application/project-boot.js", () => ({ projectFor: async () => fakeProject }));
vi.mock("./repo-context.js", () => ({ fetchRepoContext: (...a: unknown[]) => fetchRepoContext(...a) }));
vi.mock("../../data/db.js", () => ({
  query: (...a: unknown[]) => query(...a),
  getPool: () => ({ query: async () => ({ rows: [] }) }),
}));
vi.mock("../../adapters/episode-writer.js", () => ({ writeEpisode: (...a: unknown[]) => writeEpisode(...a) }));
vi.mock("../../adapters/github.js", () => ({ GitHubPlatform: class { createLabels = createLabels; } }));
