...
/** Selects the branch-lease backend for the current environment: Postgres in cluster mode (LORE_DB_HOST set, one DbLeaseBackend per pod, ADR-024), file-backed otherwise (~/.lore/leases). */
