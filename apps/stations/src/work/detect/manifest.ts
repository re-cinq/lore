...
// Runs one deterministic detection job against one repo. Runtime: still a pod at its declared 30 minutes — the redesign into short units is specs/station-consolidation FR11 and lands with the detect work.
