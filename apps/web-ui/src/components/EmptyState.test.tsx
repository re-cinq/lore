...
describe('EmptyState', () => {
  ...
  it('renders the optional description', () => {
    render(<EmptyState title="No pools yet" description="Pools are created by agents." />);
    expect(screen.getByText('Pools are created by agents.')).toBeInTheDocument();
  });

  it('renders the optional action link', () => {
    render(<EmptyState title="No tasks" action={{ href: '/create', label: 'Create one' }} />);
