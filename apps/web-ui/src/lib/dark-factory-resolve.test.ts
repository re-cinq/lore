...
import { resolveDarkFactorySettings, DEFAULT_AUTO_MERGE_PATHS } from './dark-factory-resolve';
...
describe('resolveDarkFactorySettings (web-ui mirror)', () => {
  ...
  it('applies dark-mode defaults when enabled with no other fields', () => {
    ...
    expect(r).toMatchObject({ create_issue: 'on_gate', review: 'trust_based', notify: [] });
