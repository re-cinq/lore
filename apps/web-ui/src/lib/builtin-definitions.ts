...
export const implementationLoopDefinition: AssemblyLineDefinition = {
  ...
  description:
    "Work one backlog ticket test-first, open a PR, park until it is green with no unresolved review threads. Never merges.",
  version: 1,
  entry: "implement",
  exit: "done",
  nodes: [
  ...
  edges: [
    ...
    { from: "validate", to: "push", on: "success" },
    { from: "validate", to: "implement", on: "failed", iteration_max: 1 },
    { from: "push", to: "await-pr", on: "success" },
    { from: "push", to: "retrospective", on: "failed" },
    { from: "push", to: "retrospective", on: "changes_requested" },
    { from: "await-pr", to: "retrospective", on: "success" },
    { from: "await-pr", to: "retrospective", on: "changes_requested" },
