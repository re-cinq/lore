...
export default function FailureBlock({
  ...
  return (
    <div className="spec-card" style={{ borderColor: '#dc2626' }} role="alert">
      ...
      {!failureReason && (
        <p className="meta">
          The run finished without producing a result — usually the planning agent couldn&apos;t reach
          the model. Set <code>ANTHROPIC_API_KEY</code> (org billing) and Retry, or check the agent logs.
        </p>
      )}
