    ...
    <div>
      <div className={styles.titleRow}>
        ...
        <HelpPopover label="How settings are applied">
          ...
          <ul>
            <li>
              <strong>Trust level</strong> controls which task types are
              allowed, and auto-promotes after 3 successful merges.
            </li>
            <li>
              <strong>Cross-repo</strong> links are bidirectional — adding a
              repo here adds this repo to theirs.
            </li>
            <li>
              Per-repo <strong>agents</strong> live on the{" "}
              <strong>Agents</strong> tab; autonomy on the{" "}
              <strong>Dark Factory</strong> tab.
            </li>
          </ul>
        </HelpPopover>
      </div>
