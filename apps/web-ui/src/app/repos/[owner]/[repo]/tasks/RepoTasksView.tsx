 ...
 */
export default function RepoTasksView({ owner, repo, runs }: RepoTasksViewProps) {
  return (
    <div>
      <div className={styles.header}>
        <div className={styles.heading}>
          ...
          <HelpPopover label="How assembly lines work">
            <p>An assembly line is a chain of related tasks that produce one PR — the implementation task, its review, and any revisions — grouped into a single run.</p>
            <ul>
              <li>Each task runs the pipeline: pull repo context → agent works → deterministic validation (lint/typecheck) → branch + PR.</li>
      ...
      <p className={`meta ${styles.intro}`}>
        Assembly lines targeting this repo. Delegate work to agents and track their status, stages, PRs, and cost.
      </p>
