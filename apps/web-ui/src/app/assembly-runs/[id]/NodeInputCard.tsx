// Per-visit recorded input, read off the walk rows (not the event stream) — no pod echoes its own prompt, and the Agent CR is pruned after the run (run-viz FR4.4j).
