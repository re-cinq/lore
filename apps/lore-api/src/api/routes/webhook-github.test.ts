...
import { makeReq, makeRes, makePool, useRateLimitSafeClock } from "@re-cinq/lore-server-core/test-helpers/http-mock.js";
...
vi.mock("@re-cinq/lore-server-core/features/pipeline/tasks.js", () => ({ syncTasksToDb: vi.fn() }));
vi.mock("../../platform/github-client.js", () => ({ getGitHubToken: vi.fn(), getOctokit: vi.fn() }));
