...
- `libs/assembly-lines/src/assembly-lines/*.yaml` — declarative assembly line definitions (gap-fill, general, implementation, plus the detection lines spec-drift/gap-detect/spec-coverage-{validate,backfill}; more extensible)
