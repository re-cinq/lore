    ...
    <div className="spec-card" style={{ marginBottom: '16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
        ...
        <HelpPopover label="What enrollment checks mean">
          ...
          <ul>
            <li><strong>Repo integration</strong> is verified from Lore&apos;s database and (where the GitHub App has access) the repo&apos;s files. Missing files (e.g. the <code>lore-ingest.yml</code> ingest workflow) are regenerated by re-running onboarding.</li>
