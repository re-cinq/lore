...
[`projectSpecFile`](../libs/shared/src/work/spec-trace/project-spec-file.ts) turns it into
...
and [`ingestTestReport`](../libs/shared/src/work/spec-trace/ingest-test-report.ts) projects
...
1. **Derive descriptor `spec` anchors from the inline spec links.** A pure
   ...
   [`linksForStatements`](../libs/shared/src/domain/spec-link-parser.ts) to index every
