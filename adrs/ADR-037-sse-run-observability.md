...
attaching to the live tail. ([validated by `agent-events-stream.test.ts:286`](apps/floor/src/transport/http/routes/agent-events-stream.test.ts#L287), [`run-event-reducer.test.ts:223`](apps/web-ui/src/lib/run-event-reducer.test.ts#L222)) The bus is therefore best-effort and holds no
